...
var _ datasource.DataSource = &PluginRateLimitingAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginRateLimitingAdvancedDataSource{}

func NewPluginRateLimitingAdvancedDataSource() datasource.DataSource {
	return &PluginRateLimitingAdvancedDataSource{}
}

// PluginRateLimitingAdvancedDataSource is the data source implementation.
type PluginRateLimitingAdvancedDataSource struct {
...
func (r *PluginRateLimitingAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_rate_limiting_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginRateLimitingAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginRateLimitingAdvanced DataSource",
...
func (r *PluginRateLimitingAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginRateLimitingAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginRateLimitingAdvancedDataSourceModel
