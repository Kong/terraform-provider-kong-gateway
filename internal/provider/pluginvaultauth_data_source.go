...
var _ datasource.DataSource = &PluginVaultAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginVaultAuthDataSource{}

func NewPluginVaultAuthDataSource() datasource.DataSource {
	return &PluginVaultAuthDataSource{}
}
...
// PluginVaultAuthDataSourceModel describes the data model.
type PluginVaultAuthDataSourceModel struct {
...
func (r *PluginVaultAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_vault_auth"
}

// Schema defines the schema for the data source.
func (r *PluginVaultAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginVaultAuth DataSource",
...
func (r *PluginVaultAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginVaultAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginVaultAuthDataSourceModel
