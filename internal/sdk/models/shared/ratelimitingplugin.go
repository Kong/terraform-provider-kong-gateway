...
type RateLimitingPluginConfig struct {
	...
	LimitBy *RateLimitingPluginLimitBy `json:"limit_by,omitempty"`
	...
	Policy *RateLimitingPluginPolicy `json:"policy,omitempty"`
	// Redis configuration
...
func (o *RateLimitingPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
