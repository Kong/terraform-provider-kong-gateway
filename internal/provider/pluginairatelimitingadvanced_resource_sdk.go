...
func (r *PluginAiRateLimitingAdvancedResourceModel) RefreshFromSharedAiRateLimitingAdvancedPlugin(ctx context.Context, resp *shared.AiRateLimitingAdvancedPlugin) diag.Diagnostics {
...
func (r *PluginAiRateLimitingAdvancedResourceModel) ToOperationsCreateAiratelimitingadvancedPluginRequest(ctx context.Context) (*operations.CreateAiratelimitingadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRateLimitingAdvancedResourceModel) ToOperationsDeleteAiratelimitingadvancedPluginRequest(ctx context.Context) (*operations.DeleteAiratelimitingadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRateLimitingAdvancedResourceModel) ToOperationsGetAiratelimitingadvancedPluginRequest(ctx context.Context) (*operations.GetAiratelimitingadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRateLimitingAdvancedResourceModel) ToOperationsUpdateAiratelimitingadvancedPluginRequest(ctx context.Context) (*operations.UpdateAiratelimitingadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRateLimitingAdvancedResourceModel) ToSharedAiRateLimitingAdvancedPlugin(ctx context.Context) (*shared.AiRateLimitingAdvancedPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config != nil {
		...
		for llmProvidersIndex := range r.Config.LlmProviders {
			...
			name1 := shared.Name(r.Config.LlmProviders[llmProvidersIndex].Name.ValueString())
		...
		if r.Config.Redis != nil {
			...
			if r.Config.Redis.CloudAuthentication != nil {
				...
				var oauth *shared.AiRateLimitingAdvancedPluginOauth
				if r.Config.Redis.CloudAuthentication.Oauth != nil {
					authMethod := new(shared.AiRateLimitingAdvancedPluginAuthMethod)
					if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
						*authMethod = shared.AiRateLimitingAdvancedPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
					} else {
						authMethod = nil
					}
					clientID := new(string)
					...
					clientSecretJwtAlg := new(shared.AiRateLimitingAdvancedPluginClientSecretJwtAlg)
					if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
						*clientSecretJwtAlg = shared.AiRateLimitingAdvancedPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
					} else {
						clientSecretJwtAlg = nil
					}
					grantType := new(shared.AiRateLimitingAdvancedPluginGrantType)
					if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
						*grantType = shared.AiRateLimitingAdvancedPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
					} else {
						grantType = nil
					}
					password := new(string)
					...
					oauth = &shared.AiRateLimitingAdvancedPluginOauth{
