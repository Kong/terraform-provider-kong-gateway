...
// Create a new Route
func (s *Routes) CreateRoute(ctx context.Context, request shared.RouteInput) (*operations.CreateRouteResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update a Route
func (s *Routes) UpdateRoute(ctx context.Context, request operations.UpdateRouteRequest) (*operations.UpdateRouteResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
