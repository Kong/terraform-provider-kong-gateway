...
func (r *PluginAiResponseTransformerDataSourceModel) ToOperationsGetAiresponsetransformerPluginRequest(ctx context.Context) (*operations.GetAiresponsetransformerPluginRequest, diag.Diagnostics) {
...
func (r *PluginAiResponseTransformerDataSourceModel) RefreshFromSharedAiResponseTransformerPlugin(ctx context.Context, resp *shared.AiResponseTransformerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
