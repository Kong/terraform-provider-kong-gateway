...
func (r *PluginVaultAuthDataSourceModel) ToOperationsGetVaultauthPluginRequest(ctx context.Context) (*operations.GetVaultauthPluginRequest, diag.Diagnostics) {
...
func (r *PluginVaultAuthDataSourceModel) RefreshFromSharedVaultAuthPlugin(ctx context.Context, resp *shared.VaultAuthPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
