...
func (r *PluginResponseTransformerDataSourceModel) ToOperationsGetResponsetransformerPluginRequest(ctx context.Context) (*operations.GetResponsetransformerPluginRequest, diag.Diagnostics) {
...
func (r *PluginResponseTransformerDataSourceModel) RefreshFromSharedResponseTransformerPlugin(ctx context.Context, resp *shared.ResponseTransformerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
