...
func (r *PluginAiProxyAdvancedResourceModel) RefreshFromSharedAiProxyAdvancedPlugin(ctx context.Context, resp *shared.AiProxyAdvancedPlugin) diag.Diagnostics {
...
func (r *PluginAiProxyAdvancedResourceModel) ToOperationsCreateAiproxyadvancedPluginRequest(ctx context.Context) (*operations.CreateAiproxyadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiProxyAdvancedResourceModel) ToOperationsDeleteAiproxyadvancedPluginRequest(ctx context.Context) (*operations.DeleteAiproxyadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiProxyAdvancedResourceModel) ToOperationsGetAiproxyadvancedPluginRequest(ctx context.Context) (*operations.GetAiproxyadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiProxyAdvancedResourceModel) ToOperationsUpdateAiproxyadvancedPluginRequest(ctx context.Context) (*operations.UpdateAiproxyadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Vectordb != nil {
		...
		if r.Config.Vectordb.Redis != nil {
			...
			if r.Config.Vectordb.Redis.CloudAuthentication != nil {
				...
				var oauth *shared.AiProxyAdvancedPluginOauth
				if r.Config.Vectordb.Redis.CloudAuthentication.Oauth != nil {
					authMethod := new(shared.AiProxyAdvancedPluginAuthMethod)
					if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
						*authMethod = shared.AiProxyAdvancedPluginAuthMethod(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
					} else {
						authMethod = nil
					}
					clientID := new(string)
					...
					clientSecretJwtAlg := new(shared.AiProxyAdvancedPluginClientSecretJwtAlg)
					if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
						*clientSecretJwtAlg = shared.AiProxyAdvancedPluginClientSecretJwtAlg(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
					} else {
						clientSecretJwtAlg = nil
					}
					grantType := new(shared.AiProxyAdvancedPluginGrantType)
					if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
						*grantType = shared.AiProxyAdvancedPluginGrantType(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
					} else {
						grantType = nil
					}
					...
					oauth = &shared.AiProxyAdvancedPluginOauth{
