...
func (r *PluginJweDecryptDataSourceModel) ToOperationsGetJwedecryptPluginRequest(ctx context.Context) (*operations.GetJwedecryptPluginRequest, diag.Diagnostics) {
...
func (r *PluginJweDecryptDataSourceModel) RefreshFromSharedJweDecryptPlugin(ctx context.Context, resp *shared.JweDecryptPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
