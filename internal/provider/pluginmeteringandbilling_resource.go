...
var _ resource.Resource = &PluginMeteringAndBillingResource{}
var _ resource.ResourceWithImportState = &PluginMeteringAndBillingResource{}

func NewPluginMeteringAndBillingResource() resource.Resource {
	return &PluginMeteringAndBillingResource{}
}

// PluginMeteringAndBillingResource defines the resource implementation.
type PluginMeteringAndBillingResource struct {
	// Provider configured SDK client.
	client *sdk.KongGateway
}

// PluginMeteringAndBillingResourceModel describes the resource data model.
type PluginMeteringAndBillingResourceModel struct {
	Condition    types.String                            `tfsdk:"condition"`
	Config       *tfTypes.MeteringAndBillingPluginConfig `tfsdk:"config"`
...
func (r *PluginMeteringAndBillingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_metering_and_billing"
}

func (r *PluginMeteringAndBillingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginMeteringAndBilling Resource",
				...
				Attributes: map[string]schema.Attribute{
					...
					"attributes": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							...
							Attributes: map[string]schema.Attribute{
								"event_property_name": schema.StringAttribute{
									Computed:    true,
									Optional:    true,
									Description: `The property name in the usage event data payload. Not Null`,
									Validators: []validator.String{
								...
								"look_up_value_in": schema.StringAttribute{
									Computed:    true,
									Optional:    true,
									Description: `The header name or query parameter that contains the value, e.g 'x-department-id'. Not Null`,
									Validators: []validator.String{
										speakeasy_stringvalidators.NotNull(),
									},
								},
					...
					"ingest_endpoint": schema.StringAttribute{
						Required:    true,
					...
					"meter_ai_token_usage": schema.BoolAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Emit events for LLM input and output tokens on AI Gateway requests.`,
					},
					"meter_api_requests": schema.BoolAttribute{
						Computed:    true,
						Optional:    true,
...
func (r *PluginMeteringAndBillingResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginMeteringAndBillingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginMeteringAndBillingResourceModel
	...
	if !(res.MeteringAndBillingPlugin != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedMeteringAndBillingPlugin(ctx, res.MeteringAndBillingPlugin)...)
...
func (r *PluginMeteringAndBillingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginMeteringAndBillingResourceModel
...
func (r *PluginMeteringAndBillingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginMeteringAndBillingResourceModel
	var plan types.Object
...
func (r *PluginMeteringAndBillingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginMeteringAndBillingResourceModel
	var item types.Object
...
func (r *PluginMeteringAndBillingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
