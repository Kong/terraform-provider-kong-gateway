...
func (r *PluginRequestCalloutDataSourceModel) ToOperationsGetRequestcalloutPluginRequest(ctx context.Context) (*operations.GetRequestcalloutPluginRequest, diag.Diagnostics) {
...
func (r *PluginRequestCalloutDataSourceModel) RefreshFromSharedRequestCalloutPlugin(ctx context.Context, resp *shared.RequestCalloutPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
