...
var _ resource.Resource = &PluginRateLimitingAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginRateLimitingAdvancedResource{}

func NewPluginRateLimitingAdvancedResource() resource.Resource {
	return &PluginRateLimitingAdvancedResource{}
}
...
type PluginRateLimitingAdvancedResourceModel struct {
	...
	Expressions   *tfTypes.RateLimitingAdvancedPluginExpressions `tfsdk:"expressions"`
...
func (r *PluginRateLimitingAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_rate_limiting_advanced"
}

func (r *PluginRateLimitingAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginRateLimitingAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginRateLimitingAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginRateLimitingAdvancedResourceModel
...
func (r *PluginRateLimitingAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginRateLimitingAdvancedResourceModel
...
func (r *PluginRateLimitingAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginRateLimitingAdvancedResourceModel
	var plan types.Object
...
func (r *PluginRateLimitingAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginRateLimitingAdvancedResourceModel
	var item types.Object
