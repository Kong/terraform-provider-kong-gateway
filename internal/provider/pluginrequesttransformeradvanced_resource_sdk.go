...
func (r *PluginRequestTransformerAdvancedResourceModel) ToOperationsCreateRequesttransformeradvancedPluginRequest(ctx context.Context) (*operations.CreateRequesttransformeradvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
