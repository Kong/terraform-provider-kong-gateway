...
var _ datasource.DataSource = &PluginAiRagInjectorDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiRagInjectorDataSource{}

func NewPluginAiRagInjectorDataSource() datasource.DataSource {
	return &PluginAiRagInjectorDataSource{}
}
...
// PluginAiRagInjectorDataSourceModel describes the data model.
type PluginAiRagInjectorDataSourceModel struct {
...
func (r *PluginAiRagInjectorDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_rag_injector"
}

// Schema defines the schema for the data source.
func (r *PluginAiRagInjectorDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiRagInjector DataSource",
...
func (r *PluginAiRagInjectorDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiRagInjectorDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiRagInjectorDataSourceModel
