...
func (r *PluginRateLimitingResourceModel) RefreshFromSharedRateLimitingPlugin(ctx context.Context, resp *shared.RateLimitingPlugin) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Config == nil {
			...
			r.Config.CustomKey = types.StringPointerValue(resp.Config.CustomKey)
			...
			if resp.Config.Redis == nil {
				...
				if resp.Config.Redis.CloudAuthentication == nil {
					...
					if resp.Config.Redis.CloudAuthentication.Oauth == nil {
						...
						r.Config.Redis.CloudAuthentication.Oauth = &tfTypes.PartialRedisCeOauth{}
						...
						r.Config.Redis.CloudAuthentication.Oauth.Timeout = types.Float64PointerValue(resp.Config.Redis.CloudAuthentication.Oauth.Timeout)
						...
						if len(resp.Config.Redis.CloudAuthentication.Oauth.TokenHeaders) > 0 {
						...
						if len(resp.Config.Redis.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
		...
		if resp.Expressions == nil {
			r.Expressions = nil
		} else {
			r.Expressions = &tfTypes.Expressions{}
			r.Expressions.CustomKey = types.StringPointerValue(resp.Expressions.CustomKey)
			r.Expressions.Day = types.StringPointerValue(resp.Expressions.Day)
			r.Expressions.Hour = types.StringPointerValue(resp.Expressions.Hour)
			r.Expressions.Minute = types.StringPointerValue(resp.Expressions.Minute)
			r.Expressions.Month = types.StringPointerValue(resp.Expressions.Month)
			r.Expressions.Second = types.StringPointerValue(resp.Expressions.Second)
			r.Expressions.Year = types.StringPointerValue(resp.Expressions.Year)
		}
...
func (r *PluginRateLimitingResourceModel) ToOperationsCreateRatelimitingPluginRequest(ctx context.Context) (*operations.CreateRatelimitingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginRateLimitingResourceModel) ToSharedRateLimitingPlugin(ctx context.Context) (*shared.RateLimitingPlugin, diag.Diagnostics) {
	...
	if r.Config != nil {
		...
		if !r.Config.CustomKey.IsUnknown() && !r.Config.CustomKey.IsNull() {
			*customKey = r.Config.CustomKey.ValueString()
		} else {
			customKey = nil
		}
		day := new(float64)
		...
		if r.Config.Redis != nil {
			var cloudAuthentication *shared.RateLimitingPluginCloudAuthentication
			if r.Config.Redis.CloudAuthentication != nil {
				authProvider := new(shared.RateLimitingPluginAuthProvider)
				if !r.Config.Redis.CloudAuthentication.AuthProvider.IsUnknown() && !r.Config.Redis.CloudAuthentication.AuthProvider.IsNull() {
					*authProvider = shared.RateLimitingPluginAuthProvider(r.Config.Redis.CloudAuthentication.AuthProvider.ValueString())
				} else {
					authProvider = nil
				}
				...
				var oauth *shared.RateLimitingPluginOauth
				if r.Config.Redis.CloudAuthentication.Oauth != nil {
					authMethod := new(shared.RateLimitingPluginAuthMethod)
					if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
						*authMethod = shared.RateLimitingPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
					} else {
						authMethod = nil
					}
					clientID := new(string)
					...
					clientSecretJwtAlg := new(shared.RateLimitingPluginClientSecretJwtAlg)
					if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
						*clientSecretJwtAlg = shared.RateLimitingPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
					} else {
						clientSecretJwtAlg = nil
					}
					grantType := new(shared.RateLimitingPluginGrantType)
					if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
						*grantType = shared.RateLimitingPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
					} else {
						grantType = nil
					}
					password := new(string)
					...
					if !r.Config.Redis.CloudAuthentication.Oauth.Timeout.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.Timeout.IsNull() {
						*timeout = r.Config.Redis.CloudAuthentication.Oauth.Timeout.ValueFloat64()
					} else {
						timeout = nil
					}
					...
					oauth = &shared.RateLimitingPluginOauth{
				...
				cloudAuthentication = &shared.RateLimitingPluginCloudAuthentication{
			...
			if !r.Config.Redis.Timeout.IsUnknown() && !r.Config.Redis.Timeout.IsNull() {
				*timeout1 = r.Config.Redis.Timeout.ValueInt64()
			} else {
				timeout1 = nil
			}
	...
	var expressions *shared.Expressions
	if r.Expressions != nil {
		customKey1 := new(string)
		if !r.Expressions.CustomKey.IsUnknown() && !r.Expressions.CustomKey.IsNull() {
			*customKey1 = r.Expressions.CustomKey.ValueString()
		} else {
			customKey1 = nil
		}
		day1 := new(string)
		if !r.Expressions.Day.IsUnknown() && !r.Expressions.Day.IsNull() {
			*day1 = r.Expressions.Day.ValueString()
		} else {
			day1 = nil
		}
		hour1 := new(string)
		if !r.Expressions.Hour.IsUnknown() && !r.Expressions.Hour.IsNull() {
			*hour1 = r.Expressions.Hour.ValueString()
		} else {
			hour1 = nil
		}
		minute1 := new(string)
		if !r.Expressions.Minute.IsUnknown() && !r.Expressions.Minute.IsNull() {
			*minute1 = r.Expressions.Minute.ValueString()
		} else {
			minute1 = nil
		}
		month1 := new(string)
		if !r.Expressions.Month.IsUnknown() && !r.Expressions.Month.IsNull() {
			*month1 = r.Expressions.Month.ValueString()
		} else {
			month1 = nil
		}
		second1 := new(string)
		if !r.Expressions.Second.IsUnknown() && !r.Expressions.Second.IsNull() {
			*second1 = r.Expressions.Second.ValueString()
		} else {
			second1 = nil
		}
		year1 := new(string)
		if !r.Expressions.Year.IsUnknown() && !r.Expressions.Year.IsNull() {
			*year1 = r.Expressions.Year.ValueString()
		} else {
			year1 = nil
		}
