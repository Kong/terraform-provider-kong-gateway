...
func (r *PluginIPRestrictionResourceModel) ToSharedIPRestrictionPlugin() *shared.IPRestrictionPlugin {
	createdAt := new(int64)
	...
	var partials []shared.IPRestrictionPluginPartials = []shared.IPRestrictionPluginPartials{}
