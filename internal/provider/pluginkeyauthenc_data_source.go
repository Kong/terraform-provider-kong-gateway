...
var _ datasource.DataSource = &PluginKeyAuthEncDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginKeyAuthEncDataSource{}

func NewPluginKeyAuthEncDataSource() datasource.DataSource {
	return &PluginKeyAuthEncDataSource{}
}

// PluginKeyAuthEncDataSource is the data source implementation.
type PluginKeyAuthEncDataSource struct {
...
func (r *PluginKeyAuthEncDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_key_auth_enc"
}

// Schema defines the schema for the data source.
func (r *PluginKeyAuthEncDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginKeyAuthEnc DataSource",
...
func (r *PluginKeyAuthEncDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginKeyAuthEncDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginKeyAuthEncDataSourceModel
