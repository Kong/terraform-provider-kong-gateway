...
func (r *PluginStandardWebhooksResourceModel) ToSharedStandardWebhooksPlugin() *shared.StandardWebhooksPlugin {
	createdAt := new(int64)
	...
	var partials []shared.StandardWebhooksPluginPartials = []shared.StandardWebhooksPluginPartials{}
...
func (r *PluginStandardWebhooksResourceModel) RefreshFromSharedStandardWebhooksPlugin(resp *shared.StandardWebhooksPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
