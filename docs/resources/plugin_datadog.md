...
page_title: "kong-gateway_plugin_datadog Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginDatadog Resource
---

# kong-gateway_plugin_datadog (Resource)
...
```terraform
resource "kong-gateway_plugin_datadog" "my_plugindatadog" {
  ...
  config = {
    ...
    prefix = "...my_prefix..."
    queue = {
      breaker_cooldown     = 675815.72
      concurrency_limit    = 4
      failure_threshold    = 796774
...
```terraform
import {
  to = kong-gateway_plugin_datadog.my_kong-gateway_plugin_datadog
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_datadog.my_kong-gateway_plugin_datadog '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
