...
var _ resource.Resource = &PluginStandardWebhooksResource{}
var _ resource.ResourceWithImportState = &PluginStandardWebhooksResource{}

func NewPluginStandardWebhooksResource() resource.Resource {
	return &PluginStandardWebhooksResource{}
}
...
func (r *PluginStandardWebhooksResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginStandardWebhooksResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginStandardWebhooksResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginStandardWebhooksResourceModel
	...
	request, requestDiags := data.ToSharedStandardWebhooksPlugin(ctx)
...
func (r *PluginStandardWebhooksResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginStandardWebhooksResourceModel
...
func (r *PluginStandardWebhooksResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginStandardWebhooksResourceModel
	var plan types.Object
...
func (r *PluginStandardWebhooksResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginStandardWebhooksResourceModel
	var item types.Object
...
func (r *PluginStandardWebhooksResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
