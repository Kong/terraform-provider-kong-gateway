...
func (s *Consumers) CreateConsumer(ctx context.Context, request shared.ConsumerInput) (*operations.CreateConsumerResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update a Consumer
func (s *Consumers) UpdateConsumer(ctx context.Context, request operations.UpdateConsumerRequest) (*operations.UpdateConsumerResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
