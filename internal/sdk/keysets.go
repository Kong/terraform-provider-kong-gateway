...
func newKeySets(rootSDK *KongGateway, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *KeySets {
	return &KeySets{
		rootSDK:          rootSDK,
...
// Create a new KeySet
func (s *KeySets) CreateKeySet(ctx context.Context, request shared.KeySet, opts ...operations.Option) (*operations.CreateKeySetResponse, error) {
