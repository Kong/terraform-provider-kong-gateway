...
func (r *PluginSyslogDataSourceModel) ToOperationsGetSyslogPluginRequest(ctx context.Context) (*operations.GetSyslogPluginRequest, diag.Diagnostics) {
...
func (r *PluginSyslogDataSourceModel) RefreshFromSharedSyslogPlugin(ctx context.Context, resp *shared.SyslogPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
