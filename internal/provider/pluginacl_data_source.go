...
var _ datasource.DataSource = &PluginACLDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginACLDataSource{}

func NewPluginACLDataSource() datasource.DataSource {
	return &PluginACLDataSource{}
}
...
// PluginACLDataSourceModel describes the data model.
type PluginACLDataSourceModel struct {
...
func (r *PluginACLDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_acl"
}

// Schema defines the schema for the data source.
func (r *PluginACLDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginACL DataSource",
...
func (r *PluginACLDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginACLDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginACLDataSourceModel
