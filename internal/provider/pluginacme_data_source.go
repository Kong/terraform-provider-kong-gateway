...
var _ datasource.DataSource = &PluginAcmeDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAcmeDataSource{}

func NewPluginAcmeDataSource() datasource.DataSource {
	return &PluginAcmeDataSource{}
}
...
func (r *PluginAcmeDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_acme"
}

// Schema defines the schema for the data source.
func (r *PluginAcmeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAcme DataSource",
...
func (r *PluginAcmeDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAcmeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAcmeDataSourceModel
