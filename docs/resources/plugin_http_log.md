...
resource "kong-gateway_plugin_http_log" "my_pluginhttplog" {
  ...
  config = {
    ...
    method        = "PUT"
    queue = {
      breaker_cooldown     = 200275.62
      concurrency_limit    = 1
      failure_threshold    = 535342
...
```shell
terraform import kong-gateway_plugin_http_log.my_kong-gateway_plugin_http_log '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
