...
var _ resource.Resource = &PluginOpaResource{}
var _ resource.ResourceWithImportState = &PluginOpaResource{}

func NewPluginOpaResource() resource.Resource {
	return &PluginOpaResource{}
}
...
func (r *PluginOpaResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginOpaResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginOpaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginOpaResourceModel
	...
	request := *data.ToSharedOpaPlugin()
...
func (r *PluginOpaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginOpaResourceModel
...
func (r *PluginOpaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginOpaResourceModel
	var plan types.Object
...
func (r *PluginOpaResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginOpaResourceModel
	var item types.Object
