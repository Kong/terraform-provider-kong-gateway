...
func (r *PluginExitTransformerDataSourceModel) ToOperationsGetExittransformerPluginRequest(ctx context.Context) (*operations.GetExittransformerPluginRequest, diag.Diagnostics) {
...
func (r *PluginExitTransformerDataSourceModel) RefreshFromSharedExitTransformerPlugin(ctx context.Context, resp *shared.ExitTransformerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
