...
var _ datasource.DataSource = &PluginAzureFunctionsDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAzureFunctionsDataSource{}

func NewPluginAzureFunctionsDataSource() datasource.DataSource {
	return &PluginAzureFunctionsDataSource{}
}
...
// PluginAzureFunctionsDataSourceModel describes the data model.
type PluginAzureFunctionsDataSourceModel struct {
...
func (r *PluginAzureFunctionsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_azure_functions"
}

// Schema defines the schema for the data source.
func (r *PluginAzureFunctionsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAzureFunctions DataSource",
...
func (r *PluginAzureFunctionsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAzureFunctionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAzureFunctionsDataSourceModel
