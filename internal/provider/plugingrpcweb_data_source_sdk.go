...
func (r *PluginGrpcWebDataSourceModel) ToOperationsGetGrpcwebPluginRequest(ctx context.Context) (*operations.GetGrpcwebPluginRequest, diag.Diagnostics) {
...
func (r *PluginGrpcWebDataSourceModel) RefreshFromSharedGrpcWebPlugin(ctx context.Context, resp *shared.GrpcWebPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
