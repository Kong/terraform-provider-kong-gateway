...
page_title: "kong-gateway_plugin_ai_semantic_response_guard Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginAiSemanticResponseGuard Resource
---

# kong-gateway_plugin_ai_semantic_response_guard (Resource)
...
```terraform
resource "kong-gateway_plugin_ai_semantic_response_guard" "my_pluginaisemanticresponseguard" {
  config = {
    embeddings = {
      auth = {
    ...
    vectordb = {
      ...
      redis = {
        ...
        connect_timeout       = 561232583
        connection_is_proxied = true
        database              = 7
        host                  = "...my_host..."
        keepalive_backlog     = 1519722540
        keepalive_pool_size   = 1498087046
        password              = "...my_password..."
        port                  = 7612
        read_timeout          = 1035447009
        send_timeout          = 958485908
...
- `max_response_body_size` (Number) Max allowed body size allowed to be introspected. 0 means unlimited, but the size of this body will still be limited by Nginx's client_max_body_size.
...
```terraform
import {
  to = kong-gateway_plugin_ai_semantic_response_guard.my_kong-gateway_plugin_ai_semantic_response_guard
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_ai_semantic_response_guard.my_kong-gateway_plugin_ai_semantic_response_guard '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "747d1e5-8246-4f65-a939-b392f1ee17f8"}'
```
