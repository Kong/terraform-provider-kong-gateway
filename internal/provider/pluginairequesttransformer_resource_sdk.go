...
func (r *PluginAiRequestTransformerResourceModel) ToSharedCreateAiRequestTransformerPlugin() *shared.CreateAiRequestTransformerPlugin {
	var config *shared.CreateAiRequestTransformerPluginConfig
	if r.Config != nil {
		...
		var llm *shared.Llm
		if r.Config.Llm != nil {
			var auth *shared.CreateAiRequestTransformerPluginAuth
			if r.Config.Llm.Auth != nil {
				...
				paramLocation := new(shared.CreateAiRequestTransformerPluginParamLocation)
				if !r.Config.Llm.Auth.ParamLocation.IsUnknown() && !r.Config.Llm.Auth.ParamLocation.IsNull() {
					*paramLocation = shared.CreateAiRequestTransformerPluginParamLocation(r.Config.Llm.Auth.ParamLocation.ValueString())
				} else {
					paramLocation = nil
				}
				...
				auth = &shared.CreateAiRequestTransformerPluginAuth{
			...
			var logging *shared.CreateAiRequestTransformerPluginLogging
			if r.Config.Llm.Logging != nil {
				...
				logging = &shared.CreateAiRequestTransformerPluginLogging{
					LogPayloads:   logPayloads,
					LogStatistics: logStatistics,
				}
			}
			var model *shared.CreateAiRequestTransformerPluginModel
			if r.Config.Llm.Model != nil {
				...
				var optionsVar *shared.CreateAiRequestTransformerPluginOptions
				if r.Config.Llm.Model.Options != nil {
					...
					var bedrock *shared.CreateAiRequestTransformerPluginBedrock
					if r.Config.Llm.Model.Options.Bedrock != nil {
						...
						bedrock = &shared.CreateAiRequestTransformerPluginBedrock{
							AwsRegion: awsRegion,
						}
					}
					var gemini *shared.CreateAiRequestTransformerPluginGemini
					if r.Config.Llm.Model.Options.Gemini != nil {
						...
						gemini = &shared.CreateAiRequestTransformerPluginGemini{
					...
					llama2Format := new(shared.CreateAiRequestTransformerPluginLlama2Format)
					if !r.Config.Llm.Model.Options.Llama2Format.IsUnknown() && !r.Config.Llm.Model.Options.Llama2Format.IsNull() {
						*llama2Format = shared.CreateAiRequestTransformerPluginLlama2Format(r.Config.Llm.Model.Options.Llama2Format.ValueString())
					} else {
						llama2Format = nil
					}
					maxTokens := new(int64)
					...
					mistralFormat := new(shared.CreateAiRequestTransformerPluginMistralFormat)
					if !r.Config.Llm.Model.Options.MistralFormat.IsUnknown() && !r.Config.Llm.Model.Options.MistralFormat.IsNull() {
						*mistralFormat = shared.CreateAiRequestTransformerPluginMistralFormat(r.Config.Llm.Model.Options.MistralFormat.ValueString())
					} else {
						mistralFormat = nil
					}
					...
					optionsVar = &shared.CreateAiRequestTransformerPluginOptions{
				...
				provider := new(shared.CreateAiRequestTransformerPluginProvider)
				if !r.Config.Llm.Model.Provider.IsUnknown() && !r.Config.Llm.Model.Provider.IsNull() {
					*provider = shared.CreateAiRequestTransformerPluginProvider(r.Config.Llm.Model.Provider.ValueString())
				} else {
					provider = nil
				}
				model = &shared.CreateAiRequestTransformerPluginModel{
					Name:     name,
					Options:  optionsVar,
					Provider: provider,
				}
			}
			routeType := new(shared.CreateAiRequestTransformerPluginRouteType)
			if !r.Config.Llm.RouteType.IsUnknown() && !r.Config.Llm.RouteType.IsNull() {
				*routeType = shared.CreateAiRequestTransformerPluginRouteType(r.Config.Llm.RouteType.ValueString())
			} else {
				routeType = nil
			}
			llm = &shared.Llm{
		...
		config = &shared.CreateAiRequestTransformerPluginConfig{
	...
	var protocols []shared.CreateAiRequestTransformerPluginProtocols = []shared.CreateAiRequestTransformerPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateAiRequestTransformerPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateAiRequestTransformerPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateAiRequestTransformerPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateAiRequestTransformerPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateAiRequestTransformerPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateAiRequestTransformerPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateAiRequestTransformerPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateAiRequestTransformerPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateAiRequestTransformerPluginService{
			ID: id3,
		}
	}
	out := shared.CreateAiRequestTransformerPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginAiRequestTransformerResourceModel) RefreshFromSharedAiRequestTransformerPlugin(resp *shared.AiRequestTransformerPlugin) {
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config = &tfTypes.CreateAiRequestTransformerPluginConfig{}
