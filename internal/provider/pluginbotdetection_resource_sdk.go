...
func (r *PluginBotDetectionResourceModel) ToSharedBotDetectionPlugin() *shared.BotDetectionPlugin {
	createdAt := new(int64)
	...
	var partials []shared.BotDetectionPluginPartials = []shared.BotDetectionPluginPartials{}
