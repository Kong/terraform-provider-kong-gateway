...
func (s *CACertificates) CreateCaCertificate(ctx context.Context, request shared.CACertificateInput) (*operations.CreateCaCertificateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *CACertificates) UpdateCaCertificate(ctx context.Context, request operations.UpdateCaCertificateRequest) (*operations.UpdateCaCertificateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
