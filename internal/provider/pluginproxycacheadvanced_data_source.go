...
var _ datasource.DataSource = &PluginProxyCacheAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginProxyCacheAdvancedDataSource{}

func NewPluginProxyCacheAdvancedDataSource() datasource.DataSource {
	return &PluginProxyCacheAdvancedDataSource{}
}
...
// PluginProxyCacheAdvancedDataSourceModel describes the data model.
type PluginProxyCacheAdvancedDataSourceModel struct {
...
func (r *PluginProxyCacheAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_proxy_cache_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginProxyCacheAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginProxyCacheAdvanced DataSource",
...
func (r *PluginProxyCacheAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginProxyCacheAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginProxyCacheAdvancedDataSourceModel
