...
var _ datasource.DataSource = &PluginStatsdAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginStatsdAdvancedDataSource{}

func NewPluginStatsdAdvancedDataSource() datasource.DataSource {
	return &PluginStatsdAdvancedDataSource{}
}

// PluginStatsdAdvancedDataSource is the data source implementation.
type PluginStatsdAdvancedDataSource struct {
	client *sdk.KongGateway
}

// PluginStatsdAdvancedDataSourceModel describes the data model.
type PluginStatsdAdvancedDataSourceModel struct {
...
func (r *PluginStatsdAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_statsd_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginStatsdAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginStatsdAdvanced DataSource",
...
func (r *PluginStatsdAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginStatsdAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginStatsdAdvancedDataSourceModel
