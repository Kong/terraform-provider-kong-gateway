...
var _ datasource.DataSource = &PluginMtlsAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginMtlsAuthDataSource{}

func NewPluginMtlsAuthDataSource() datasource.DataSource {
	return &PluginMtlsAuthDataSource{}
}
...
// PluginMtlsAuthDataSourceModel describes the data model.
type PluginMtlsAuthDataSourceModel struct {
...
func (r *PluginMtlsAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_mtls_auth"
}

// Schema defines the schema for the data source.
func (r *PluginMtlsAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginMtlsAuth DataSource",
...
func (r *PluginMtlsAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginMtlsAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginMtlsAuthDataSourceModel
