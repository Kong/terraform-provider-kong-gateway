...
type OpenidConnectPluginConfig struct {
	...
	ClusterCacheRedis                            *PartialRedisEeConfig             `tfsdk:"cluster_cache_redis"`
	...
	DownstreamHeaders                            []UpstreamHeaders                 `tfsdk:"downstream_headers"`
	...
	SessionBind                                  []types.String                    `tfsdk:"session_bind"`
