...
var _ datasource.DataSource = &PluginAiRequestTransformerDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiRequestTransformerDataSource{}

func NewPluginAiRequestTransformerDataSource() datasource.DataSource {
	return &PluginAiRequestTransformerDataSource{}
}

// PluginAiRequestTransformerDataSource is the data source implementation.
type PluginAiRequestTransformerDataSource struct {
	client *sdk.KongGateway
}

// PluginAiRequestTransformerDataSourceModel describes the data model.
type PluginAiRequestTransformerDataSourceModel struct {
...
func (r *PluginAiRequestTransformerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_request_transformer"
}

// Schema defines the schema for the data source.
func (r *PluginAiRequestTransformerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiRequestTransformer DataSource",
...
func (r *PluginAiRequestTransformerDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiRequestTransformerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiRequestTransformerDataSourceModel
