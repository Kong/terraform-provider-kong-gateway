...
// Create a new SNI
func (s *SNIs) CreateSni(ctx context.Context, request shared.SNIInput, opts ...operations.Option) (*operations.CreateSniResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update an SNI
func (s *SNIs) UpdateSni(ctx context.Context, request operations.UpdateSniRequest, opts ...operations.Option) (*operations.UpdateSniResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
