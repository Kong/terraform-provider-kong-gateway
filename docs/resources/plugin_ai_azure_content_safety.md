...
page_title: "kong-gateway_plugin_ai_azure_content_safety Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginAiAzureContentSafety Resource
---

# kong-gateway_plugin_ai_azure_content_safety (Resource)
...
- `content_safety_url` (String) Full URL, inc protocol, of the Azure Content Safety instance. Not Null
