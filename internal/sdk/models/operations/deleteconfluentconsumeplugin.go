...
type DeleteConfluentconsumePluginRequest struct {
...
func (d DeleteConfluentconsumePluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteConfluentconsumePluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteConfluentconsumePluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteConfluentconsumePluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteConfluentconsumePluginResponse) UnmarshalJSON(data []byte) error {
