...
var _ resource.Resource = &PluginAiPromptCompressorResource{}
var _ resource.ResourceWithImportState = &PluginAiPromptCompressorResource{}

func NewPluginAiPromptCompressorResource() resource.Resource {
	return &PluginAiPromptCompressorResource{}
}

// PluginAiPromptCompressorResource defines the resource implementation.
type PluginAiPromptCompressorResource struct {
...
func (r *PluginAiPromptCompressorResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_prompt_compressor"
}

func (r *PluginAiPromptCompressorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"compression_ranges": schema.ListNestedAttribute{
						...
						NestedObject: schema.NestedAttributeObject{
							...
							Attributes: map[string]schema.Attribute{
								...
								"min_tokens": schema.Int64Attribute{
									Computed:    true,
									Optional:    true,
									Description: `Not Null`,
									Validators: []validator.Int64{
					...
					"compressor_type": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `What compression type to use to compress with. must be one of ["rate", "target_token"]`,
...
func (r *PluginAiPromptCompressorResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiPromptCompressorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiPromptCompressorResourceModel
	...
	if !(res.AiPromptCompressorPlugin != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedAiPromptCompressorPlugin(ctx, res.AiPromptCompressorPlugin)...)
...
func (r *PluginAiPromptCompressorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiPromptCompressorResourceModel
...
func (r *PluginAiPromptCompressorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiPromptCompressorResourceModel
	var plan types.Object
...
func (r *PluginAiPromptCompressorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiPromptCompressorResourceModel
	var item types.Object
...
func (r *PluginAiPromptCompressorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
