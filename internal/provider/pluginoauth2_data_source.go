...
var _ datasource.DataSource = &PluginOauth2DataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOauth2DataSource{}

func NewPluginOauth2DataSource() datasource.DataSource {
	return &PluginOauth2DataSource{}
}
...
// PluginOauth2DataSourceModel describes the data model.
type PluginOauth2DataSourceModel struct {
...
func (r *PluginOauth2DataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_oauth2"
}

// Schema defines the schema for the data source.
func (r *PluginOauth2DataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOauth2 DataSource",
...
func (r *PluginOauth2DataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOauth2DataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOauth2DataSourceModel
