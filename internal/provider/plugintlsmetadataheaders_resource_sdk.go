...
func (r *PluginTLSMetadataHeadersResourceModel) ToSharedCreateTLSMetadataHeadersPlugin() *shared.CreateTLSMetadataHeadersPlugin {
	var config *shared.CreateTLSMetadataHeadersPluginConfig
	if r.Config != nil {
		...
		config = &shared.CreateTLSMetadataHeadersPluginConfig{
	...
	var protocols []shared.CreateTLSMetadataHeadersPluginProtocols = []shared.CreateTLSMetadataHeadersPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateTLSMetadataHeadersPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateTLSMetadataHeadersPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateTLSMetadataHeadersPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateTLSMetadataHeadersPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateTLSMetadataHeadersPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateTLSMetadataHeadersPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateTLSMetadataHeadersPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateTLSMetadataHeadersPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateTLSMetadataHeadersPluginService{
			ID: id3,
		}
	}
	out := shared.CreateTLSMetadataHeadersPlugin{
		Config:        config,
		Enabled:       enabled,
