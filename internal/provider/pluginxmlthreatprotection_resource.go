...
var _ resource.Resource = &PluginXMLThreatProtectionResource{}
var _ resource.ResourceWithImportState = &PluginXMLThreatProtectionResource{}

func NewPluginXMLThreatProtectionResource() resource.Resource {
	return &PluginXMLThreatProtectionResource{}
}
...
func (r *PluginXMLThreatProtectionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginXMLThreatProtectionResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginXMLThreatProtectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginXMLThreatProtectionResourceModel
...
func (r *PluginXMLThreatProtectionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginXMLThreatProtectionResourceModel
...
func (r *PluginXMLThreatProtectionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginXMLThreatProtectionResourceModel
	var plan types.Object
...
func (r *PluginXMLThreatProtectionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginXMLThreatProtectionResourceModel
	var item types.Object
...
func (r *PluginXMLThreatProtectionResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
