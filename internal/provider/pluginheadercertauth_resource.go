...
var _ resource.Resource = &PluginHeaderCertAuthResource{}
var _ resource.ResourceWithImportState = &PluginHeaderCertAuthResource{}

func NewPluginHeaderCertAuthResource() resource.Resource {
	return &PluginHeaderCertAuthResource{}
}
...
func (r *PluginHeaderCertAuthResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_header_cert_auth"
}

func (r *PluginHeaderCertAuthResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"certificate_header_format": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Format of the certificate header. Supported formats: ` + "`" + `base64_encoded` + "`" + `, ` + "`" + `url_encoded` + "`" + `. Not Null; must be one of ["base64_encoded", "url_encoded"]`,
						Validators: []validator.String{
					...
					"certificate_header_name": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Name of the header that contains the certificate, received from the WAF or other L7 downstream proxy. Not Null`,
						Validators: []validator.String{
							speakeasy_stringvalidators.NotNull(),
						},
					},
...
func (r *PluginHeaderCertAuthResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginHeaderCertAuthResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginHeaderCertAuthResourceModel
...
func (r *PluginHeaderCertAuthResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginHeaderCertAuthResourceModel
...
func (r *PluginHeaderCertAuthResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginHeaderCertAuthResourceModel
	var plan types.Object
...
func (r *PluginHeaderCertAuthResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginHeaderCertAuthResourceModel
	var item types.Object
