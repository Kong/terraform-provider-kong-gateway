...
func (l *ListHmacAuthWithConsumerRequest) GetConsumerID() string {
	if l == nil {
		return ""
	}
	return l.ConsumerID
...
func (l *ListHmacAuthWithConsumerRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListHmacAuthWithConsumerResponseBody) GetData() []shared.HMACAuth {
	if l == nil {
		return nil
	}
	return l.Data
