...
func (r *PluginWebsocketSizeLimitDataSourceModel) ToOperationsGetWebsocketsizelimitPluginRequest(ctx context.Context) (*operations.GetWebsocketsizelimitPluginRequest, diag.Diagnostics) {
...
func (r *PluginWebsocketSizeLimitDataSourceModel) RefreshFromSharedWebsocketSizeLimitPlugin(ctx context.Context, resp *shared.WebsocketSizeLimitPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
