...
func (l *ListVaultRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListVaultResponseBody) GetData() []shared.Vault {
	if l == nil {
		return nil
	}
	return l.Data
...
func (l *ListVaultResponse) GetGatewayUnauthorizedError() *shared.GatewayUnauthorizedError {
	if l == nil {
		return nil
	}
