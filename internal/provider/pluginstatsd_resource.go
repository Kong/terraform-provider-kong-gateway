...
var _ resource.Resource = &PluginStatsdResource{}
var _ resource.ResourceWithImportState = &PluginStatsdResource{}

func NewPluginStatsdResource() resource.Resource {
	return &PluginStatsdResource{}
}
...
// PluginStatsdResourceModel describes the resource data model.
type PluginStatsdResourceModel struct {
...
func (r *PluginStatsdResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_statsd"
}

func (r *PluginStatsdResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginStatsd Resource",
...
func (r *PluginStatsdResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginStatsdResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginStatsdResourceModel
	...
	request, requestDiags := data.ToSharedStatsdPlugin(ctx)
...
func (r *PluginStatsdResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginStatsdResourceModel
...
func (r *PluginStatsdResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginStatsdResourceModel
	var plan types.Object
...
func (r *PluginStatsdResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginStatsdResourceModel
	var item types.Object
...
func (r *PluginStatsdResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
