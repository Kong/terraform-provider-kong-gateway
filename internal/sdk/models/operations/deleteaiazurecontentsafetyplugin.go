...
func (d DeleteAiazurecontentsafetyPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAiazurecontentsafetyPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteAiazurecontentsafetyPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteAiazurecontentsafetyPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAiazurecontentsafetyPluginResponse) UnmarshalJSON(data []byte) error {
