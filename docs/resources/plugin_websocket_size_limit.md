...
page_title: "kong-gateway_plugin_websocket_size_limit Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginWebsocketSizeLimit Resource
---

# kong-gateway_plugin_websocket_size_limit (Resource)
...
```terraform
resource "kong-gateway_plugin_websocket_size_limit" "my_pluginwebsocketsizelimit" {
...
```shell
terraform import kong-gateway_plugin_websocket_size_limit.my_kong-gateway_plugin_websocket_size_limit '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
