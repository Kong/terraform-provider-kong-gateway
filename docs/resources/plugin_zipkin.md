...
resource "kong-gateway_plugin_zipkin" "my_pluginzipkin" {
  ...
  config = {
    ...
    queue = {
      breaker_cooldown     = 492016.29
      concurrency_limit    = 1
      failure_threshold    = 809200
...
```shell
terraform import kong-gateway_plugin_zipkin.my_kong-gateway_plugin_zipkin '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
