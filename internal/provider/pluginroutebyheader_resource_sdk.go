...
func (r *PluginRouteByHeaderResourceModel) ToOperationsCreateRoutebyheaderPluginRequest(ctx context.Context) (*operations.CreateRoutebyheaderPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
