...
func (g GetAppdynamicsPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAppdynamicsPluginRequest) UnmarshalJSON(data []byte) error {
...
func (g *GetAppdynamicsPluginRequest) GetWorkspace() string {
	if g == nil {
		return ""
	}
	return g.Workspace
