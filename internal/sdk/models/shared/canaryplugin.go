...
// CanaryPluginHash - Hash algorithm to be used for canary release.
//
...
type CanaryPluginHash string

const (
	CanaryPluginHashConsumer CanaryPluginHash = "consumer"
	CanaryPluginHashIP       CanaryPluginHash = "ip"
	CanaryPluginHashNone     CanaryPluginHash = "none"
	CanaryPluginHashAllow    CanaryPluginHash = "allow"
	CanaryPluginHashDeny     CanaryPluginHash = "deny"
	CanaryPluginHashHeader   CanaryPluginHash = "header"
)

func (e CanaryPluginHash) ToPointer() *CanaryPluginHash {
	return &e
}
func (e *CanaryPluginHash) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "deny":
		fallthrough
	case "header":
		*e = CanaryPluginHash(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CanaryPluginHash: %v", v)
	}
}
...
type CanaryPluginConfig struct {
	...
	// * `deny`: Denies the specified groups from accessing the canary release.
	// * `header`: The hash will be based on the specified header value.
	Hash *CanaryPluginHash `json:"hash,omitempty"`
	// A string representing an HTTP header name.
...
func (o *CanaryPluginConfig) GetHash() *CanaryPluginHash {
	if o == nil {
		return nil
	}
	return o.Hash
...
func (o *CanaryPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
