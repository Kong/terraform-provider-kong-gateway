...
type DeleteWebsocketvalidatorPluginRequest struct {
...
func (d DeleteWebsocketvalidatorPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteWebsocketvalidatorPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteWebsocketvalidatorPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteWebsocketvalidatorPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteWebsocketvalidatorPluginResponse) UnmarshalJSON(data []byte) error {
