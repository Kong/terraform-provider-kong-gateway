...
var _ resource.Resource = &PluginAiResponseTransformerResource{}
var _ resource.ResourceWithImportState = &PluginAiResponseTransformerResource{}

func NewPluginAiResponseTransformerResource() resource.Resource {
	return &PluginAiResponseTransformerResource{}
}
...
func (r *PluginAiResponseTransformerResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_response_transformer"
}

func (r *PluginAiResponseTransformerResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginAiResponseTransformerResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiResponseTransformerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiResponseTransformerResourceModel
...
func (r *PluginAiResponseTransformerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiResponseTransformerResourceModel
...
func (r *PluginAiResponseTransformerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiResponseTransformerResourceModel
	var plan types.Object
...
func (r *PluginAiResponseTransformerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiResponseTransformerResourceModel
	var item types.Object
...
func (r *PluginAiResponseTransformerResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
