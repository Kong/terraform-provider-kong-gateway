...
var _ datasource.DataSource = &PluginSamlDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginSamlDataSource{}

func NewPluginSamlDataSource() datasource.DataSource {
	return &PluginSamlDataSource{}
}
...
// PluginSamlDataSourceModel describes the data model.
type PluginSamlDataSourceModel struct {
...
func (r *PluginSamlDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_saml"
}

// Schema defines the schema for the data source.
func (r *PluginSamlDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginSaml DataSource",
...
func (r *PluginSamlDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginSamlDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginSamlDataSourceModel
