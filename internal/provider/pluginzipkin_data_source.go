...
var _ datasource.DataSource = &PluginZipkinDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginZipkinDataSource{}

func NewPluginZipkinDataSource() datasource.DataSource {
	return &PluginZipkinDataSource{}
}
...
// PluginZipkinDataSourceModel describes the data model.
type PluginZipkinDataSourceModel struct {
...
func (r *PluginZipkinDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_zipkin"
}

// Schema defines the schema for the data source.
func (r *PluginZipkinDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginZipkin DataSource",
...
func (r *PluginZipkinDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginZipkinDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginZipkinDataSourceModel
