...
func (r *PluginPrometheusDataSourceModel) ToOperationsGetPrometheusPluginRequest(ctx context.Context) (*operations.GetPrometheusPluginRequest, diag.Diagnostics) {
...
func (r *PluginPrometheusDataSourceModel) RefreshFromSharedPrometheusPlugin(ctx context.Context, resp *shared.PrometheusPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
