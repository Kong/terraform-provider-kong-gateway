...
var _ resource.Resource = &PluginAiAzureContentSafetyResource{}
var _ resource.ResourceWithImportState = &PluginAiAzureContentSafetyResource{}

func NewPluginAiAzureContentSafetyResource() resource.Resource {
	return &PluginAiAzureContentSafetyResource{}
}
...
func (r *PluginAiAzureContentSafetyResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_azure_content_safety"
}

func (r *PluginAiAzureContentSafetyResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"guarding_mode": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `The guard mode to use for the request. must be one of ["BOTH", "INPUT", "OUTPUT"]`,
						Validators: []validator.String{
...
func (r *PluginAiAzureContentSafetyResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiAzureContentSafetyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiAzureContentSafetyResourceModel
...
func (r *PluginAiAzureContentSafetyResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiAzureContentSafetyResourceModel
...
func (r *PluginAiAzureContentSafetyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiAzureContentSafetyResourceModel
	var plan types.Object
...
func (r *PluginAiAzureContentSafetyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiAzureContentSafetyResourceModel
	var item types.Object
...
func (r *PluginAiAzureContentSafetyResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
