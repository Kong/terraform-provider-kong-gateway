...
func (r *PluginDatadogTracingResourceModel) ToSharedDatadogTracingPlugin() *shared.DatadogTracingPlugin {
	createdAt := new(int64)
	...
	var partials []shared.DatadogTracingPluginPartials = []shared.DatadogTracingPluginPartials{}
...
func (r *PluginDatadogTracingResourceModel) RefreshFromSharedDatadogTracingPlugin(resp *shared.DatadogTracingPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
