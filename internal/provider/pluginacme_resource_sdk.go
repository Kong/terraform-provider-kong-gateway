...
func (r *PluginAcmeResourceModel) ToOperationsCreateAcmePluginRequest(ctx context.Context) (*operations.CreateAcmePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAcmeResourceModel) ToSharedAcmePlugin(ctx context.Context) (*shared.AcmePlugin, diag.Diagnostics) {
	...
	var config *shared.AcmePluginConfig
	if r.Config != nil {
