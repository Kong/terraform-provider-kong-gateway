...
func (r *PluginAiSanitizerDataSourceModel) ToOperationsGetAisanitizerPluginRequest(ctx context.Context) (*operations.GetAisanitizerPluginRequest, diag.Diagnostics) {
...
func (r *PluginAiSanitizerDataSourceModel) RefreshFromSharedAiSanitizerPlugin(ctx context.Context, resp *shared.AiSanitizerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
