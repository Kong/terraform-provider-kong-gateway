...
func (d DeleteJwtsignerPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteJwtsignerPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteJwtsignerPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteJwtsignerPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteJwtsignerPluginResponse) UnmarshalJSON(data []byte) error {
