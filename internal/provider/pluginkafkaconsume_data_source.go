...
var _ datasource.DataSource = &PluginKafkaConsumeDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginKafkaConsumeDataSource{}

func NewPluginKafkaConsumeDataSource() datasource.DataSource {
	return &PluginKafkaConsumeDataSource{}
}
...
// PluginKafkaConsumeDataSourceModel describes the data model.
type PluginKafkaConsumeDataSourceModel struct {
...
func (r *PluginKafkaConsumeDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_kafka_consume"
}

// Schema defines the schema for the data source.
func (r *PluginKafkaConsumeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginKafkaConsume DataSource",
...
func (r *PluginKafkaConsumeDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginKafkaConsumeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginKafkaConsumeDataSourceModel
