...
var _ datasource.DataSource = &PluginForwardProxyDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginForwardProxyDataSource{}

func NewPluginForwardProxyDataSource() datasource.DataSource {
	return &PluginForwardProxyDataSource{}
}
...
// PluginForwardProxyDataSourceModel describes the data model.
type PluginForwardProxyDataSourceModel struct {
...
func (r *PluginForwardProxyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_forward_proxy"
}

// Schema defines the schema for the data source.
func (r *PluginForwardProxyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginForwardProxy DataSource",
...
func (r *PluginForwardProxyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginForwardProxyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginForwardProxyDataSourceModel
