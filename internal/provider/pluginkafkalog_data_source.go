...
var _ datasource.DataSource = &PluginKafkaLogDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginKafkaLogDataSource{}

func NewPluginKafkaLogDataSource() datasource.DataSource {
	return &PluginKafkaLogDataSource{}
}
...
// PluginKafkaLogDataSourceModel describes the data model.
type PluginKafkaLogDataSourceModel struct {
...
func (r *PluginKafkaLogDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_kafka_log"
}

// Schema defines the schema for the data source.
func (r *PluginKafkaLogDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginKafkaLog DataSource",
...
func (r *PluginKafkaLogDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginKafkaLogDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginKafkaLogDataSourceModel
