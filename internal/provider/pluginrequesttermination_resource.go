...
var _ resource.Resource = &PluginRequestTerminationResource{}
var _ resource.ResourceWithImportState = &PluginRequestTerminationResource{}

func NewPluginRequestTerminationResource() resource.Resource {
	return &PluginRequestTerminationResource{}
}
...
func (r *PluginRequestTerminationResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_request_termination"
}

func (r *PluginRequestTerminationResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginRequestTerminationResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginRequestTerminationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginRequestTerminationResourceModel
	...
	request, requestDiags := data.ToSharedRequestTerminationPlugin(ctx)
...
func (r *PluginRequestTerminationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginRequestTerminationResourceModel
...
func (r *PluginRequestTerminationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginRequestTerminationResourceModel
	var plan types.Object
...
func (r *PluginRequestTerminationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginRequestTerminationResourceModel
	var item types.Object
...
func (r *PluginRequestTerminationResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
