...
var _ resource.Resource = &PluginTLSHandshakeModifierResource{}
var _ resource.ResourceWithImportState = &PluginTLSHandshakeModifierResource{}

func NewPluginTLSHandshakeModifierResource() resource.Resource {
	return &PluginTLSHandshakeModifierResource{}
}
...
func (r *PluginTLSHandshakeModifierResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_tls_handshake_modifier"
}

func (r *PluginTLSHandshakeModifierResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginTLSHandshakeModifierResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginTLSHandshakeModifierResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginTLSHandshakeModifierResourceModel
	...
	if !(res.TLSHandshakeModifierPlugin != nil) {
...
func (r *PluginTLSHandshakeModifierResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginTLSHandshakeModifierResourceModel
...
func (r *PluginTLSHandshakeModifierResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginTLSHandshakeModifierResourceModel
	var plan types.Object
...
func (r *PluginTLSHandshakeModifierResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginTLSHandshakeModifierResourceModel
	var item types.Object
...
func (r *PluginTLSHandshakeModifierResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
