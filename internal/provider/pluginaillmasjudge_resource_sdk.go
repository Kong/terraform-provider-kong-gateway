...
func (r *PluginAiLlmAsJudgeResourceModel) RefreshFromSharedAiLlmAsJudgePlugin(ctx context.Context, resp *shared.AiLlmAsJudgePlugin) diag.Diagnostics {
	...
	if resp != nil {
		...
		r.Config.Llm = &tfTypes.PartialModelConfig{}
...
func (r *PluginAiLlmAsJudgeResourceModel) ToOperationsCreateAillmasjudgePluginRequest(ctx context.Context) (*operations.CreateAillmasjudgePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiLlmAsJudgeResourceModel) ToOperationsDeleteAillmasjudgePluginRequest(ctx context.Context) (*operations.DeleteAillmasjudgePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiLlmAsJudgeResourceModel) ToOperationsGetAillmasjudgePluginRequest(ctx context.Context) (*operations.GetAillmasjudgePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiLlmAsJudgeResourceModel) ToOperationsUpdateAillmasjudgePluginRequest(ctx context.Context) (*operations.UpdateAillmasjudgePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiLlmAsJudgeResourceModel) ToSharedAiLlmAsJudgePlugin(ctx context.Context) (*shared.AiLlmAsJudgePlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Llm.Model.Options != nil {
		...
		cacheWriteCostList := make([]shared.AiLlmAsJudgePluginCacheWriteCostList, 0, len(r.Config.Llm.Model.Options.CacheWriteCostList))
		for cacheWriteCostListIndex := range r.Config.Llm.Model.Options.CacheWriteCostList {
			...
			cacheWriteCostList = append(cacheWriteCostList, shared.AiLlmAsJudgePluginCacheWriteCostList{
				Cost: cost,
				TTL:  ttl,
			})
		}
		...
		contextWindowFactor := make([]shared.AiLlmAsJudgePluginContextWindowFactor, 0, len(r.Config.Llm.Model.Options.ContextWindowFactor))
		for contextWindowFactorIndex := range r.Config.Llm.Model.Options.ContextWindowFactor {
			...
			contextWindowFactor = append(contextWindowFactor, shared.AiLlmAsJudgePluginContextWindowFactor{
				Above:        above,
		...
		serviceTierFactor := make([]shared.AiLlmAsJudgePluginServiceTierFactor, 0, len(r.Config.Llm.Model.Options.ServiceTierFactor))
		for serviceTierFactorIndex := range r.Config.Llm.Model.Options.ServiceTierFactor {
			...
			serviceTierFactor = append(serviceTierFactor, shared.AiLlmAsJudgePluginServiceTierFactor{
				Factor: factor,
				Tier:   tier,
			})
		}
