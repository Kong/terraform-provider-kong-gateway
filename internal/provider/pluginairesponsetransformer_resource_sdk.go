...
func (r *PluginAiResponseTransformerResourceModel) ToSharedCreateAiResponseTransformerPlugin() *shared.CreateAiResponseTransformerPlugin {
	var config *shared.CreateAiResponseTransformerPluginConfig
	if r.Config != nil {
		...
		var llm *shared.CreateAiResponseTransformerPluginLlm
		if r.Config.Llm != nil {
			var auth *shared.CreateAiResponseTransformerPluginAuth
			if r.Config.Llm.Auth != nil {
				...
				paramLocation := new(shared.CreateAiResponseTransformerPluginParamLocation)
				if !r.Config.Llm.Auth.ParamLocation.IsUnknown() && !r.Config.Llm.Auth.ParamLocation.IsNull() {
					*paramLocation = shared.CreateAiResponseTransformerPluginParamLocation(r.Config.Llm.Auth.ParamLocation.ValueString())
				} else {
					paramLocation = nil
				}
				...
				auth = &shared.CreateAiResponseTransformerPluginAuth{
			...
			var logging *shared.CreateAiResponseTransformerPluginLogging
			if r.Config.Llm.Logging != nil {
				...
				logging = &shared.CreateAiResponseTransformerPluginLogging{
					LogPayloads:   logPayloads,
					LogStatistics: logStatistics,
				}
			}
			var model *shared.CreateAiResponseTransformerPluginModel
			if r.Config.Llm.Model != nil {
				...
				var optionsVar *shared.CreateAiResponseTransformerPluginOptions
				if r.Config.Llm.Model.Options != nil {
					...
					var bedrock *shared.CreateAiResponseTransformerPluginBedrock
					if r.Config.Llm.Model.Options.Bedrock != nil {
						...
						bedrock = &shared.CreateAiResponseTransformerPluginBedrock{
							AwsRegion: awsRegion,
						}
					}
					var gemini *shared.CreateAiResponseTransformerPluginGemini
					if r.Config.Llm.Model.Options.Gemini != nil {
						...
						gemini = &shared.CreateAiResponseTransformerPluginGemini{
					...
					llama2Format := new(shared.CreateAiResponseTransformerPluginLlama2Format)
					if !r.Config.Llm.Model.Options.Llama2Format.IsUnknown() && !r.Config.Llm.Model.Options.Llama2Format.IsNull() {
						*llama2Format = shared.CreateAiResponseTransformerPluginLlama2Format(r.Config.Llm.Model.Options.Llama2Format.ValueString())
					} else {
						llama2Format = nil
					}
					maxTokens := new(int64)
					...
					mistralFormat := new(shared.CreateAiResponseTransformerPluginMistralFormat)
					if !r.Config.Llm.Model.Options.MistralFormat.IsUnknown() && !r.Config.Llm.Model.Options.MistralFormat.IsNull() {
						*mistralFormat = shared.CreateAiResponseTransformerPluginMistralFormat(r.Config.Llm.Model.Options.MistralFormat.ValueString())
					} else {
						mistralFormat = nil
					}
					...
					optionsVar = &shared.CreateAiResponseTransformerPluginOptions{
				...
				provider := new(shared.CreateAiResponseTransformerPluginProvider)
				if !r.Config.Llm.Model.Provider.IsUnknown() && !r.Config.Llm.Model.Provider.IsNull() {
					*provider = shared.CreateAiResponseTransformerPluginProvider(r.Config.Llm.Model.Provider.ValueString())
				} else {
					provider = nil
				}
				model = &shared.CreateAiResponseTransformerPluginModel{
					Name:     name,
					Options:  optionsVar,
					Provider: provider,
				}
			}
			routeType := new(shared.CreateAiResponseTransformerPluginRouteType)
			if !r.Config.Llm.RouteType.IsUnknown() && !r.Config.Llm.RouteType.IsNull() {
				*routeType = shared.CreateAiResponseTransformerPluginRouteType(r.Config.Llm.RouteType.ValueString())
			} else {
				routeType = nil
			}
			llm = &shared.CreateAiResponseTransformerPluginLlm{
				Auth:      auth,
				Logging:   logging,
				Model:     model,
				RouteType: routeType,
		...
		config = &shared.CreateAiResponseTransformerPluginConfig{
	...
	var protocols []shared.CreateAiResponseTransformerPluginProtocols = []shared.CreateAiResponseTransformerPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateAiResponseTransformerPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateAiResponseTransformerPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateAiResponseTransformerPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateAiResponseTransformerPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateAiResponseTransformerPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateAiResponseTransformerPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateAiResponseTransformerPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateAiResponseTransformerPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateAiResponseTransformerPluginService{
			ID: id3,
		}
	}
	out := shared.CreateAiResponseTransformerPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginAiResponseTransformerResourceModel) RefreshFromSharedAiResponseTransformerPlugin(resp *shared.AiResponseTransformerPlugin) {
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config = &tfTypes.CreateAiResponseTransformerPluginConfig{}
