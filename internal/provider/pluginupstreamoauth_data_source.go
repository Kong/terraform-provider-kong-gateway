...
var _ datasource.DataSource = &PluginUpstreamOauthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginUpstreamOauthDataSource{}

func NewPluginUpstreamOauthDataSource() datasource.DataSource {
	return &PluginUpstreamOauthDataSource{}
}
...
// PluginUpstreamOauthDataSourceModel describes the data model.
type PluginUpstreamOauthDataSourceModel struct {
...
func (r *PluginUpstreamOauthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_upstream_oauth"
}

// Schema defines the schema for the data source.
func (r *PluginUpstreamOauthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginUpstreamOauth DataSource",
...
func (r *PluginUpstreamOauthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginUpstreamOauthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginUpstreamOauthDataSourceModel
