...
func (s *Plugins) ListPlugin(ctx context.Context, request operations.ListPluginRequest) (*operations.ListPluginResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/plugins")
	if err != nil {
...
// Create a new Plugin
func (s *Plugins) CreatePlugin(ctx context.Context, request shared.PluginInput) (*operations.CreatePluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Create a ACL plugin
func (s *Plugins) CreateACLPlugin(ctx context.Context, request *shared.CreateACLPlugin) (*operations.CreateACLPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateAipromptdecoratorPlugin(ctx context.Context, request *shared.CreateAIPromptDecoratorPlugin) (*operations.CreateAipromptdecoratorPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateAipromptguardPlugin(ctx context.Context, request *shared.CreateAIPromptGuardPlugin) (*operations.CreateAipromptguardPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateAiprompttemplatePlugin(ctx context.Context, request *shared.CreateAIPromptTemplatePlugin) (*operations.CreateAiprompttemplatePluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateAiproxyPlugin(ctx context.Context, request *shared.CreateAIProxyPlugin) (*operations.CreateAiproxyPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateAwslambdaPlugin(ctx context.Context, request *shared.CreateAWSLambdaPlugin) (*operations.CreateAwslambdaPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateBasicauthPlugin(ctx context.Context, request *shared.CreateBasicAuthPlugin) (*operations.CreateBasicauthPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateCorsPlugin(ctx context.Context, request *shared.CreateCORSPlugin) (*operations.CreateCorsPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateCorrelationidPlugin(ctx context.Context, request *shared.CreateCorrelationIDPlugin) (*operations.CreateCorrelationidPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateFilelogPlugin(ctx context.Context, request *shared.CreateFileLogPlugin) (*operations.CreateFilelogPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateIprestrictionPlugin(ctx context.Context, request *shared.CreateIPRestrictionPlugin) (*operations.CreateIprestrictionPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Create a JQ plugin
func (s *Plugins) CreateJqPlugin(ctx context.Context, request *shared.CreateJQPlugin) (*operations.CreateJqPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Create a JWT plugin
func (s *Plugins) CreateJwtPlugin(ctx context.Context, request *shared.CreateJWTPlugin) (*operations.CreateJwtPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateJwtsignerPlugin(ctx context.Context, request *shared.CreateJWTSignerPlugin) (*operations.CreateJwtsignerPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateKeyauthPlugin(ctx context.Context, request *shared.CreateKeyAuthPlugin) (*operations.CreateKeyauthPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateOauth2Plugin(ctx context.Context, request *shared.CreateOauth2Plugin) (*operations.CreateOauth2PluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateOpenidconnectPlugin(ctx context.Context, request *shared.CreateOpenidConnectPlugin) (*operations.CreateOpenidconnectPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateOpentelemetryPlugin(ctx context.Context, request *shared.CreateOpentelemetryPlugin) (*operations.CreateOpentelemetryPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreatePrefunctionPlugin(ctx context.Context, request *shared.CreatePreFunctionPlugin) (*operations.CreatePrefunctionPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreatePrometheusPlugin(ctx context.Context, request *shared.CreatePrometheusPlugin) (*operations.CreatePrometheusPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateProxycachePlugin(ctx context.Context, request *shared.CreateProxyCachePlugin) (*operations.CreateProxycachePluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateRatelimitingPlugin(ctx context.Context, request *shared.CreateRateLimitingPlugin) (*operations.CreateRatelimitingPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateRatelimitingadvancedPlugin(ctx context.Context, request *shared.CreateRateLimitingAdvancedPlugin) (*operations.CreateRatelimitingadvancedPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateRequestterminationPlugin(ctx context.Context, request *shared.CreateRequestTerminationPlugin) (*operations.CreateRequestterminationPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateRequesttransformerPlugin(ctx context.Context, request *shared.CreateRequestTransformerPlugin) (*operations.CreateRequesttransformerPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateRequesttransformeradvancedPlugin(ctx context.Context, request *shared.CreateRequestTransformerAdvancedPlugin) (*operations.CreateRequesttransformeradvancedPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateResponsetransformerPlugin(ctx context.Context, request *shared.CreateResponseTransformerPlugin) (*operations.CreateResponsetransformerPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateResponsetransformeradvancedPlugin(ctx context.Context, request *shared.CreateResponseTransformerAdvancedPlugin) (*operations.CreateResponsetransformeradvancedPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) CreateSamlPlugin(ctx context.Context, request *shared.CreateSamlPlugin) (*operations.CreateSamlPluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) DeletePlugin(ctx context.Context, request operations.DeletePluginRequest) (*operations.DeletePluginResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/plugins/{PluginId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// Update a Plugin
func (s *Plugins) UpdatePlugin(ctx context.Context, request operations.UpdatePluginRequest) (*operations.UpdatePluginResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Plugins) FetchPluginSchema(ctx context.Context, request operations.FetchPluginSchemaRequest) (*operations.FetchPluginSchemaResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
