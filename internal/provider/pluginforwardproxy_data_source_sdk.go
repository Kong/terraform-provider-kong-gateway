...
func (r *PluginForwardProxyDataSourceModel) ToOperationsGetForwardproxyPluginRequest(ctx context.Context) (*operations.GetForwardproxyPluginRequest, diag.Diagnostics) {
...
func (r *PluginForwardProxyDataSourceModel) RefreshFromSharedForwardProxyPlugin(ctx context.Context, resp *shared.ForwardProxyPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
