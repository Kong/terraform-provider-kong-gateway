...
func (s *KeySets) ListKeySet(ctx context.Context, request operations.ListKeySetRequest, opts ...operations.Option) (*operations.ListKeySetResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/key-sets")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListKeySetResponseBody
...
// Create a new KeySet
func (s *KeySets) CreateKeySet(ctx context.Context, request shared.KeySetInput, opts ...operations.Option) (*operations.CreateKeySetResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *KeySets) DeleteKeySet(ctx context.Context, request operations.DeleteKeySetRequest, opts ...operations.Option) (*operations.DeleteKeySetResponse, error) {
	...
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	opURL, err := utils.GenerateURL(ctx, baseURL, "/key-sets/{KeySetIdOrName}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// UpdateKeySet - Update a KeySet
// Update a KeySet
func (s *KeySets) UpdateKeySet(ctx context.Context, request operations.UpdateKeySetRequest, opts ...operations.Option) (*operations.UpdateKeySetResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.UpdateKeySetResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
