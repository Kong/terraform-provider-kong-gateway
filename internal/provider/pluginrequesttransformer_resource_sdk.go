...
func (r *PluginRequestTransformerResourceModel) ToSharedCreateRequestTransformerPlugin() *shared.CreateRequestTransformerPlugin {
	var config *shared.CreateRequestTransformerPluginConfig
	if r.Config != nil {
		var add *shared.Add
		if r.Config.Add != nil {
	...
	var consumerGroup *shared.CreateRequestTransformerPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateRequestTransformerPluginConsumerGroup{
			ID: id1,
		}
	}
...
func (r *PluginRequestTransformerResourceModel) RefreshFromSharedRequestTransformerPlugin(resp *shared.RequestTransformerPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
