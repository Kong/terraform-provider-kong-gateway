...
func (r *PluginUpstreamTimeoutDataSourceModel) ToOperationsGetUpstreamtimeoutPluginRequest(ctx context.Context) (*operations.GetUpstreamtimeoutPluginRequest, diag.Diagnostics) {
...
func (r *PluginUpstreamTimeoutDataSourceModel) RefreshFromSharedUpstreamTimeoutPlugin(ctx context.Context, resp *shared.UpstreamTimeoutPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
