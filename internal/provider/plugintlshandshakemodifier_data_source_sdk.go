...
func (r *PluginTLSHandshakeModifierDataSourceModel) ToOperationsGetTlshandshakemodifierPluginRequest(ctx context.Context) (*operations.GetTlshandshakemodifierPluginRequest, diag.Diagnostics) {
...
func (r *PluginTLSHandshakeModifierDataSourceModel) RefreshFromSharedTLSHandshakeModifierPlugin(ctx context.Context, resp *shared.TLSHandshakeModifierPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
