...
func (l *ListServiceRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
type ListServiceResponseBody struct {
	Data []shared.ServiceOutput `json:"data,omitempty"`
...
func (l *ListServiceResponseBody) GetData() []shared.ServiceOutput {
	if l == nil {
		return nil
	}
	return l.Data
...
func (l *ListServiceResponse) GetGatewayUnauthorizedError() *shared.GatewayUnauthorizedError {
	if l == nil {
		return nil
	}
