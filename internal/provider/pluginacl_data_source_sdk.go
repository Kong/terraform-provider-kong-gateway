...
func (r *PluginACLDataSourceModel) ToOperationsGetACLPluginRequest(ctx context.Context) (*operations.GetACLPluginRequest, diag.Diagnostics) {
...
func (r *PluginACLDataSourceModel) RefreshFromSharedACLPlugin(ctx context.Context, resp *shared.ACLPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
