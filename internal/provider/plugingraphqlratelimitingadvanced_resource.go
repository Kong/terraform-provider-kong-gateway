...
var _ resource.Resource = &PluginGraphqlRateLimitingAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginGraphqlRateLimitingAdvancedResource{}

func NewPluginGraphqlRateLimitingAdvancedResource() resource.Resource {
	return &PluginGraphqlRateLimitingAdvancedResource{}
}
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginGraphqlRateLimitingAdvancedResourceModel
	...
	request := data.ToSharedCreateGraphqlRateLimitingAdvancedPlugin()
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginGraphqlRateLimitingAdvancedResourceModel
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginGraphqlRateLimitingAdvancedResourceModel
	var plan types.Object
	...
	createGraphqlRateLimitingAdvancedPlugin := data.ToSharedCreateGraphqlRateLimitingAdvancedPlugin()
	request := operations.UpdateGraphqlratelimitingadvancedPluginRequest{
		PluginID:                                pluginID,
		CreateGraphqlRateLimitingAdvancedPlugin: createGraphqlRateLimitingAdvancedPlugin,
	}
...
func (r *PluginGraphqlRateLimitingAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginGraphqlRateLimitingAdvancedResourceModel
	var item types.Object
