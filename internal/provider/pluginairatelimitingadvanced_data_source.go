...
var _ datasource.DataSource = &PluginAiRateLimitingAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiRateLimitingAdvancedDataSource{}

func NewPluginAiRateLimitingAdvancedDataSource() datasource.DataSource {
	return &PluginAiRateLimitingAdvancedDataSource{}
}
...
// PluginAiRateLimitingAdvancedDataSourceModel describes the data model.
type PluginAiRateLimitingAdvancedDataSourceModel struct {
...
func (r *PluginAiRateLimitingAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_rate_limiting_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginAiRateLimitingAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiRateLimitingAdvanced DataSource",
...
func (r *PluginAiRateLimitingAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiRateLimitingAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiRateLimitingAdvancedDataSourceModel
