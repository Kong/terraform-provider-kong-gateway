...
func (r *PluginRequestTransformerDataSourceModel) ToOperationsGetRequesttransformerPluginRequest(ctx context.Context) (*operations.GetRequesttransformerPluginRequest, diag.Diagnostics) {
...
func (r *PluginRequestTransformerDataSourceModel) RefreshFromSharedRequestTransformerPlugin(ctx context.Context, resp *shared.RequestTransformerPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
