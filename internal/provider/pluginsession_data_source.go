...
var _ datasource.DataSource = &PluginSessionDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginSessionDataSource{}

func NewPluginSessionDataSource() datasource.DataSource {
	return &PluginSessionDataSource{}
}
...
// PluginSessionDataSourceModel describes the data model.
type PluginSessionDataSourceModel struct {
...
func (r *PluginSessionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_session"
}

// Schema defines the schema for the data source.
func (r *PluginSessionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginSession DataSource",
...
func (r *PluginSessionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginSessionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginSessionDataSourceModel
