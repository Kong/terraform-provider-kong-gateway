...
var _ resource.Resource = &PluginAceResource{}
var _ resource.ResourceWithImportState = &PluginAceResource{}

func NewPluginAceResource() resource.Resource {
	return &PluginAceResource{}
}

// PluginAceResource defines the resource implementation.
type PluginAceResource struct {
...
func (r *PluginAceResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ace"
}

func (r *PluginAceResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginAceResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAceResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAceResourceModel
...
func (r *PluginAceResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAceResourceModel
...
func (r *PluginAceResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAceResourceModel
	var plan types.Object
...
func (r *PluginAceResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAceResourceModel
	var item types.Object
...
func (r *PluginAceResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
