...
func (r *PluginGraphqlRateLimitingAdvancedDataSourceModel) RefreshFromSharedGraphqlRateLimitingAdvancedPlugin(resp *shared.GraphqlRateLimitingAdvancedPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
