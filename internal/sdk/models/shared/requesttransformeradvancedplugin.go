...
func (o *RequestTransformerAdvancedPluginAdd) GetJSONTypes() []RequestTransformerAdvancedPluginJSONTypes {
	if o == nil {
		return nil
	}
	return o.JSONTypes
...
func (o *RequestTransformerAdvancedPluginAppend) GetJSONTypes() []RequestTransformerAdvancedPluginConfigJSONTypes {
	if o == nil {
		return nil
	}
	return o.JSONTypes
...
type RequestTransformerAdvancedPluginConfigReplaceJSONTypes string

const (
	RequestTransformerAdvancedPluginConfigReplaceJSONTypesBoolean RequestTransformerAdvancedPluginConfigReplaceJSONTypes = "boolean"
	RequestTransformerAdvancedPluginConfigReplaceJSONTypesNumber  RequestTransformerAdvancedPluginConfigReplaceJSONTypes = "number"
	RequestTransformerAdvancedPluginConfigReplaceJSONTypesString  RequestTransformerAdvancedPluginConfigReplaceJSONTypes = "string"
)

func (e RequestTransformerAdvancedPluginConfigReplaceJSONTypes) ToPointer() *RequestTransformerAdvancedPluginConfigReplaceJSONTypes {
	return &e
}
func (e *RequestTransformerAdvancedPluginConfigReplaceJSONTypes) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "number":
		fallthrough
	case "string":
		*e = RequestTransformerAdvancedPluginConfigReplaceJSONTypes(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestTransformerAdvancedPluginConfigReplaceJSONTypes: %v", v)
	}
}
...
type RequestTransformerAdvancedPluginReplace struct {
	Body        []string                                                 `json:"body,omitempty"`
	Headers     []string                                                 `json:"headers,omitempty"`
	JSONTypes   []RequestTransformerAdvancedPluginConfigReplaceJSONTypes `json:"json_types,omitempty"`
	Querystring []string                                                 `json:"querystring,omitempty"`
...
func (o *RequestTransformerAdvancedPluginReplace) GetJSONTypes() []RequestTransformerAdvancedPluginConfigReplaceJSONTypes {
	if o == nil {
		return nil
	}
	return o.JSONTypes
...
func (o *RequestTransformerAdvancedPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
