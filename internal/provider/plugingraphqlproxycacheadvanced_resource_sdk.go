...
func (r *PluginGraphqlProxyCacheAdvancedResourceModel) ToSharedCreateGraphqlProxyCacheAdvancedPlugin() *shared.CreateGraphqlProxyCacheAdvancedPlugin {
	var config *shared.CreateGraphqlProxyCacheAdvancedPluginConfig
	if r.Config != nil {
		...
		config = &shared.CreateGraphqlProxyCacheAdvancedPluginConfig{
	...
	var protocols []shared.CreateGraphqlProxyCacheAdvancedPluginProtocols = []shared.CreateGraphqlProxyCacheAdvancedPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateGraphqlProxyCacheAdvancedPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateGraphqlProxyCacheAdvancedPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateGraphqlProxyCacheAdvancedPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateGraphqlProxyCacheAdvancedPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateGraphqlProxyCacheAdvancedPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateGraphqlProxyCacheAdvancedPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateGraphqlProxyCacheAdvancedPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateGraphqlProxyCacheAdvancedPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateGraphqlProxyCacheAdvancedPluginService{
			ID: id3,
		}
	}
	out := shared.CreateGraphqlProxyCacheAdvancedPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginGraphqlProxyCacheAdvancedResourceModel) RefreshFromSharedGraphqlProxyCacheAdvancedPlugin(resp *shared.GraphqlProxyCacheAdvancedPlugin) {
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config = &tfTypes.CreateGraphqlProxyCacheAdvancedPluginConfig{}
