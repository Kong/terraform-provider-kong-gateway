...
func (s *ConsumerGroups) CreateConsumerGroup(ctx context.Context, request shared.ConsumerGroupInput) (*operations.CreateConsumerGroupResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *ConsumerGroups) UpdateConsumerGroup(ctx context.Context, request operations.UpdateConsumerGroupRequest) (*operations.UpdateConsumerGroupResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
