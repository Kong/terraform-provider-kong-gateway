...
func (r *PluginOasValidationDataSourceModel) ToOperationsGetOasvalidationPluginRequest(ctx context.Context) (*operations.GetOasvalidationPluginRequest, diag.Diagnostics) {
...
func (r *PluginOasValidationDataSourceModel) RefreshFromSharedOasValidationPlugin(ctx context.Context, resp *shared.OasValidationPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
