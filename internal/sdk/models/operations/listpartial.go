...
func (l ListPartialRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListPartialRequest) UnmarshalJSON(data []byte) error {
...
func (l *ListPartialRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
type ListPartialResponseBody struct {
	Data []shared.Partial `json:"data,omitempty"`
...
func (l *ListPartialResponseBody) GetData() []shared.Partial {
	if l == nil {
		return nil
	}
	return l.Data
...
type ListPartialResponse struct {
	...
	// A successful response listing Partials
...
func (l *ListPartialResponse) GetGatewayUnauthorizedError() *shared.GatewayUnauthorizedError {
	if l == nil {
		return nil
	}
