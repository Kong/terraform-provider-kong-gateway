...
var _ resource.Resource = &PluginAiRagInjectorResource{}
var _ resource.ResourceWithImportState = &PluginAiRagInjectorResource{}

func NewPluginAiRagInjectorResource() resource.Resource {
	return &PluginAiRagInjectorResource{}
}
...
func (r *PluginAiRagInjectorResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_rag_injector"
}

func (r *PluginAiRagInjectorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginAiRagInjectorResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiRagInjectorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiRagInjectorResourceModel
	...
	request, requestDiags := data.ToSharedAiRagInjectorPlugin(ctx)
...
func (r *PluginAiRagInjectorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiRagInjectorResourceModel
...
func (r *PluginAiRagInjectorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiRagInjectorResourceModel
	var plan types.Object
...
func (r *PluginAiRagInjectorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiRagInjectorResourceModel
	var item types.Object
...
func (r *PluginAiRagInjectorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
