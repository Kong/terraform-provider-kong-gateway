...
func (d DeleteAipromptdecoratorPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAipromptdecoratorPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteAipromptdecoratorPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteAipromptdecoratorPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAipromptdecoratorPluginResponse) UnmarshalJSON(data []byte) error {
