...
- `flow` (Attributes) The flow related configuration. Not Null (see [below for nested schema](#nestedatt--config--flow))
...
- `binds` (Attributes List) Not Null (see [below for nested schema](#nestedatt--config--flow--binds))
