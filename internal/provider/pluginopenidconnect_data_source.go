...
var _ datasource.DataSource = &PluginOpenidConnectDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOpenidConnectDataSource{}

func NewPluginOpenidConnectDataSource() datasource.DataSource {
	return &PluginOpenidConnectDataSource{}
}
...
// PluginOpenidConnectDataSourceModel describes the data model.
type PluginOpenidConnectDataSourceModel struct {
...
func (r *PluginOpenidConnectDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_openid_connect"
}

// Schema defines the schema for the data source.
func (r *PluginOpenidConnectDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOpenidConnect DataSource",
...
func (r *PluginOpenidConnectDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOpenidConnectDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOpenidConnectDataSourceModel
