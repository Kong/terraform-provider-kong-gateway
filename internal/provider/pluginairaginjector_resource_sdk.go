...
func (r *PluginAiRagInjectorResourceModel) ToSharedAiRagInjectorPlugin(ctx context.Context) (*shared.AiRagInjectorPlugin, diag.Diagnostics) {
	...
	var config *shared.AiRagInjectorPluginConfig
	if r.Config != nil {
		...
		if r.Config.Embeddings != nil {
			...
			var model *shared.AiRagInjectorPluginModel
			if r.Config.Embeddings.Model != nil {
				...
				provider := new(shared.AiRagInjectorPluginProvider)
		...
		if r.Config.Vectordb != nil {
			...
			distanceMetric := new(shared.AiRagInjectorPluginDistanceMetric)
			...
			strategy := new(shared.AiRagInjectorPluginStrategy)
	...
	if resp != nil {
		if resp.Config == nil {
			...
			if resp.Config.Vectordb == nil {
				...
				r.Config.Vectordb = &tfTypes.AiRagInjectorPluginVectordb{}
