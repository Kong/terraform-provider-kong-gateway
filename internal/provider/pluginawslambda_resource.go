...
var _ resource.Resource = &PluginAwsLambdaResource{}
var _ resource.ResourceWithImportState = &PluginAwsLambdaResource{}

func NewPluginAwsLambdaResource() resource.Resource {
	return &PluginAwsLambdaResource{}
}
...
func (r *PluginAwsLambdaResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"awsgateway_compatible_payload_version": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `An optional value that defines which version will be used to generate the AWS API Gateway compatible payload. The default will be ` + "`" + `1.0` + "`" + `. must be one of ["1.0", "2.0"]`,
						Validators: []validator.String{
...
func (r *PluginAwsLambdaResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAwsLambdaResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAwsLambdaResourceModel
...
func (r *PluginAwsLambdaResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAwsLambdaResourceModel
...
func (r *PluginAwsLambdaResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAwsLambdaResourceModel
	var plan types.Object
...
func (r *PluginAwsLambdaResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAwsLambdaResourceModel
	var item types.Object
...
func (r *PluginAwsLambdaResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
