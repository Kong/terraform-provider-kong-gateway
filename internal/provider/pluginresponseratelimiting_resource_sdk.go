...
func (r *PluginResponseRatelimitingResourceModel) RefreshFromSharedResponseRatelimitingPlugin(ctx context.Context, resp *shared.ResponseRatelimitingPlugin) diag.Diagnostics {
...
func (r *PluginResponseRatelimitingResourceModel) ToOperationsCreateResponseratelimitingPluginRequest(ctx context.Context) (*operations.CreateResponseratelimitingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginResponseRatelimitingResourceModel) ToOperationsDeleteResponseratelimitingPluginRequest(ctx context.Context) (*operations.DeleteResponseratelimitingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginResponseRatelimitingResourceModel) ToOperationsGetResponseratelimitingPluginRequest(ctx context.Context) (*operations.GetResponseratelimitingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginResponseRatelimitingResourceModel) ToOperationsUpdateResponseratelimitingPluginRequest(ctx context.Context) (*operations.UpdateResponseratelimitingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginResponseRatelimitingResourceModel) ToSharedResponseRatelimitingPlugin(ctx context.Context) (*shared.ResponseRatelimitingPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config != nil {
		...
		if r.Config.Redis != nil {
			...
			if r.Config.Redis.CloudAuthentication != nil {
				...
				var oauth *shared.ResponseRatelimitingPluginOauth
				if r.Config.Redis.CloudAuthentication.Oauth != nil {
					authMethod := new(shared.ResponseRatelimitingPluginAuthMethod)
					if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
						*authMethod = shared.ResponseRatelimitingPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
					} else {
						authMethod = nil
					}
					clientID := new(string)
					...
					clientSecretJwtAlg := new(shared.ResponseRatelimitingPluginClientSecretJwtAlg)
					if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
						*clientSecretJwtAlg = shared.ResponseRatelimitingPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
					} else {
						clientSecretJwtAlg = nil
					}
					grantType := new(shared.ResponseRatelimitingPluginGrantType)
					if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
						*grantType = shared.ResponseRatelimitingPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
					} else {
						grantType = nil
					}
					password := new(string)
					...
					oauth = &shared.ResponseRatelimitingPluginOauth{
