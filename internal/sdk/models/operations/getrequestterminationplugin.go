...
func (g GetRequestterminationPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestterminationPluginRequest) UnmarshalJSON(data []byte) error {
...
func (g *GetRequestterminationPluginRequest) GetWorkspace() string {
	if g == nil {
		return ""
	}
	return g.Workspace
...
func (g GetRequestterminationPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetRequestterminationPluginResponse) UnmarshalJSON(data []byte) error {
