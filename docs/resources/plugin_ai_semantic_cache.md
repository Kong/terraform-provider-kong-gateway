...
page_title: "kong-gateway_plugin_ai_semantic_cache Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginAiSemanticCache Resource
---

# kong-gateway_plugin_ai_semantic_cache (Resource)
...
```terraform
resource "kong-gateway_plugin_ai_semantic_cache" "my_pluginaisemanticcache" {
...
```shell
terraform import kong-gateway_plugin_ai_semantic_cache.my_kong-gateway_plugin_ai_semantic_cache '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
