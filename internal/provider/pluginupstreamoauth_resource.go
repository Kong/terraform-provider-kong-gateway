...
var _ resource.Resource = &PluginUpstreamOauthResource{}
var _ resource.ResourceWithImportState = &PluginUpstreamOauthResource{}

func NewPluginUpstreamOauthResource() resource.Resource {
	return &PluginUpstreamOauthResource{}
}
...
func (r *PluginUpstreamOauthResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_upstream_oauth"
}

func (r *PluginUpstreamOauthResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
					...
					"client": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							"auth_method": schema.StringAttribute{
								Computed:    true,
								Optional:    true,
								Description: `The authentication method used in client requests to the IdP. Supported values are: ` + "`" + `client_secret_basic` + "`" + ` to send ` + "`" + `client_id` + "`" + ` and ` + "`" + `client_secret` + "`" + ` in the ` + "`" + `Authorization: Basic` + "`" + ` header, ` + "`" + `client_secret_post` + "`" + ` to send ` + "`" + `client_id` + "`" + ` and ` + "`" + `client_secret` + "`" + ` as part of the request body, ` + "`" + `client_secret_jwt` + "`" + ` to send a JWT signed with the ` + "`" + `client_secret` + "`" + ` using the client assertion as part of the body, ` + "`" + `private_key_jwt` + "`" + ` to send a JWT signed with a private key, or ` + "`" + `none` + "`" + ` to send no client authentication. must be one of ["client_secret_basic", "client_secret_jwt", "client_secret_post", "none", "private_key_jwt"]`,
								Validators: []validator.String{
									stringvalidator.OneOf(
										"client_secret_basic",
										"client_secret_jwt",
							...
							"private_key_jwt_alg": schema.StringAttribute{
								Computed:    true,
								Optional:    true,
								Description: `The algorithm to use when signing the JWT client assertion for ` + "`" + `private_key_jwt` + "`" + ` authentication. This field is ignored when ` + "`" + `auth_method` + "`" + ` is not ` + "`" + `private_key_jwt` + "`" + `. must be one of ["ES256", "ES256K", "ES384", "ES512", "ESB256", "ESB320", "ESB384", "ESB512", "ESP256", "ESP384", "ESP512", "Ed25519", "Ed448", "EdDSA", "PS256", "PS384", "PS512", "RS256", "RS384", "RS512"]`,
								Validators: []validator.String{
									stringvalidator.OneOf(
										"ES256",
										"ES256K",
							...
							"private_key_jwt_include_kid": schema.BoolAttribute{
								Computed:    true,
								Optional:    true,
								Description: `Whether to include the configured Key ID as the ` + "`" + `kid` + "`" + ` header in the JWT client assertion for ` + "`" + `private_key_jwt` + "`" + ` authentication. This field is ignored when ` + "`" + `auth_method` + "`" + ` is not ` + "`" + `private_key_jwt` + "`" + `.`,
							},
...
func (r *PluginUpstreamOauthResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginUpstreamOauthResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginUpstreamOauthResourceModel
...
func (r *PluginUpstreamOauthResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginUpstreamOauthResourceModel
...
func (r *PluginUpstreamOauthResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginUpstreamOauthResourceModel
	var plan types.Object
...
func (r *PluginUpstreamOauthResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginUpstreamOauthResourceModel
	var item types.Object
...
func (r *PluginUpstreamOauthResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
