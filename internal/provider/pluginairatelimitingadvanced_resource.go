...
var _ resource.Resource = &PluginAiRateLimitingAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginAiRateLimitingAdvancedResource{}

func NewPluginAiRateLimitingAdvancedResource() resource.Resource {
	return &PluginAiRateLimitingAdvancedResource{}
}

// PluginAiRateLimitingAdvancedResource defines the resource implementation.
type PluginAiRateLimitingAdvancedResource struct {
...
func (r *PluginAiRateLimitingAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_rate_limiting_advanced"
}

func (r *PluginAiRateLimitingAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"tokens_count_strategy": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `What tokens to use for cost calculation. Available values are: ` + "`" + `total_tokens` + "`" + ` ` + "`" + `prompt_tokens` + "`" + `, ` + "`" + `completion_tokens` + "`" + ` or ` + "`" + `cost` + "`" + `. must be one of ["completion_tokens", "cost", "prompt_tokens", "total_tokens"]`,
						Validators: []validator.String{
							stringvalidator.OneOf(
								"completion_tokens",
								"cost",
...
func (r *PluginAiRateLimitingAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiRateLimitingAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiRateLimitingAdvancedResourceModel
...
func (r *PluginAiRateLimitingAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiRateLimitingAdvancedResourceModel
...
func (r *PluginAiRateLimitingAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiRateLimitingAdvancedResourceModel
	var plan types.Object
...
func (r *PluginAiRateLimitingAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiRateLimitingAdvancedResourceModel
	var item types.Object
...
func (r *PluginAiRateLimitingAdvancedResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
