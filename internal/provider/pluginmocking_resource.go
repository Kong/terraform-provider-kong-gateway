...
var _ resource.Resource = &PluginMockingResource{}
var _ resource.ResourceWithImportState = &PluginMockingResource{}

func NewPluginMockingResource() resource.Resource {
	return &PluginMockingResource{}
}
...
// PluginMockingResourceModel describes the resource data model.
type PluginMockingResourceModel struct {
	Config        *tfTypes.CreateMockingPluginConfig `tfsdk:"config"`
...
func (r *PluginMockingResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_mocking"
}

func (r *PluginMockingResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginMocking Resource",
...
func (r *PluginMockingResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginMockingResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginMockingResourceModel
	...
	request := data.ToSharedCreateMockingPlugin()
...
func (r *PluginMockingResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginMockingResourceModel
...
func (r *PluginMockingResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginMockingResourceModel
	var plan types.Object
	...
	createMockingPlugin := data.ToSharedCreateMockingPlugin()
	request := operations.UpdateMockingPluginRequest{
		PluginID:            pluginID,
		CreateMockingPlugin: createMockingPlugin,
	}
...
func (r *PluginMockingResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginMockingResourceModel
	var item types.Object
...
func (r *PluginMockingResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
