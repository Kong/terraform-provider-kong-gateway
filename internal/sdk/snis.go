...
func newSNIs(rootSDK *KongGateway, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SNIs {
	return &SNIs{
		rootSDK:          rootSDK,
...
// Create a new SNI
func (s *SNIs) CreateSni(ctx context.Context, request shared.Sni, opts ...operations.Option) (*operations.CreateSniResponse, error) {
