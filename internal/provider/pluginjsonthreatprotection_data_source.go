...
var _ datasource.DataSource = &PluginJSONThreatProtectionDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginJSONThreatProtectionDataSource{}

func NewPluginJSONThreatProtectionDataSource() datasource.DataSource {
	return &PluginJSONThreatProtectionDataSource{}
}
...
// PluginJSONThreatProtectionDataSourceModel describes the data model.
type PluginJSONThreatProtectionDataSourceModel struct {
...
func (r *PluginJSONThreatProtectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_json_threat_protection"
}

// Schema defines the schema for the data source.
func (r *PluginJSONThreatProtectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginJSONThreatProtection DataSource",
...
func (r *PluginJSONThreatProtectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginJSONThreatProtectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginJSONThreatProtectionDataSourceModel
