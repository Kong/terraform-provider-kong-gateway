...
var _ datasource.DataSource = &PluginCanaryDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginCanaryDataSource{}

func NewPluginCanaryDataSource() datasource.DataSource {
	return &PluginCanaryDataSource{}
}
...
// PluginCanaryDataSourceModel describes the data model.
type PluginCanaryDataSourceModel struct {
...
func (r *PluginCanaryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_canary"
}

// Schema defines the schema for the data source.
func (r *PluginCanaryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginCanary DataSource",
...
func (r *PluginCanaryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginCanaryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginCanaryDataSourceModel
