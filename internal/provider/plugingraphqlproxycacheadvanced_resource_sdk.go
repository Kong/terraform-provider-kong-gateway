...
func (r *PluginGraphqlProxyCacheAdvancedResourceModel) ToOperationsCreateGraphqlproxycacheadvancedPluginRequest(ctx context.Context) (*operations.CreateGraphqlproxycacheadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config != nil {
		...
		if r.Config.Redis != nil {
			...
			if r.Config.Redis.CloudAuthentication != nil {
				...
				var oauth *shared.GraphqlProxyCacheAdvancedPluginOauth
				if r.Config.Redis.CloudAuthentication.Oauth != nil {
					authMethod := new(shared.GraphqlProxyCacheAdvancedPluginAuthMethod)
					if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
						*authMethod = shared.GraphqlProxyCacheAdvancedPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
					} else {
						authMethod = nil
					}
					clientID := new(string)
					...
					clientSecretJwtAlg := new(shared.GraphqlProxyCacheAdvancedPluginClientSecretJwtAlg)
					if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
						*clientSecretJwtAlg = shared.GraphqlProxyCacheAdvancedPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
					} else {
						clientSecretJwtAlg = nil
					}
					grantType := new(shared.GraphqlProxyCacheAdvancedPluginGrantType)
					if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
						*grantType = shared.GraphqlProxyCacheAdvancedPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
					} else {
						grantType = nil
					}
					password := new(string)
					...
					oauth = &shared.GraphqlProxyCacheAdvancedPluginOauth{
