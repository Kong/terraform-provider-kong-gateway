...
var _ datasource.DataSource = &PluginConfluentConsumeDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginConfluentConsumeDataSource{}

func NewPluginConfluentConsumeDataSource() datasource.DataSource {
	return &PluginConfluentConsumeDataSource{}
}

// PluginConfluentConsumeDataSource is the data source implementation.
type PluginConfluentConsumeDataSource struct {
	client *sdk.KongGateway
}

// PluginConfluentConsumeDataSourceModel describes the data model.
type PluginConfluentConsumeDataSourceModel struct {
...
func (r *PluginConfluentConsumeDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_confluent_consume"
}

// Schema defines the schema for the data source.
func (r *PluginConfluentConsumeDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginConfluentConsume DataSource",
...
func (r *PluginConfluentConsumeDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginConfluentConsumeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginConfluentConsumeDataSourceModel
