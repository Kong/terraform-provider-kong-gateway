...
page_title: "kong-gateway_plugin_ai_proxy_advanced Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginAiProxyAdvanced Resource
---

# kong-gateway_plugin_ai_proxy_advanced (Resource)
...
- `service_tier_factor` (Attributes List) Multiplier applied to the whole request for a service tier. No need to configure a standard/default tier, as the default factor is 1.0 if none of the tier is matched. (see [below for nested schema](#nestedatt--config--targets--model--options--service_tier_factor))
...
<a id="nestedatt--config--targets--model--options--cache_write_cost_list"></a>
### Nested Schema for `config.targets.model.options.cache_write_cost_list`
...
<a id="nestedatt--config--targets--model--options--context_window_factor"></a>
### Nested Schema for `config.targets.model.options.context_window_factor`
...
<a id="nestedatt--config--targets--model--options--service_tier_factor"></a>
### Nested Schema for `config.targets.model.options.service_tier_factor`
