...
func (d DeleteAppdynamicsPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAppdynamicsPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteAppdynamicsPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteAppdynamicsPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteAppdynamicsPluginResponse) UnmarshalJSON(data []byte) error {
