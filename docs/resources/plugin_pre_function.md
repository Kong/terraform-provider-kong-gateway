...
```terraform
import {
  to = kong-gateway_plugin_pre_function.my_kong-gateway_plugin_pre_function
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_pre_function.my_kong-gateway_plugin_pre_function '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "747d1e5-8246-4f65-a939-b392f1ee17f8"}'
```
