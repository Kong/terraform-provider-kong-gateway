...
func (r *PluginHeaderCertAuthResourceModel) ToOperationsCreateHeadercertauthPluginRequest(ctx context.Context) (*operations.CreateHeadercertauthPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
