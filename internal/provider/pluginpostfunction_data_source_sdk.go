...
func (r *PluginPostFunctionDataSourceModel) ToOperationsGetPostfunctionPluginRequest(ctx context.Context) (*operations.GetPostfunctionPluginRequest, diag.Diagnostics) {
...
func (r *PluginPostFunctionDataSourceModel) RefreshFromSharedPostFunctionPlugin(ctx context.Context, resp *shared.PostFunctionPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
