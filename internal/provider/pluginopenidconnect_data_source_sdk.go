...
func (r *PluginOpenidConnectDataSourceModel) ToOperationsGetOpenidconnectPluginRequest(ctx context.Context) (*operations.GetOpenidconnectPluginRequest, diag.Diagnostics) {
...
func (r *PluginOpenidConnectDataSourceModel) RefreshFromSharedOpenidConnectPlugin(ctx context.Context, resp *shared.OpenidConnectPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
