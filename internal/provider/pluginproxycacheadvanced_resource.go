...
var _ resource.Resource = &PluginProxyCacheAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginProxyCacheAdvancedResource{}

func NewPluginProxyCacheAdvancedResource() resource.Resource {
	return &PluginProxyCacheAdvancedResource{}
}

// PluginProxyCacheAdvancedResource defines the resource implementation.
type PluginProxyCacheAdvancedResource struct {
...
type PluginProxyCacheAdvancedResourceModel struct {
	Config        *tfTypes.CreateProxyCacheAdvancedPluginConfig `tfsdk:"config"`
...
func (r *PluginProxyCacheAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_proxy_cache_advanced"
}

func (r *PluginProxyCacheAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginProxyCacheAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginProxyCacheAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginProxyCacheAdvancedResourceModel
	...
	request := data.ToSharedCreateProxyCacheAdvancedPlugin()
...
func (r *PluginProxyCacheAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginProxyCacheAdvancedResourceModel
...
func (r *PluginProxyCacheAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginProxyCacheAdvancedResourceModel
	var plan types.Object
	...
	createProxyCacheAdvancedPlugin := data.ToSharedCreateProxyCacheAdvancedPlugin()
	request := operations.UpdateProxycacheadvancedPluginRequest{
		PluginID:                       pluginID,
		CreateProxyCacheAdvancedPlugin: createProxyCacheAdvancedPlugin,
	}
...
func (r *PluginProxyCacheAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginProxyCacheAdvancedResourceModel
	var item types.Object
