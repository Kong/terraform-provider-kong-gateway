...
type Flow struct {
	...
	AckMode *AckMode `json:"ack_mode,omitempty"`
	...
	MaxUnackedMessages *int64 `json:"max_unacked_messages,omitempty"`
...
// ClientCredentials - Client credentials used to automatically obtain and renew OAuth2 access tokens from an IdP for the `CLIENT_CREDENTIALS` authentication scheme. When set, Kong fetches tokens from `token_endpoint` using `client_id` and `client_secret`, caches them until expiry, and retries with a fresh token whenever Solace returns an unauthenticated response.
type ClientCredentials struct {
	// The OAuth2 client ID used with `CLIENT_CREDENTIALS` authentication scheme when connecting to an event broker.
	ClientID string `json:"client_id"`
	// The OAuth2 client secret used with `CLIENT_CREDENTIALS` authentication scheme when connecting to an event broker.
	ClientSecret string `json:"client_secret"`
	// Number of seconds before actual expiry when cached access tokens should be considered expired and proactively renewed. This helps prevent edge cases where tokens are rejected by Solace just as they expire, but setting this too high may lead to unnecessary token refreshes.
	EagerlyExpire *int64 `json:"eagerly_expire,omitempty"`
	// The OAuth2 scopes to request when retrieving access tokens for the `CLIENT_CREDENTIALS` authentication scheme.
	Scopes []string `json:"scopes,omitempty"`
	// Controls TLS certificate verification for HTTPS token endpoint requests.
	SslVerify *bool `json:"ssl_verify,omitempty"`
	// The OAuth2 token endpoint URL used to retrieve access tokens for the `CLIENT_CREDENTIALS` authentication scheme when connecting to an event broker.
...
func (c *ClientCredentials) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"client_id", "client_secret", "token_endpoint"}); err != nil {
		return err
	}
	return nil
}

func (c *ClientCredentials) GetClientID() string {
	if c == nil {
		return ""
	}
	return c.ClientID
...
func (c *ClientCredentials) GetClientSecret() string {
	if c == nil {
		return ""
	}
...
func (c *ClientCredentials) GetEagerlyExpire() *int64 {
	if c == nil {
		return nil
	}
	return c.EagerlyExpire
}

func (c *ClientCredentials) GetScopes() []string {
	if c == nil {
		return nil
	}
	return c.Scopes
...
func (c *ClientCredentials) GetSslVerify() *bool {
	if c == nil {
		return nil
	}
	return c.SslVerify
...
func (c *ClientCredentials) GetTokenEndpoint() string {
	if c == nil {
		return ""
	}
...
const (
	...
	SolaceConsumePluginSchemeClientCredentials SolaceConsumePluginScheme = "CLIENT_CREDENTIALS"
...
type SolaceConsumePluginAuthentication struct {
	...
	// Client credentials used to automatically obtain and renew OAuth2 access tokens from an IdP for the `CLIENT_CREDENTIALS` authentication scheme. When set, Kong fetches tokens from `token_endpoint` using `client_id` and `client_secret`, caches them until expiry, and retries with a fresh token whenever Solace returns an unauthenticated response.
...
func (s *SolaceConsumePluginAuthentication) GetClientCredentials() *ClientCredentials {
	if s == nil {
		return nil
	}
...
type Session struct {
	...
	Authentication *SolaceConsumePluginAuthentication `json:"authentication,omitempty"`
...
type Websocket struct {
	...
	MaxRecvLen *int64 `json:"max_recv_len,omitempty"`
	// Specifies the maximal length of payload allowed when sending WebSocket frames.
	MaxSendLen *int64 `json:"max_send_len,omitempty"`
...
type SolaceConsumePluginConfig struct {
	...
	Mode *SolaceConsumePluginMode `json:"mode,omitempty"`
...
type SolaceConsumePlugin struct {
	...
	Ordering *SolaceConsumePluginOrdering `json:"ordering,omitempty"`
	// A list of partials to be used by the plugin.
	Partials []SolaceConsumePluginPartials `json:"partials,omitempty"`
	...
	Protocols []SolaceConsumePluginProtocols `json:"protocols,omitempty"`
	// If set, the plugin will only activate when receiving requests via the specified route. Leave unset for the plugin to activate regardless of the route being used.
	Route *SolaceConsumePluginRoute `json:"route,omitempty"`
	// If set, the plugin will only activate when receiving requests via one of the routes belonging to the specified Service. Leave unset for the plugin to activate regardless of the Service being matched.
	Service *SolaceConsumePluginService `json:"service,omitempty"`
}
