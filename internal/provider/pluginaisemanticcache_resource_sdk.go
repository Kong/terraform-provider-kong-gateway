...
func (r *PluginAiSemanticCacheResourceModel) RefreshFromSharedAiSemanticCachePlugin(ctx context.Context, resp *shared.AiSemanticCachePlugin) diag.Diagnostics {
...
func (r *PluginAiSemanticCacheResourceModel) ToOperationsCreateAisemanticcachePluginRequest(ctx context.Context) (*operations.CreateAisemanticcachePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticCacheResourceModel) ToOperationsDeleteAisemanticcachePluginRequest(ctx context.Context) (*operations.DeleteAisemanticcachePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticCacheResourceModel) ToOperationsGetAisemanticcachePluginRequest(ctx context.Context) (*operations.GetAisemanticcachePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticCacheResourceModel) ToOperationsUpdateAisemanticcachePluginRequest(ctx context.Context) (*operations.UpdateAisemanticcachePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticCacheResourceModel) ToSharedAiSemanticCachePlugin(ctx context.Context) (*shared.AiSemanticCachePlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Embeddings.Model.Options != nil {
		var azure *shared.AiSemanticCachePluginAzure
	...
	if r.Config.Vectordb.Redis != nil {
		var cloudAuthentication *shared.AiSemanticCachePluginCloudAuthentication
		if r.Config.Vectordb.Redis.CloudAuthentication != nil {
			authProvider := new(shared.AiSemanticCachePluginAuthProvider)
			if !r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.IsNull() {
				*authProvider = shared.AiSemanticCachePluginAuthProvider(r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.ValueString())
			} else {
				authProvider = nil
			}
			...
			var oauth *shared.AiSemanticCachePluginOauth
			if r.Config.Vectordb.Redis.CloudAuthentication.Oauth != nil {
				authMethod := new(shared.AiSemanticCachePluginAuthMethod)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
					*authMethod = shared.AiSemanticCachePluginAuthMethod(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
				} else {
					authMethod = nil
				}
				clientID := new(string)
				...
				clientSecretJwtAlg := new(shared.AiSemanticCachePluginClientSecretJwtAlg)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
					*clientSecretJwtAlg = shared.AiSemanticCachePluginClientSecretJwtAlg(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
				} else {
					clientSecretJwtAlg = nil
				}
				grantType := new(shared.AiSemanticCachePluginGrantType)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
					*grantType = shared.AiSemanticCachePluginGrantType(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
				} else {
					grantType = nil
				}
				...
				oauth = &shared.AiSemanticCachePluginOauth{
			...
			cloudAuthentication = &shared.AiSemanticCachePluginCloudAuthentication{
