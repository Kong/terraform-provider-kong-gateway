...
var _ resource.Resource = &PluginAIPromptDecoratorResource{}
var _ resource.ResourceWithImportState = &PluginAIPromptDecoratorResource{}

func NewPluginAIPromptDecoratorResource() resource.Resource {
	return &PluginAIPromptDecoratorResource{}
}

// PluginAIPromptDecoratorResource defines the resource implementation.
type PluginAIPromptDecoratorResource struct {
...
func (r *PluginAIPromptDecoratorResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_prompt_decorator"
}

func (r *PluginAIPromptDecoratorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginAIPromptDecoratorResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAIPromptDecoratorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAIPromptDecoratorResourceModel
...
func (r *PluginAIPromptDecoratorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAIPromptDecoratorResourceModel
...
func (r *PluginAIPromptDecoratorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAIPromptDecoratorResourceModel
	var plan types.Object
...
func (r *PluginAIPromptDecoratorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAIPromptDecoratorResourceModel
	var item types.Object
...
func (r *PluginAIPromptDecoratorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
