...
func (g GetWebsocketvalidatorPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetWebsocketvalidatorPluginRequest) UnmarshalJSON(data []byte) error {
...
func (g *GetWebsocketvalidatorPluginRequest) GetWorkspace() string {
	if g == nil {
		return ""
	}
	return g.Workspace
...
func (g GetWebsocketvalidatorPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetWebsocketvalidatorPluginResponse) UnmarshalJSON(data []byte) error {
