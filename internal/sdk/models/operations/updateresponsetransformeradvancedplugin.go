...
func (u UpdateResponsetransformeradvancedPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateResponsetransformeradvancedPluginResponse) UnmarshalJSON(data []byte) error {
