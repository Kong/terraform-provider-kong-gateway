...
func newKeys(rootSDK *KongGateway, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Keys {
	return &Keys{
		rootSDK:          rootSDK,
...
// Create a new Key
func (s *Keys) CreateKey(ctx context.Context, request shared.Key, opts ...operations.Option) (*operations.CreateKeyResponse, error) {
