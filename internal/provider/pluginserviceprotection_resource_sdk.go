...
func (r *PluginServiceProtectionResourceModel) RefreshFromSharedServiceProtectionPlugin(ctx context.Context, resp *shared.ServiceProtectionPlugin) diag.Diagnostics {
...
func (r *PluginServiceProtectionResourceModel) ToOperationsCreateServiceprotectionPluginRequest(ctx context.Context) (*operations.CreateServiceprotectionPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginServiceProtectionResourceModel) ToOperationsDeleteServiceprotectionPluginRequest(ctx context.Context) (*operations.DeleteServiceprotectionPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginServiceProtectionResourceModel) ToOperationsGetServiceprotectionPluginRequest(ctx context.Context) (*operations.GetServiceprotectionPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginServiceProtectionResourceModel) ToOperationsUpdateServiceprotectionPluginRequest(ctx context.Context) (*operations.UpdateServiceprotectionPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginServiceProtectionResourceModel) ToSharedServiceProtectionPlugin(ctx context.Context) (*shared.ServiceProtectionPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Redis != nil {
		var cloudAuthentication *shared.ServiceProtectionPluginCloudAuthentication
		if r.Config.Redis.CloudAuthentication != nil {
			authProvider := new(shared.ServiceProtectionPluginAuthProvider)
			if !r.Config.Redis.CloudAuthentication.AuthProvider.IsUnknown() && !r.Config.Redis.CloudAuthentication.AuthProvider.IsNull() {
				*authProvider = shared.ServiceProtectionPluginAuthProvider(r.Config.Redis.CloudAuthentication.AuthProvider.ValueString())
			} else {
				authProvider = nil
			}
			...
			var oauth *shared.ServiceProtectionPluginOauth
			if r.Config.Redis.CloudAuthentication.Oauth != nil {
				authMethod := new(shared.ServiceProtectionPluginAuthMethod)
				if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
					*authMethod = shared.ServiceProtectionPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
				} else {
					authMethod = nil
				}
				clientID := new(string)
				...
				clientSecretJwtAlg := new(shared.ServiceProtectionPluginClientSecretJwtAlg)
				if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
					*clientSecretJwtAlg = shared.ServiceProtectionPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
				} else {
					clientSecretJwtAlg = nil
				}
				grantType := new(shared.ServiceProtectionPluginGrantType)
				if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
					*grantType = shared.ServiceProtectionPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
				} else {
					grantType = nil
				}
				password := new(string)
				...
				oauth = &shared.ServiceProtectionPluginOauth{
			...
			cloudAuthentication = &shared.ServiceProtectionPluginCloudAuthentication{
