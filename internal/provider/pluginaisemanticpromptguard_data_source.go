...
var _ datasource.DataSource = &PluginAiSemanticPromptGuardDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiSemanticPromptGuardDataSource{}

func NewPluginAiSemanticPromptGuardDataSource() datasource.DataSource {
	return &PluginAiSemanticPromptGuardDataSource{}
}
...
// PluginAiSemanticPromptGuardDataSourceModel describes the data model.
type PluginAiSemanticPromptGuardDataSourceModel struct {
...
func (r *PluginAiSemanticPromptGuardDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_semantic_prompt_guard"
}

// Schema defines the schema for the data source.
func (r *PluginAiSemanticPromptGuardDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiSemanticPromptGuard DataSource",
...
func (r *PluginAiSemanticPromptGuardDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiSemanticPromptGuardDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiSemanticPromptGuardDataSourceModel
