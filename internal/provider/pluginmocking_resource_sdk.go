...
func (r *PluginMockingResourceModel) ToSharedCreateMockingPlugin() *shared.CreateMockingPlugin {
	var config *shared.CreateMockingPluginConfig
	if r.Config != nil {
		...
		config = &shared.CreateMockingPluginConfig{
	...
	var protocols []shared.CreateMockingPluginProtocols = []shared.CreateMockingPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateMockingPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateMockingPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateMockingPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateMockingPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateMockingPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateMockingPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateMockingPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateMockingPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateMockingPluginService{
			ID: id3,
		}
	}
	out := shared.CreateMockingPlugin{
		Config:        config,
		Enabled:       enabled,
