...
page_title: "kong-gateway_plugin_entitlement_enforcement Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginEntitlementEnforcement Resource
---

# kong-gateway_plugin_entitlement_enforcement (Resource)
...
```terraform
resource "kong-gateway_plugin_entitlement_enforcement" "my_pluginentitlementenforcement" {
  ...
  config = {
    ...
    keepalive            = 1.38
    l1_cache_ttl_seconds = 0.31
    l2_cache_ttl_seconds = 3.43
    max_stale_seconds    = 9.76
    redis = {
      ...
      connect_timeout       = 374402181
      connection_is_proxied = false
      database              = 5
      host                  = "...my_host..."
      keepalive_backlog     = 390437893
      keepalive_pool_size   = 1375755440
      password              = "...my_password..."
      port                  = 60102
      read_timeout          = 1993178795
      send_timeout          = 1674808650
...
- `api_token` (String) Bearer token for authenticating with the entitlement access endpoint.
- `entitlement_access_endpoint` (String) A string representing a URL, such as https://example.com/path/to/resource?q=search.
- `feature` (Attributes) The feature identifies what capability is being accessed and enforced. (see [below for nested schema](#nestedatt--config--feature))

Optional:

- `credit_balance_required` (Boolean) If set to true, gateway will fetch credit balance for subject.
- `customer` (Attributes) The customer identifies who gets billed for each request. Choose where the plugin should look for the customer identifier. (see [below for nested schema](#nestedatt--config--customer))
- `deny_unknown_customers` (Boolean) If set to true, gateway will deny access to any unknown subjects.
- `fail_policy` (String) Policy to apply when enforcement state cannot be retrieved. must be one of ["allow", "block"]
...
- `response_codes` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes))
...
<a id="nestedatt--config--feature"></a>
### Nested Schema for `config.feature`
...
<a id="nestedatt--config--customer"></a>
### Nested Schema for `config.customer`
...
<a id="nestedatt--config--response_codes"></a>
### Nested Schema for `config.response_codes`

Optional:

- `customer_not_found` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes--customer_not_found))
- `feature_not_found` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes--feature_not_found))
- `feature_unavailable` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes--feature_unavailable))
- `no_credit_available` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes--no_credit_available))
- `usage_limit_reached` (Attributes) (see [below for nested schema](#nestedatt--config--response_codes--usage_limit_reached))

<a id="nestedatt--config--response_codes--customer_not_found"></a>
### Nested Schema for `config.response_codes.customer_not_found`
...
<a id="nestedatt--config--response_codes--feature_not_found"></a>
### Nested Schema for `config.response_codes.feature_not_found`
...
<a id="nestedatt--config--response_codes--feature_unavailable"></a>
### Nested Schema for `config.response_codes.feature_unavailable`
...
<a id="nestedatt--config--response_codes--no_credit_available"></a>
### Nested Schema for `config.response_codes.no_credit_available`
...
<a id="nestedatt--config--response_codes--usage_limit_reached"></a>
### Nested Schema for `config.response_codes.usage_limit_reached`
...
```terraform
import {
  to = kong-gateway_plugin_entitlement_enforcement.my_kong-gateway_plugin_entitlement_enforcement
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_entitlement_enforcement.my_kong-gateway_plugin_entitlement_enforcement '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
