...
var _ datasource.DataSource = &PluginOpentelemetryDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOpentelemetryDataSource{}

func NewPluginOpentelemetryDataSource() datasource.DataSource {
	return &PluginOpentelemetryDataSource{}
}
...
// PluginOpentelemetryDataSourceModel describes the data model.
type PluginOpentelemetryDataSourceModel struct {
...
func (r *PluginOpentelemetryDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_opentelemetry"
}

// Schema defines the schema for the data source.
func (r *PluginOpentelemetryDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOpentelemetry DataSource",
...
func (r *PluginOpentelemetryDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOpentelemetryDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOpentelemetryDataSourceModel
