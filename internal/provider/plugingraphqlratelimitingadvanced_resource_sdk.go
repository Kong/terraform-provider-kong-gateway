...
func (r *PluginGraphqlRateLimitingAdvancedResourceModel) ToOperationsCreateGraphqlratelimitingadvancedPluginRequest(ctx context.Context) (*operations.CreateGraphqlratelimitingadvancedPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginGraphqlRateLimitingAdvancedResourceModel) ToSharedGraphqlRateLimitingAdvancedPlugin(ctx context.Context) (*shared.GraphqlRateLimitingAdvancedPlugin, diag.Diagnostics) {
	...
	if r.Config.Redis != nil {
		...
		if r.Config.Redis.CloudAuthentication != nil {
			...
			var oauth *shared.GraphqlRateLimitingAdvancedPluginOauth
			if r.Config.Redis.CloudAuthentication.Oauth != nil {
				authMethod := new(shared.GraphqlRateLimitingAdvancedPluginAuthMethod)
				if !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
					*authMethod = shared.GraphqlRateLimitingAdvancedPluginAuthMethod(r.Config.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
				} else {
					authMethod = nil
				}
				clientID := new(string)
				...
				clientSecretJwtAlg := new(shared.GraphqlRateLimitingAdvancedPluginClientSecretJwtAlg)
				if !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
					*clientSecretJwtAlg = shared.GraphqlRateLimitingAdvancedPluginClientSecretJwtAlg(r.Config.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
				} else {
					clientSecretJwtAlg = nil
				}
				grantType := new(shared.GraphqlRateLimitingAdvancedPluginGrantType)
				if !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
					*grantType = shared.GraphqlRateLimitingAdvancedPluginGrantType(r.Config.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
				} else {
					grantType = nil
				}
				password := new(string)
				...
				oauth = &shared.GraphqlRateLimitingAdvancedPluginOauth{
