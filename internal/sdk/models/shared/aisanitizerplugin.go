...
type AiSanitizerPluginConfig struct {
	...
	BlockIfDetected *bool `json:"block_if_detected,omitempty"`
	...
	SanitizationMode *SanitizationMode `json:"sanitization_mode,omitempty"`
	...
	SkipLoggingSanitizedItems *bool `json:"skip_logging_sanitized_items,omitempty"`
