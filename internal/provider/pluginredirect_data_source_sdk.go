...
func (r *PluginRedirectDataSourceModel) ToOperationsGetRedirectPluginRequest(ctx context.Context) (*operations.GetRedirectPluginRequest, diag.Diagnostics) {
...
func (r *PluginRedirectDataSourceModel) RefreshFromSharedRedirectPlugin(ctx context.Context, resp *shared.RedirectPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
