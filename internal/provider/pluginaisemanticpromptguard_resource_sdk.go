		...
		if resp.Config.Vectordb.Redis == nil {
			...
			if resp.Config.Vectordb.Redis.CloudAuthentication == nil {
				...
				if resp.Config.Vectordb.Redis.CloudAuthentication.Oauth == nil {
					...
					if len(resp.Config.Vectordb.Redis.CloudAuthentication.Oauth.TokenHeaders) > 0 {
					...
					if len(resp.Config.Vectordb.Redis.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
...
func (r *PluginAiSemanticPromptGuardResourceModel) ToOperationsCreateAisemanticpromptguardPluginRequest(ctx context.Context) (*operations.CreateAisemanticpromptguardPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticPromptGuardResourceModel) ToSharedAiSemanticPromptGuardPlugin(ctx context.Context) (*shared.AiSemanticPromptGuardPlugin, diag.Diagnostics) {
	...
	var ordering *shared.AiSemanticPromptGuardPluginOrdering
	if r.Ordering != nil {
		...
		ordering = &shared.AiSemanticPromptGuardPluginOrdering{
			After:  after,
			Before: before,
		}
	}
	...
	var auth *shared.AiSemanticPromptGuardPluginAuth
	if r.Config.Embeddings.Auth != nil {
		...
		paramLocation := new(shared.AiSemanticPromptGuardPluginParamLocation)
		if !r.Config.Embeddings.Auth.ParamLocation.IsUnknown() && !r.Config.Embeddings.Auth.ParamLocation.IsNull() {
			*paramLocation = shared.AiSemanticPromptGuardPluginParamLocation(r.Config.Embeddings.Auth.ParamLocation.ValueString())
		} else {
			paramLocation = nil
		}
		...
		auth = &shared.AiSemanticPromptGuardPluginAuth{
	...
	provider := shared.AiSemanticPromptGuardPluginProvider(r.Config.Embeddings.Model.Provider.ValueString())
	model := shared.AiSemanticPromptGuardPluginModel{
		Name:     name1,
		Options:  optionsVar,
		Provider: provider,
	}
	embeddings := shared.AiSemanticPromptGuardPluginEmbeddings{
		Auth:  auth,
		Model: model,
	}
	genaiCategory := new(shared.AiSemanticPromptGuardPluginGenaiCategory)
	if !r.Config.GenaiCategory.IsUnknown() && !r.Config.GenaiCategory.IsNull() {
		*genaiCategory = shared.AiSemanticPromptGuardPluginGenaiCategory(r.Config.GenaiCategory.ValueString())
	} else {
		genaiCategory = nil
	}
	...
	if r.Config.Rules != nil {
		...
		if !r.Config.Rules.MatchAllConversationHistory.IsUnknown() && !r.Config.Rules.MatchAllConversationHistory.IsNull() {
			*matchAllConversationHistory = r.Config.Rules.MatchAllConversationHistory.ValueBool()
		} else {
			matchAllConversationHistory = nil
		}
		matchAllRoles := new(bool)
		if !r.Config.Rules.MatchAllRoles.IsUnknown() && !r.Config.Rules.MatchAllRoles.IsNull() {
			*matchAllRoles = r.Config.Rules.MatchAllRoles.ValueBool()
		} else {
			matchAllRoles = nil
		}
		maxRequestBodySize1 := new(int64)
		if !r.Config.Rules.MaxRequestBodySize.IsUnknown() && !r.Config.Rules.MaxRequestBodySize.IsNull() {
			*maxRequestBodySize1 = r.Config.Rules.MaxRequestBodySize.ValueInt64()
		} else {
	...
	distanceMetric := shared.AiSemanticPromptGuardPluginDistanceMetric(r.Config.Vectordb.DistanceMetric.ValueString())
	...
	if r.Config.Vectordb.Redis != nil {
		var cloudAuthentication *shared.AiSemanticPromptGuardPluginCloudAuthentication
		if r.Config.Vectordb.Redis.CloudAuthentication != nil {
			authProvider := new(shared.AiSemanticPromptGuardPluginAuthProvider)
			if !r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.IsNull() {
				*authProvider = shared.AiSemanticPromptGuardPluginAuthProvider(r.Config.Vectordb.Redis.CloudAuthentication.AuthProvider.ValueString())
			} else {
				authProvider = nil
			}
			...
			var oauth *shared.AiSemanticPromptGuardPluginOauth
			if r.Config.Vectordb.Redis.CloudAuthentication.Oauth != nil {
				authMethod := new(shared.AiSemanticPromptGuardPluginAuthMethod)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
					*authMethod = shared.AiSemanticPromptGuardPluginAuthMethod(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
				} else {
					authMethod = nil
				}
				clientID := new(string)
				...
				clientSecretJwtAlg := new(shared.AiSemanticPromptGuardPluginClientSecretJwtAlg)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
					*clientSecretJwtAlg = shared.AiSemanticPromptGuardPluginClientSecretJwtAlg(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
				} else {
					clientSecretJwtAlg = nil
				}
				grantType := new(shared.AiSemanticPromptGuardPluginGrantType)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
					*grantType = shared.AiSemanticPromptGuardPluginGrantType(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
				} else {
					grantType = nil
				}
				...
				oauth = &shared.AiSemanticPromptGuardPluginOauth{
			...
			cloudAuthentication = &shared.AiSemanticPromptGuardPluginCloudAuthentication{
		...
		sentinelRole := new(shared.AiSemanticPromptGuardPluginSentinelRole)
		if !r.Config.Vectordb.Redis.SentinelRole.IsUnknown() && !r.Config.Vectordb.Redis.SentinelRole.IsNull() {
			*sentinelRole = shared.AiSemanticPromptGuardPluginSentinelRole(r.Config.Vectordb.Redis.SentinelRole.ValueString())
		} else {
			sentinelRole = nil
		}
		...
		redis = &shared.AiSemanticPromptGuardPluginRedis{
	...
	strategy := shared.AiSemanticPromptGuardPluginStrategy(r.Config.Vectordb.Strategy.ValueString())
	...
	var consumer *shared.AiSemanticPromptGuardPluginConsumer
	if r.Consumer != nil {
		id2 := new(string)
		...
		consumer = &shared.AiSemanticPromptGuardPluginConsumer{
			ID: id2,
		}
	}
	var consumerGroup *shared.AiSemanticPromptGuardPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.AiSemanticPromptGuardPluginConsumerGroup{
			ID: id3,
		}
	}
	...
	var route *shared.AiSemanticPromptGuardPluginRoute
	if r.Route != nil {
		id4 := new(string)
		...
		route = &shared.AiSemanticPromptGuardPluginRoute{
			ID: id4,
		}
	}
	var service *shared.AiSemanticPromptGuardPluginService
	if r.Service != nil {
		id5 := new(string)
		...
		service = &shared.AiSemanticPromptGuardPluginService{
			ID: id5,
		}
	}
