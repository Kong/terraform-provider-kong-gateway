...
func (r *PluginPostFunctionResourceModel) ToSharedPostFunctionPlugin() *shared.PostFunctionPlugin {
	createdAt := new(int64)
	...
	var partials []shared.PostFunctionPluginPartials = []shared.PostFunctionPluginPartials{}
