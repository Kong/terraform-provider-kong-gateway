...
func (r *PluginKafkaConsumeDataSourceModel) ToOperationsGetKafkaconsumePluginRequest(ctx context.Context) (*operations.GetKafkaconsumePluginRequest, diag.Diagnostics) {
...
func (r *PluginKafkaConsumeDataSourceModel) RefreshFromSharedKafkaConsumePlugin(ctx context.Context, resp *shared.KafkaConsumePlugin) diag.Diagnostics {
	var diags diag.Diagnostics
