...
func (r *PluginWebsocketValidatorResourceModel) ToSharedWebsocketValidatorPlugin() *shared.WebsocketValidatorPlugin {
	createdAt := new(int64)
	...
	var partials []shared.WebsocketValidatorPluginPartials = []shared.WebsocketValidatorPluginPartials{}
