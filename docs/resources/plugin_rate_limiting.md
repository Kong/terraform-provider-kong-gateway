...
```shell
terraform import kong-gateway_plugin_rate_limiting.my_kong-gateway_plugin_rate_limiting '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
