...
page_title: "kong-gateway_plugin_canary Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginCanary Resource
---

# kong-gateway_plugin_canary (Resource)
...
```terraform
resource "kong-gateway_plugin_canary" "my_plugincanary" {
  config = {
...
```terraform
import {
  to = kong-gateway_plugin_canary.my_kong-gateway_plugin_canary
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_canary.my_kong-gateway_plugin_canary '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "747d1e5-8246-4f65-a939-b392f1ee17f8"}'
```
