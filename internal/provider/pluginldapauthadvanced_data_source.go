...
var _ datasource.DataSource = &PluginLdapAuthAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginLdapAuthAdvancedDataSource{}

func NewPluginLdapAuthAdvancedDataSource() datasource.DataSource {
	return &PluginLdapAuthAdvancedDataSource{}
}

// PluginLdapAuthAdvancedDataSource is the data source implementation.
type PluginLdapAuthAdvancedDataSource struct {
	client *sdk.KongGateway
}

// PluginLdapAuthAdvancedDataSourceModel describes the data model.
type PluginLdapAuthAdvancedDataSourceModel struct {
...
func (r *PluginLdapAuthAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ldap_auth_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginLdapAuthAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginLdapAuthAdvanced DataSource",
...
func (r *PluginLdapAuthAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginLdapAuthAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginLdapAuthAdvancedDataSourceModel
