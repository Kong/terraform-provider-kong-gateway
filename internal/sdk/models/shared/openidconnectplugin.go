...
func (e *ClusterCacheItems) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "introspection":
		fallthrough
	case "tokens":
		*e = ClusterCacheItems(v)
		return nil
	default:
		return fmt.Errorf("invalid value for ClusterCacheItems: %v", v)
	}
}
...
func (e *OpenidConnectPluginCertificateHeaderFormat) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "base64_encoded":
		fallthrough
	case "url_encoded":
		*e = OpenidConnectPluginCertificateHeaderFormat(v)
		return nil
	default:
		return fmt.Errorf("invalid value for OpenidConnectPluginCertificateHeaderFormat: %v", v)
	}
}
...
func (e *OpenidConnectPluginRevocationCheckMode) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "SKIP":
		fallthrough
	case "STRICT":
		*e = OpenidConnectPluginRevocationCheckMode(v)
		return nil
	default:
		return fmt.Errorf("invalid value for OpenidConnectPluginRevocationCheckMode: %v", v)
	}
}
...
type ProofOfPossessionMtlsFromHeader struct {
	...
	CertificateHeaderFormat *OpenidConnectPluginCertificateHeaderFormat `json:"certificate_header_format,omitempty"`
	...
	RevocationCheckMode *OpenidConnectPluginRevocationCheckMode `json:"revocation_check_mode,omitempty"`
