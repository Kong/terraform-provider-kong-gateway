	...
	if resp != nil {
		...
		if len(resp.Config.CustomFieldsByLua) > 0 {
			...
			for key1, value1 := range resp.Config.CustomFieldsByLua {
				r.Config.CustomFieldsByLua[key1] = types.StringValue(value1)
			}
		}
...
func (r *PluginKafkaLogResourceModel) ToOperationsCreateKafkalogPluginRequest(ctx context.Context) (*operations.CreateKafkalogPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginKafkaLogResourceModel) ToSharedKafkaLogPlugin(ctx context.Context) (*shared.KafkaLogPlugin, diag.Diagnostics) {
	...
	if r.Config.Authentication != nil {
		...
		var oauthbearer *shared.KafkaLogPluginOauthbearer
		if r.Config.Authentication.Oauthbearer != nil {
			...
			oauthbearer = &shared.KafkaLogPluginOauthbearer{
				ClientID:               clientID,
