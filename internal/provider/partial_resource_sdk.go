	...
	if resp != nil {
		...
		if resp.PartialRedisCe != nil {
			...
			if resp.PartialRedisCe.Config.CloudAuthentication == nil {
				...
				if resp.PartialRedisCe.Config.CloudAuthentication.Oauth == nil {
					...
					if len(resp.PartialRedisCe.Config.CloudAuthentication.Oauth.TokenHeaders) > 0 {
					...
					if len(resp.PartialRedisCe.Config.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
		...
		if resp.PartialRedisEe != nil {
			...
			if resp.PartialRedisEe.Config.CloudAuthentication == nil {
				...
				if resp.PartialRedisEe.Config.CloudAuthentication.Oauth == nil {
					...
					if len(resp.PartialRedisEe.Config.CloudAuthentication.Oauth.TokenHeaders) > 0 {
					...
					if len(resp.PartialRedisEe.Config.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
		...
		if resp.PartialVectordb != nil {
			...
			if resp.PartialVectordb.Config.Redis == nil {
				...
				r.Vectordb.Config.Redis = &tfTypes.PartialRedisEeConfig{}
				if resp.PartialVectordb.Config.Redis.CloudAuthentication == nil {
					...
					if resp.PartialVectordb.Config.Redis.CloudAuthentication.Oauth == nil {
						...
						if len(resp.PartialVectordb.Config.Redis.CloudAuthentication.Oauth.TokenHeaders) > 0 {
						...
						if len(resp.PartialVectordb.Config.Redis.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
