...
func (r *PluginKeyAuthEncResourceModel) ToSharedKeyAuthEncPluginInput() *shared.KeyAuthEncPluginInput {
	...
	var consumer *shared.KeyAuthEncPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.KeyAuthEncPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.KeyAuthEncPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.KeyAuthEncPluginConsumerGroup{
			ID: id1,
		}
	}
	enabled := new(bool)
	...
	out := shared.KeyAuthEncPluginInput{
		Config:        config,
		Consumer:      consumer,
