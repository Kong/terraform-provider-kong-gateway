...
func (r *PluginOauth2IntrospectionResourceModel) RefreshFromSharedOauth2IntrospectionPlugin(ctx context.Context, resp *shared.Oauth2IntrospectionPlugin) diag.Diagnostics {
	...
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config.IntrospectionURL = types.StringValue(resp.Config.IntrospectionURL)
...
func (r *PluginOauth2IntrospectionResourceModel) ToOperationsCreateOauth2introspectionPluginRequest(ctx context.Context) (*operations.CreateOauth2introspectionPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
