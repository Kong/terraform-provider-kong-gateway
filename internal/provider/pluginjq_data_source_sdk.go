...
func (r *PluginJqDataSourceModel) ToOperationsGetJqPluginRequest(ctx context.Context) (*operations.GetJqPluginRequest, diag.Diagnostics) {
...
func (r *PluginJqDataSourceModel) RefreshFromSharedJqPlugin(ctx context.Context, resp *shared.JqPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
