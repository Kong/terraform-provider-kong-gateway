...
var _ datasource.DataSource = &PluginAiProxyAdvancedDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiProxyAdvancedDataSource{}

func NewPluginAiProxyAdvancedDataSource() datasource.DataSource {
	return &PluginAiProxyAdvancedDataSource{}
}

// PluginAiProxyAdvancedDataSource is the data source implementation.
type PluginAiProxyAdvancedDataSource struct {
	client *sdk.KongGateway
}

// PluginAiProxyAdvancedDataSourceModel describes the data model.
type PluginAiProxyAdvancedDataSourceModel struct {
...
func (r *PluginAiProxyAdvancedDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_proxy_advanced"
}

// Schema defines the schema for the data source.
func (r *PluginAiProxyAdvancedDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiProxyAdvanced DataSource",
...
func (r *PluginAiProxyAdvancedDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiProxyAdvancedDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiProxyAdvancedDataSourceModel
