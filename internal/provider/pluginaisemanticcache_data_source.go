...
var _ datasource.DataSource = &PluginAiSemanticCacheDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiSemanticCacheDataSource{}

func NewPluginAiSemanticCacheDataSource() datasource.DataSource {
	return &PluginAiSemanticCacheDataSource{}
}
...
// PluginAiSemanticCacheDataSourceModel describes the data model.
type PluginAiSemanticCacheDataSourceModel struct {
...
func (r *PluginAiSemanticCacheDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_semantic_cache"
}

// Schema defines the schema for the data source.
func (r *PluginAiSemanticCacheDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiSemanticCache DataSource",
...
func (r *PluginAiSemanticCacheDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiSemanticCacheDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiSemanticCacheDataSourceModel
