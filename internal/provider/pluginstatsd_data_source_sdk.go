...
func (r *PluginStatsdDataSourceModel) ToOperationsGetStatsdPluginRequest(ctx context.Context) (*operations.GetStatsdPluginRequest, diag.Diagnostics) {
...
func (r *PluginStatsdDataSourceModel) RefreshFromSharedStatsdPlugin(ctx context.Context, resp *shared.StatsdPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
