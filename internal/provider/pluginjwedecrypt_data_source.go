...
var _ datasource.DataSource = &PluginJweDecryptDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginJweDecryptDataSource{}

func NewPluginJweDecryptDataSource() datasource.DataSource {
	return &PluginJweDecryptDataSource{}
}
...
func (r *PluginJweDecryptDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_jwe_decrypt"
}

// Schema defines the schema for the data source.
func (r *PluginJweDecryptDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginJweDecrypt DataSource",
...
func (r *PluginJweDecryptDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginJweDecryptDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginJweDecryptDataSourceModel
