...
func (r *PluginServiceProtectionResourceModel) ToSharedServiceProtectionPlugin() *shared.ServiceProtectionPlugin {
	createdAt := new(int64)
	...
	var partials []shared.ServiceProtectionPluginPartials = []shared.ServiceProtectionPluginPartials{}
...
func (r *PluginServiceProtectionResourceModel) RefreshFromSharedServiceProtectionPlugin(resp *shared.ServiceProtectionPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
