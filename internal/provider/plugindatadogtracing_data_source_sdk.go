...
func (r *PluginDatadogTracingDataSourceModel) ToOperationsGetDatadogtracingPluginRequest(ctx context.Context) (*operations.GetDatadogtracingPluginRequest, diag.Diagnostics) {
...
func (r *PluginDatadogTracingDataSourceModel) RefreshFromSharedDatadogTracingPlugin(ctx context.Context, resp *shared.DatadogTracingPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
