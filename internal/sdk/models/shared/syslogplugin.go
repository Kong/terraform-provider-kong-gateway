...
// SyslogPluginFacility - The facility is used by the operating system to decide how to handle each log message.
type SyslogPluginFacility string

const (
	SyslogPluginFacilityAuth     SyslogPluginFacility = "auth"
	SyslogPluginFacilityAuthpriv SyslogPluginFacility = "authpriv"
	SyslogPluginFacilityCron     SyslogPluginFacility = "cron"
	SyslogPluginFacilityDaemon   SyslogPluginFacility = "daemon"
	SyslogPluginFacilityFtp      SyslogPluginFacility = "ftp"
	SyslogPluginFacilityKern     SyslogPluginFacility = "kern"
	SyslogPluginFacilityLpr      SyslogPluginFacility = "lpr"
	SyslogPluginFacilityMail     SyslogPluginFacility = "mail"
	SyslogPluginFacilityNews     SyslogPluginFacility = "news"
	SyslogPluginFacilitySyslog   SyslogPluginFacility = "syslog"
	SyslogPluginFacilityUser     SyslogPluginFacility = "user"
	SyslogPluginFacilityUucp     SyslogPluginFacility = "uucp"
	SyslogPluginFacilityLocal0   SyslogPluginFacility = "local0"
	SyslogPluginFacilityLocal1   SyslogPluginFacility = "local1"
	SyslogPluginFacilityLocal2   SyslogPluginFacility = "local2"
	SyslogPluginFacilityLocal3   SyslogPluginFacility = "local3"
	SyslogPluginFacilityLocal4   SyslogPluginFacility = "local4"
	SyslogPluginFacilityLocal5   SyslogPluginFacility = "local5"
	SyslogPluginFacilityLocal6   SyslogPluginFacility = "local6"
	SyslogPluginFacilityLocal7   SyslogPluginFacility = "local7"
)

func (e SyslogPluginFacility) ToPointer() *SyslogPluginFacility {
	return &e
}
func (e *SyslogPluginFacility) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "local6":
		fallthrough
	case "local7":
		*e = SyslogPluginFacility(v)
		return nil
	default:
		return fmt.Errorf("invalid value for SyslogPluginFacility: %v", v)
	}
}
...
type SyslogPluginConfig struct {
	...
	Facility             *SyslogPluginFacility             `json:"facility,omitempty"`
...
func (o *SyslogPluginConfig) GetFacility() *SyslogPluginFacility {
	if o == nil {
		return nil
	}
	return o.Facility
...
func (o *SyslogPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
