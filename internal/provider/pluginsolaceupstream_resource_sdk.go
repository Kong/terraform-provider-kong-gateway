...
func (r *PluginSolaceUpstreamResourceModel) RefreshFromSharedSolaceUpstreamPlugin(ctx context.Context, resp *shared.SolaceUpstreamPlugin) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Config.Message.UserProperties == nil {
			...
			if resp.Config.Message.UserProperties.Headers == nil {
				...
				if len(resp.Config.Message.UserProperties.Headers.Mappings) > 0 {
			...
			if len(resp.Config.Message.UserProperties.PredefinedProperties) > 0 {
...
func (r *PluginSolaceUpstreamResourceModel) ToOperationsCreateSolaceupstreamPluginRequest(ctx context.Context) (*operations.CreateSolaceupstreamPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginSolaceUpstreamResourceModel) ToOperationsDeleteSolaceupstreamPluginRequest(ctx context.Context) (*operations.DeleteSolaceupstreamPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginSolaceUpstreamResourceModel) ToOperationsGetSolaceupstreamPluginRequest(ctx context.Context) (*operations.GetSolaceupstreamPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginSolaceUpstreamResourceModel) ToOperationsUpdateSolaceupstreamPluginRequest(ctx context.Context) (*operations.UpdateSolaceupstreamPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginSolaceUpstreamResourceModel) ToSharedSolaceUpstreamPlugin(ctx context.Context) (*shared.SolaceUpstreamPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Session.Authentication != nil {
		...
		var clientCredentials *shared.SolaceUpstreamPluginClientCredentials
		if r.Config.Session.Authentication.ClientCredentials != nil {
			...
			clientCredentials = &shared.SolaceUpstreamPluginClientCredentials{
				ClientID:      clientID,
