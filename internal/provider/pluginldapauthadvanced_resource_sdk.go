...
func (r *PluginLdapAuthAdvancedResourceModel) ToSharedLdapAuthAdvancedPlugin() *shared.LdapAuthAdvancedPlugin {
	createdAt := new(int64)
	...
	var partials []shared.LdapAuthAdvancedPluginPartials = []shared.LdapAuthAdvancedPluginPartials{}
