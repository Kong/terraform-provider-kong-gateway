...
func (r *PluginGrpcGatewayResourceModel) ToSharedGrpcGatewayPluginInput() *shared.GrpcGatewayPluginInput {
	proto := new(string)
	...
	var consumerGroup *shared.GrpcGatewayPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.GrpcGatewayPluginConsumerGroup{
			ID: id1,
		}
	}
	enabled := new(bool)
	...
	var ordering *shared.GrpcGatewayPluginOrdering
	if r.Ordering != nil {
		...
		ordering = &shared.GrpcGatewayPluginOrdering{
			After:  after,
			Before: before,
		}
	}
