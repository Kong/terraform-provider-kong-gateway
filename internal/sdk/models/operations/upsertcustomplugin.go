...
func (u *UpsertCustomPluginRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &u, "", false, []string{"CustomPluginIdOrName", "CustomPlugin"}); err != nil {
		return err
	}
	return nil
}

func (u *UpsertCustomPluginRequest) GetCustomPluginIDOrName() string {
	if u == nil {
		return ""
	}
	return u.CustomPluginIDOrName
}
