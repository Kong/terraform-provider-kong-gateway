...
var _ datasource.DataSource = &PluginOasValidationDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOasValidationDataSource{}

func NewPluginOasValidationDataSource() datasource.DataSource {
	return &PluginOasValidationDataSource{}
}
...
// PluginOasValidationDataSourceModel describes the data model.
type PluginOasValidationDataSourceModel struct {
...
func (r *PluginOasValidationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_oas_validation"
}

// Schema defines the schema for the data source.
func (r *PluginOasValidationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOasValidation DataSource",
...
func (r *PluginOasValidationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOasValidationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOasValidationDataSourceModel
