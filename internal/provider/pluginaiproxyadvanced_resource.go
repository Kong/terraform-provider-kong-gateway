...
var _ resource.Resource = &PluginAiProxyAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginAiProxyAdvancedResource{}

func NewPluginAiProxyAdvancedResource() resource.Resource {
	return &PluginAiProxyAdvancedResource{}
}
...
func (r *PluginAiProxyAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_proxy_advanced"
}

func (r *PluginAiProxyAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
					...
					"balancer": schema.SingleNestedAttribute{
						...
						Attributes: map[string]schema.Attribute{
							...
							"tokens_count_strategy": schema.StringAttribute{
								Computed:    true,
								Optional:    true,
								Description: `What tokens to use for usage calculation. Available values are: ` + "`" + `total_tokens` + "`" + ` ` + "`" + `prompt_tokens` + "`" + `, ` + "`" + `completion_tokens` + "`" + ` and ` + "`" + `cost` + "`" + `. must be one of ["completion-tokens", "cost", "llm-accuracy", "prompt-tokens", "total-tokens"]`,
								Validators: []validator.String{
									stringvalidator.OneOf(
										"completion-tokens",
										"cost",
...
func (r *PluginAiProxyAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiProxyAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiProxyAdvancedResourceModel
	...
	if !(res.AiProxyAdvancedPlugin != nil) {
...
func (r *PluginAiProxyAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiProxyAdvancedResourceModel
...
func (r *PluginAiProxyAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiProxyAdvancedResourceModel
	var plan types.Object
...
func (r *PluginAiProxyAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiProxyAdvancedResourceModel
	var item types.Object
...
func (r *PluginAiProxyAdvancedResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
