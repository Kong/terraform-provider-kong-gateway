...
var _ datasource.DataSource = &PluginKonnectApplicationAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginKonnectApplicationAuthDataSource{}

func NewPluginKonnectApplicationAuthDataSource() datasource.DataSource {
	return &PluginKonnectApplicationAuthDataSource{}
}

// PluginKonnectApplicationAuthDataSource is the data source implementation.
type PluginKonnectApplicationAuthDataSource struct {
	client *sdk.KongGateway
}

// PluginKonnectApplicationAuthDataSourceModel describes the data model.
type PluginKonnectApplicationAuthDataSourceModel struct {
...
func (r *PluginKonnectApplicationAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_konnect_application_auth"
}

// Schema defines the schema for the data source.
func (r *PluginKonnectApplicationAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginKonnectApplicationAuth DataSource",
...
func (r *PluginKonnectApplicationAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginKonnectApplicationAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginKonnectApplicationAuthDataSourceModel
