...
func (r *PluginVaultAuthResourceModel) ToSharedVaultAuthPlugin() *shared.VaultAuthPlugin {
	createdAt := new(int64)
	...
	var partials []shared.VaultAuthPluginPartials = []shared.VaultAuthPluginPartials{}
...
func (r *PluginVaultAuthResourceModel) RefreshFromSharedVaultAuthPlugin(resp *shared.VaultAuthPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
