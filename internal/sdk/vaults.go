...
func newVaults(rootSDK *KongGateway, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Vaults {
	return &Vaults{
		rootSDK:          rootSDK,
...
// Create a new Vault
func (s *Vaults) CreateVault(ctx context.Context, request shared.Vault, opts ...operations.Option) (*operations.CreateVaultResponse, error) {
