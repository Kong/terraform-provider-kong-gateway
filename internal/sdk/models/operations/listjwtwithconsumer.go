...
func (l *ListJwtWithConsumerRequest) GetConsumerID() string {
	if l == nil {
		return ""
	}
	return l.ConsumerID
...
func (l *ListJwtWithConsumerRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListJwtWithConsumerResponseBody) GetData() []shared.Jwt {
	if l == nil {
		return nil
	}
	return l.Data
