...
func (r *PluginUpstreamTimeoutResourceModel) ToSharedUpstreamTimeoutPlugin() *shared.UpstreamTimeoutPlugin {
	createdAt := new(int64)
	...
	var partials []shared.UpstreamTimeoutPluginPartials = []shared.UpstreamTimeoutPluginPartials{}
