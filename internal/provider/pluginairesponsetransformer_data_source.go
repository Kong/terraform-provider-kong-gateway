...
var _ datasource.DataSource = &PluginAiResponseTransformerDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiResponseTransformerDataSource{}

func NewPluginAiResponseTransformerDataSource() datasource.DataSource {
	return &PluginAiResponseTransformerDataSource{}
}
...
// PluginAiResponseTransformerDataSourceModel describes the data model.
type PluginAiResponseTransformerDataSourceModel struct {
...
func (r *PluginAiResponseTransformerDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_response_transformer"
}

// Schema defines the schema for the data source.
func (r *PluginAiResponseTransformerDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiResponseTransformer DataSource",
...
func (r *PluginAiResponseTransformerDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiResponseTransformerDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiResponseTransformerDataSourceModel
