...
var _ resource.Resource = &PluginAiLlmAsJudgeResource{}
var _ resource.ResourceWithImportState = &PluginAiLlmAsJudgeResource{}

func NewPluginAiLlmAsJudgeResource() resource.Resource {
	return &PluginAiLlmAsJudgeResource{}
}

// PluginAiLlmAsJudgeResource defines the resource implementation.
type PluginAiLlmAsJudgeResource struct {
...
func (r *PluginAiLlmAsJudgeResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_llm_as_judge"
}

func (r *PluginAiLlmAsJudgeResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginAiLlmAsJudgeResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiLlmAsJudgeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiLlmAsJudgeResourceModel
...
func (r *PluginAiLlmAsJudgeResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiLlmAsJudgeResourceModel
...
func (r *PluginAiLlmAsJudgeResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiLlmAsJudgeResourceModel
	var plan types.Object
...
func (r *PluginAiLlmAsJudgeResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiLlmAsJudgeResourceModel
	var item types.Object
...
func (r *PluginAiLlmAsJudgeResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
