...
func (s *Upstreams) CreateUpstream(ctx context.Context, request shared.UpstreamInput) (*operations.CreateUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update an Upstream
func (s *Upstreams) UpdateUpstream(ctx context.Context, request operations.UpdateUpstreamRequest) (*operations.UpdateUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
