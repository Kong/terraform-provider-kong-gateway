...
// Create a new KeySet
func (s *KeySets) CreateKeySet(ctx context.Context, request shared.KeySetInput) (*operations.CreateKeySetResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update a KeySet
func (s *KeySets) UpdateKeySet(ctx context.Context, request operations.UpdateKeySetRequest) (*operations.UpdateKeySetResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
