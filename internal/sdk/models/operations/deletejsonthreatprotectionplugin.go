...
type DeleteJsonthreatprotectionPluginRequest struct {
...
func (d DeleteJsonthreatprotectionPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteJsonthreatprotectionPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteJsonthreatprotectionPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteJsonthreatprotectionPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteJsonthreatprotectionPluginResponse) UnmarshalJSON(data []byte) error {
