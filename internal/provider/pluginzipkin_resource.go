...
var _ resource.Resource = &PluginZipkinResource{}
var _ resource.ResourceWithImportState = &PluginZipkinResource{}

func NewPluginZipkinResource() resource.Resource {
	return &PluginZipkinResource{}
}
...
func (r *PluginZipkinResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_zipkin"
}

func (r *PluginZipkinResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginZipkinResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginZipkinResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginZipkinResourceModel
	...
	request := data.ToSharedCreateZipkinPlugin()
...
func (r *PluginZipkinResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginZipkinResourceModel
...
func (r *PluginZipkinResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginZipkinResourceModel
	var plan types.Object
...
func (r *PluginZipkinResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginZipkinResourceModel
	var item types.Object
...
func (r *PluginZipkinResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
