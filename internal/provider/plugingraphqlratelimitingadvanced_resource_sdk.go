...
func (r *PluginGraphqlRateLimitingAdvancedResourceModel) ToSharedCreateGraphqlRateLimitingAdvancedPlugin() *shared.CreateGraphqlRateLimitingAdvancedPlugin {
	var config *shared.CreateGraphqlRateLimitingAdvancedPluginConfig
	if r.Config != nil {
		...
		var redis *shared.CreateGraphqlRateLimitingAdvancedPluginRedis
		if r.Config.Redis != nil {
			...
			var clusterNodes []shared.CreateGraphqlRateLimitingAdvancedPluginClusterNodes = []shared.CreateGraphqlRateLimitingAdvancedPluginClusterNodes{}
			for _, clusterNodesItem := range r.Config.Redis.ClusterNodes {
				...
				clusterNodes = append(clusterNodes, shared.CreateGraphqlRateLimitingAdvancedPluginClusterNodes{
					IP:   ip,
					Port: port,
				})
			}
			...
			var sentinelNodes []shared.CreateGraphqlRateLimitingAdvancedPluginSentinelNodes = []shared.CreateGraphqlRateLimitingAdvancedPluginSentinelNodes{}
			for _, sentinelNodesItem := range r.Config.Redis.SentinelNodes {
				...
				sentinelNodes = append(sentinelNodes, shared.CreateGraphqlRateLimitingAdvancedPluginSentinelNodes{
					Host: host1,
					Port: port2,
				})
			}
			...
			sentinelRole := new(shared.CreateGraphqlRateLimitingAdvancedPluginSentinelRole)
			if !r.Config.Redis.SentinelRole.IsUnknown() && !r.Config.Redis.SentinelRole.IsNull() {
				*sentinelRole = shared.CreateGraphqlRateLimitingAdvancedPluginSentinelRole(r.Config.Redis.SentinelRole.ValueString())
			} else {
				sentinelRole = nil
			}
			...
			redis = &shared.CreateGraphqlRateLimitingAdvancedPluginRedis{
		...
		strategy := new(shared.CreateGraphqlRateLimitingAdvancedPluginStrategy)
		if !r.Config.Strategy.IsUnknown() && !r.Config.Strategy.IsNull() {
			*strategy = shared.CreateGraphqlRateLimitingAdvancedPluginStrategy(r.Config.Strategy.ValueString())
		} else {
			strategy = nil
		}
		...
		config = &shared.CreateGraphqlRateLimitingAdvancedPluginConfig{
	...
	var protocols []shared.CreateGraphqlRateLimitingAdvancedPluginProtocols = []shared.CreateGraphqlRateLimitingAdvancedPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateGraphqlRateLimitingAdvancedPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateGraphqlRateLimitingAdvancedPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateGraphqlRateLimitingAdvancedPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateGraphqlRateLimitingAdvancedPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateGraphqlRateLimitingAdvancedPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateGraphqlRateLimitingAdvancedPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateGraphqlRateLimitingAdvancedPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateGraphqlRateLimitingAdvancedPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateGraphqlRateLimitingAdvancedPluginService{
			ID: id3,
		}
	}
	out := shared.CreateGraphqlRateLimitingAdvancedPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginGraphqlRateLimitingAdvancedResourceModel) RefreshFromSharedGraphqlRateLimitingAdvancedPlugin(resp *shared.GraphqlRateLimitingAdvancedPlugin) {
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config = &tfTypes.CreateGraphqlRateLimitingAdvancedPluginConfig{}
