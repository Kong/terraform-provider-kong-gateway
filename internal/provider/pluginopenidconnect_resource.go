...
var _ resource.Resource = &PluginOpenidConnectResource{}
var _ resource.ResourceWithImportState = &PluginOpenidConnectResource{}

func NewPluginOpenidConnectResource() resource.Resource {
	return &PluginOpenidConnectResource{}
}
...
func (r *PluginOpenidConnectResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_openid_connect"
}

func (r *PluginOpenidConnectResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginOpenidConnectResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginOpenidConnectResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginOpenidConnectResourceModel
	...
	request, requestDiags := data.ToSharedOpenidConnectPlugin(ctx)
...
func (r *PluginOpenidConnectResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginOpenidConnectResourceModel
...
func (r *PluginOpenidConnectResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginOpenidConnectResourceModel
	var plan types.Object
...
func (r *PluginOpenidConnectResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginOpenidConnectResourceModel
	var item types.Object
...
func (r *PluginOpenidConnectResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
