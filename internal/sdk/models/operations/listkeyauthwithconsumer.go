...
func (l *ListKeyAuthWithConsumerRequest) GetConsumerID() string {
	if l == nil {
		return ""
	}
	return l.ConsumerID
...
func (l *ListKeyAuthWithConsumerRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListKeyAuthWithConsumerResponseBody) GetData() []shared.KeyAuth {
	if l == nil {
		return nil
	}
	return l.Data
