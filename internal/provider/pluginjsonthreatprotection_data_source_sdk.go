...
func (r *PluginJSONThreatProtectionDataSourceModel) ToOperationsGetJsonthreatprotectionPluginRequest(ctx context.Context) (*operations.GetJsonthreatprotectionPluginRequest, diag.Diagnostics) {
...
func (r *PluginJSONThreatProtectionDataSourceModel) RefreshFromSharedJSONThreatProtectionPlugin(ctx context.Context, resp *shared.JSONThreatProtectionPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
