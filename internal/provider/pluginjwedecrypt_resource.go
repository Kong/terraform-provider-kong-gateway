...
type PluginJweDecryptResourceModel struct {
	Config        *tfTypes.CreateJweDecryptPluginConfig `tfsdk:"config"`
...
func (r *PluginJweDecryptResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	request := data.ToSharedCreateJweDecryptPlugin()
...
func (r *PluginJweDecryptResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	createJweDecryptPlugin := data.ToSharedCreateJweDecryptPlugin()
	request := operations.UpdateJwedecryptPluginRequest{
		PluginID:               pluginID,
		CreateJweDecryptPlugin: createJweDecryptPlugin,
	}
