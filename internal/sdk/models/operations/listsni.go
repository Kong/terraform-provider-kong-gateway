...
func (l *ListSniRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
type ListSniResponseBody struct {
	Data []shared.Sni `json:"data,omitempty"`
...
func (l *ListSniResponseBody) GetData() []shared.Sni {
	if l == nil {
		return nil
	}
	return l.Data
...
func (l *ListSniResponse) GetGatewayUnauthorizedError() *shared.GatewayUnauthorizedError {
	if l == nil {
		return nil
	}
