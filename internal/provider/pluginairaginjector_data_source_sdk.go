...
func (r *PluginAiRagInjectorDataSourceModel) ToOperationsGetAiraginjectorPluginRequest(ctx context.Context) (*operations.GetAiraginjectorPluginRequest, diag.Diagnostics) {
...
func (r *PluginAiRagInjectorDataSourceModel) RefreshFromSharedAiRagInjectorPlugin(ctx context.Context, resp *shared.AiRagInjectorPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
