...
var _ datasource.DataSource = &PluginOauth2IntrospectionDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOauth2IntrospectionDataSource{}

func NewPluginOauth2IntrospectionDataSource() datasource.DataSource {
	return &PluginOauth2IntrospectionDataSource{}
}
...
// PluginOauth2IntrospectionDataSourceModel describes the data model.
type PluginOauth2IntrospectionDataSourceModel struct {
...
func (r *PluginOauth2IntrospectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_oauth2_introspection"
}

// Schema defines the schema for the data source.
func (r *PluginOauth2IntrospectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOauth2Introspection DataSource",
...
func (r *PluginOauth2IntrospectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOauth2IntrospectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOauth2IntrospectionDataSourceModel
