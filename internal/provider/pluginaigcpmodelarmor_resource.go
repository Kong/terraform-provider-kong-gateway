...
var _ resource.Resource = &PluginAiGcpModelArmorResource{}
var _ resource.ResourceWithImportState = &PluginAiGcpModelArmorResource{}

func NewPluginAiGcpModelArmorResource() resource.Resource {
	return &PluginAiGcpModelArmorResource{}
}

// PluginAiGcpModelArmorResource defines the resource implementation.
type PluginAiGcpModelArmorResource struct {
...
func (r *PluginAiGcpModelArmorResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_gcp_model_armor"
}

func (r *PluginAiGcpModelArmorResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
		...
		Attributes: map[string]schema.Attribute{
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"source_language": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
					...
					"text_source": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Select where to pick the 'text' for the GCP Model Armor Services request. must be one of ["concatenate_all_content", "concatenate_user_content", "last_message"]`,
						Validators: []validator.String{
							stringvalidator.OneOf(
...
func (r *PluginAiGcpModelArmorResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiGcpModelArmorResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiGcpModelArmorResourceModel
	...
	if !(res.AiGcpModelArmorPlugin != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedAiGcpModelArmorPlugin(ctx, res.AiGcpModelArmorPlugin)...)
...
func (r *PluginAiGcpModelArmorResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiGcpModelArmorResourceModel
...
func (r *PluginAiGcpModelArmorResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiGcpModelArmorResourceModel
	var plan types.Object
...
func (r *PluginAiGcpModelArmorResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiGcpModelArmorResourceModel
	var item types.Object
...
func (r *PluginAiGcpModelArmorResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
