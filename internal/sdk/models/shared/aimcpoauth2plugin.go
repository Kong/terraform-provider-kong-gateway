...
type AiMcpOauth2PluginRequest struct {
	...
	ActorTokenSource *ActorTokenSource `json:"actor_token_source,omitempty"`
...
type TokenExchange struct {
	Cache *AiMcpOauth2PluginCache `json:"cache,omitempty"`
	...
	Enabled *bool                     `json:"enabled,omitempty"`
	Request *AiMcpOauth2PluginRequest `json:"request,omitempty"`
...
type AiMcpOauth2PluginConfig struct {
	...
	ClaimToHeader []ClaimToHeader `json:"claim_to_header,omitempty"`
	...
	InsecureRelaxedAudienceValidation *bool `json:"insecure_relaxed_audience_validation,omitempty"`
	...
	JwksCacheTTL *int64 `json:"jwks_cache_ttl,omitempty"`
	...
	JwtClaimsLeeway *int64 `json:"jwt_claims_leeway,omitempty"`
	...
	MetadataCacheTTL *int64 `json:"metadata_cache_ttl,omitempty"`
	...
	MetadataDiscoveryEndpoint *string `json:"metadata_discovery_endpoint,omitempty"`
	// The number of retry attempts for metadata discovery requests per URL.
	MetadataDiscoveryRetry *int64 `json:"metadata_discovery_retry,omitempty"`
	...
	PassthroughCredentials *bool `json:"passthrough_credentials,omitempty"`
	...
	TLSClientAuthCert *string `json:"tls_client_auth_cert,omitempty"`
	// PEM-encoded private key for mTLS.
	TLSClientAuthKey *string `json:"tls_client_auth_key,omitempty"`
