...
var _ resource.Resource = &PluginRequestCalloutResource{}
var _ resource.ResourceWithImportState = &PluginRequestCalloutResource{}

func NewPluginRequestCalloutResource() resource.Resource {
	return &PluginRequestCalloutResource{}
}
...
func (r *PluginRequestCalloutResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_request_callout"
}

func (r *PluginRequestCalloutResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginRequestCalloutResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginRequestCalloutResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginRequestCalloutResourceModel
...
func (r *PluginRequestCalloutResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginRequestCalloutResourceModel
...
func (r *PluginRequestCalloutResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginRequestCalloutResourceModel
	var plan types.Object
...
func (r *PluginRequestCalloutResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginRequestCalloutResourceModel
	var item types.Object
