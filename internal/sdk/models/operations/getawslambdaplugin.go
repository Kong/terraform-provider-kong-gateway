...
func (g GetAwslambdaPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAwslambdaPluginRequest) UnmarshalJSON(data []byte) error {
...
func (g *GetAwslambdaPluginRequest) GetWorkspace() string {
	if g == nil {
		return ""
	}
	return g.Workspace
...
func (g GetAwslambdaPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetAwslambdaPluginResponse) UnmarshalJSON(data []byte) error {
