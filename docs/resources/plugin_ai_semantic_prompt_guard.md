...
page_title: "kong-gateway_plugin_ai_semantic_prompt_guard Resource - terraform-provider-kong-gateway"
subcategory: ""
description: |-
  PluginAiSemanticPromptGuard Resource
---

# kong-gateway_plugin_ai_semantic_prompt_guard (Resource)
...
```terraform
resource "kong-gateway_plugin_ai_semantic_prompt_guard" "my_pluginaisemanticpromptguard" {
  config = {
    embeddings = {
      auth = {
        allow_override             = true
...
```terraform
import {
  to = kong-gateway_plugin_ai_semantic_prompt_guard.my_kong-gateway_plugin_ai_semantic_prompt_guard
  id = jsonencode({
...
```shell
terraform import kong-gateway_plugin_ai_semantic_prompt_guard.my_kong-gateway_plugin_ai_semantic_prompt_guard '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "747d1e5-8246-4f65-a939-b392f1ee17f8"}'
```
