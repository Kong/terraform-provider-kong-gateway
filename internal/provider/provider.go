...
func (p *KongGatewayProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewClonedPluginResource,
		NewConsumerResource,
		NewConsumerGroupResource,
		NewConsumerGroupMemberResource,
		NewCustomPluginStreamingResource,
		NewGroupResource,
		...
		NewPluginAiA2aProxyResource,
		NewPluginAiAwsGuardrailsResource,
		NewPluginAiAzureContentSafetyResource,
		NewPluginAiCustomGuardrailResource,
		NewPluginAiGcpModelArmorResource,
		NewPluginAiLakeraGuardResource,
		NewPluginAiLlmAsJudgeResource,
		NewPluginAiMcpOauth2Resource,
		NewPluginAiMcpProxyResource,
		NewPluginAiPromptCompressorResource,
		...
		NewPluginAiSemanticResponseGuardResource,
		NewPluginAppDynamicsResource,
		...
		NewPluginMeteringAndBillingResource,
		...
		NewPluginSolaceConsumeResource,
		NewPluginSolaceLogResource,
		NewPluginSolaceUpstreamResource,
		...
		NewRbacRoleResource,
		NewRbacRoleEndpointResource,
		NewRbacRoleEntityResource,
		NewRbacUserResource,
		NewRbacUserGroupResource,
		NewRbacUserRoleResource,
		NewRouteResource,
