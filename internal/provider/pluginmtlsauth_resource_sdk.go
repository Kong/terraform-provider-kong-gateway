...
func (r *PluginMtlsAuthResourceModel) ToSharedCreateMtlsAuthPlugin() *shared.CreateMtlsAuthPlugin {
	var config *shared.CreateMtlsAuthPluginConfig
	if r.Config != nil {
		...
		var consumerBy []shared.CreateMtlsAuthPluginConsumerBy = []shared.CreateMtlsAuthPluginConsumerBy{}
		for _, consumerByItem := range r.Config.ConsumerBy {
			consumerBy = append(consumerBy, shared.CreateMtlsAuthPluginConsumerBy(consumerByItem.ValueString()))
		}
		...
		config = &shared.CreateMtlsAuthPluginConfig{
	...
	var protocols []shared.CreateMtlsAuthPluginProtocols = []shared.CreateMtlsAuthPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateMtlsAuthPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateMtlsAuthPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateMtlsAuthPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateMtlsAuthPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateMtlsAuthPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateMtlsAuthPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateMtlsAuthPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateMtlsAuthPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateMtlsAuthPluginService{
			ID: id3,
		}
	}
	out := shared.CreateMtlsAuthPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginMtlsAuthResourceModel) RefreshFromSharedMtlsAuthPlugin(resp *shared.MtlsAuthPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
