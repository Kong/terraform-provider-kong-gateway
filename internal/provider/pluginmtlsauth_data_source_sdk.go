...
func (r *PluginMtlsAuthDataSourceModel) ToOperationsGetMtlsauthPluginRequest(ctx context.Context) (*operations.GetMtlsauthPluginRequest, diag.Diagnostics) {
...
func (r *PluginMtlsAuthDataSourceModel) RefreshFromSharedMtlsAuthPlugin(ctx context.Context, resp *shared.MtlsAuthPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
