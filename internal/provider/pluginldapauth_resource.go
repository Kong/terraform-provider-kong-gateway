...
var _ resource.Resource = &PluginLdapAuthResource{}
var _ resource.ResourceWithImportState = &PluginLdapAuthResource{}

func NewPluginLdapAuthResource() resource.Resource {
	return &PluginLdapAuthResource{}
}
...
func (r *PluginLdapAuthResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginLdapAuthResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginLdapAuthResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginLdapAuthResourceModel
	...
	request := *data.ToSharedLdapAuthPlugin()
...
func (r *PluginLdapAuthResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginLdapAuthResourceModel
...
func (r *PluginLdapAuthResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginLdapAuthResourceModel
	var plan types.Object
...
func (r *PluginLdapAuthResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginLdapAuthResourceModel
	var item types.Object
