...
// TLSHandshakeModifierPluginTLSClientCertificate - TLS Client Certificate
type TLSHandshakeModifierPluginTLSClientCertificate string

const (
	TLSHandshakeModifierPluginTLSClientCertificateRequest TLSHandshakeModifierPluginTLSClientCertificate = "REQUEST"
)

func (e TLSHandshakeModifierPluginTLSClientCertificate) ToPointer() *TLSHandshakeModifierPluginTLSClientCertificate {
	return &e
}
func (e *TLSHandshakeModifierPluginTLSClientCertificate) UnmarshalJSON(data []byte) error {
	var v string
	...
	switch v {
	case "REQUEST":
		*e = TLSHandshakeModifierPluginTLSClientCertificate(v)
		return nil
	default:
		return fmt.Errorf("invalid value for TLSHandshakeModifierPluginTLSClientCertificate: %v", v)
	}
}

type TLSHandshakeModifierPluginConfig struct {
	// TLS Client Certificate
	TLSClientCertificate *TLSHandshakeModifierPluginTLSClientCertificate `json:"tls_client_certificate,omitempty"`
}

func (o *TLSHandshakeModifierPluginConfig) GetTLSClientCertificate() *TLSHandshakeModifierPluginTLSClientCertificate {
	if o == nil {
		return nil
	}
...
func (o *TLSHandshakeModifierPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
