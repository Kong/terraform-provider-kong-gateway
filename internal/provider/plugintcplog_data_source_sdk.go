...
func (r *PluginTCPLogDataSourceModel) ToOperationsGetTcplogPluginRequest(ctx context.Context) (*operations.GetTcplogPluginRequest, diag.Diagnostics) {
...
func (r *PluginTCPLogDataSourceModel) RefreshFromSharedTCPLogPlugin(ctx context.Context, resp *shared.TCPLogPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
