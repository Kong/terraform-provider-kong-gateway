...
func (r *PluginBotDetectionResourceModel) ToSharedBotDetectionPluginInput() *shared.BotDetectionPluginInput {
	...
	var consumer *shared.BotDetectionPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.BotDetectionPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.BotDetectionPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.BotDetectionPluginConsumerGroup{
			ID: id1,
		}
	}
	enabled := new(bool)
...
func (r *PluginBotDetectionResourceModel) RefreshFromSharedBotDetectionPlugin(resp *shared.BotDetectionPlugin) {
	if resp != nil {
