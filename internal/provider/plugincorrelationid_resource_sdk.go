...
func (r *PluginCorrelationIDResourceModel) ToSharedCorrelationIDPlugin() *shared.CorrelationIDPlugin {
	createdAt := new(int64)
	...
	var partials []shared.CorrelationIDPluginPartials = []shared.CorrelationIDPluginPartials{}
...
func (r *PluginCorrelationIDResourceModel) RefreshFromSharedCorrelationIDPlugin(resp *shared.CorrelationIDPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
