...
var _ resource.Resource = &PluginAiRequestTransformerResource{}
var _ resource.ResourceWithImportState = &PluginAiRequestTransformerResource{}

func NewPluginAiRequestTransformerResource() resource.Resource {
	return &PluginAiRequestTransformerResource{}
}

// PluginAiRequestTransformerResource defines the resource implementation.
type PluginAiRequestTransformerResource struct {
	// Provider configured SDK client.
	client *sdk.KongGateway
}

// PluginAiRequestTransformerResourceModel describes the resource data model.
type PluginAiRequestTransformerResourceModel struct {
...
func (r *PluginAiRequestTransformerResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_request_transformer"
}

func (r *PluginAiRequestTransformerResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiRequestTransformer Resource",
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"prompt": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Use this prompt to tune the LLM system/assistant message for the incoming proxy request (from the client), and what you are expecting in return. Not Null`,
						Validators: []validator.String{
							speakeasy_stringvalidators.NotNull(),
						},
					},
...
func (r *PluginAiRequestTransformerResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiRequestTransformerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiRequestTransformerResourceModel
...
func (r *PluginAiRequestTransformerResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiRequestTransformerResourceModel
...
func (r *PluginAiRequestTransformerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiRequestTransformerResourceModel
	var plan types.Object
...
func (r *PluginAiRequestTransformerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiRequestTransformerResourceModel
	var item types.Object
...
func (r *PluginAiRequestTransformerResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
