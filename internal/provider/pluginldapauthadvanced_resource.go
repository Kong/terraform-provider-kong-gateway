...
var _ resource.Resource = &PluginLdapAuthAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginLdapAuthAdvancedResource{}

func NewPluginLdapAuthAdvancedResource() resource.Resource {
	return &PluginLdapAuthAdvancedResource{}
}

// PluginLdapAuthAdvancedResource defines the resource implementation.
type PluginLdapAuthAdvancedResource struct {
...
func (r *PluginLdapAuthAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ldap_auth_advanced"
}

func (r *PluginLdapAuthAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginLdapAuthAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginLdapAuthAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginLdapAuthAdvancedResourceModel
	...
	request := data.ToSharedCreateLdapAuthAdvancedPlugin()
...
func (r *PluginLdapAuthAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginLdapAuthAdvancedResourceModel
...
func (r *PluginLdapAuthAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginLdapAuthAdvancedResourceModel
	var plan types.Object
...
func (r *PluginLdapAuthAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginLdapAuthAdvancedResourceModel
	var item types.Object
