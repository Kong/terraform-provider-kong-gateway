...
func (r *PluginExitTransformerResourceModel) ToSharedExitTransformerPlugin() *shared.ExitTransformerPlugin {
	createdAt := new(int64)
	...
	var partials []shared.ExitTransformerPluginPartials = []shared.ExitTransformerPluginPartials{}
