...
var _ resource.Resource = &PluginGraphqlProxyCacheAdvancedResource{}
var _ resource.ResourceWithImportState = &PluginGraphqlProxyCacheAdvancedResource{}

func NewPluginGraphqlProxyCacheAdvancedResource() resource.Resource {
	return &PluginGraphqlProxyCacheAdvancedResource{}
}
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_graphql_proxy_cache_advanced"
}

func (r *PluginGraphqlProxyCacheAdvancedResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginGraphqlProxyCacheAdvancedResourceModel
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginGraphqlProxyCacheAdvancedResourceModel
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginGraphqlProxyCacheAdvancedResourceModel
	var plan types.Object
...
func (r *PluginGraphqlProxyCacheAdvancedResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginGraphqlProxyCacheAdvancedResourceModel
	var item types.Object
...
func (r *PluginGraphqlProxyCacheAdvancedResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
