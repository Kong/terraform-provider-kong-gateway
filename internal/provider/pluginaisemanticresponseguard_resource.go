...
var _ resource.Resource = &PluginAiSemanticResponseGuardResource{}
var _ resource.ResourceWithImportState = &PluginAiSemanticResponseGuardResource{}

func NewPluginAiSemanticResponseGuardResource() resource.Resource {
	return &PluginAiSemanticResponseGuardResource{}
}

// PluginAiSemanticResponseGuardResource defines the resource implementation.
type PluginAiSemanticResponseGuardResource struct {
	// Provider configured SDK client.
	client *sdk.KongGateway
}

// PluginAiSemanticResponseGuardResourceModel describes the resource data model.
type PluginAiSemanticResponseGuardResourceModel struct {
	Config        *tfTypes.AiSemanticResponseGuardPluginConfig `tfsdk:"config"`
...
func (r *PluginAiSemanticResponseGuardResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_semantic_response_guard"
}

func (r *PluginAiSemanticResponseGuardResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiSemanticResponseGuard Resource",
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"rules": schema.SingleNestedAttribute{
						...
						Optional: true,
						Attributes: map[string]schema.Attribute{
							"allow_responses": schema.ListAttribute{
								Computed:    true,
								Optional:    true,
								ElementType: types.StringType,
								Description: `List of responses to allow.`,
							},
							"deny_responses": schema.ListAttribute{
								Computed:    true,
								Optional:    true,
								ElementType: types.StringType,
								Description: `List of responses to deny.`,
							},
							"max_response_body_size": schema.Int64Attribute{
								Computed:    true,
								Optional:    true,
...
func (r *PluginAiSemanticResponseGuardResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiSemanticResponseGuardResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiSemanticResponseGuardResourceModel
	...
	if !(res.AiSemanticResponseGuardPlugin != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedAiSemanticResponseGuardPlugin(ctx, res.AiSemanticResponseGuardPlugin)...)
...
func (r *PluginAiSemanticResponseGuardResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiSemanticResponseGuardResourceModel
...
func (r *PluginAiSemanticResponseGuardResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiSemanticResponseGuardResourceModel
	var plan types.Object
...
func (r *PluginAiSemanticResponseGuardResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiSemanticResponseGuardResourceModel
	var item types.Object
...
func (r *PluginAiSemanticResponseGuardResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
