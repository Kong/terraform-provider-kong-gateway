...
var _ datasource.DataSource = &PluginHeaderCertAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginHeaderCertAuthDataSource{}

func NewPluginHeaderCertAuthDataSource() datasource.DataSource {
	return &PluginHeaderCertAuthDataSource{}
}
...
// PluginHeaderCertAuthDataSourceModel describes the data model.
type PluginHeaderCertAuthDataSourceModel struct {
...
func (r *PluginHeaderCertAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_header_cert_auth"
}

// Schema defines the schema for the data source.
func (r *PluginHeaderCertAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginHeaderCertAuth DataSource",
...
func (r *PluginHeaderCertAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginHeaderCertAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginHeaderCertAuthDataSourceModel
