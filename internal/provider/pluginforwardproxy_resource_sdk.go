...
func (r *PluginForwardProxyResourceModel) ToSharedForwardProxyPlugin() *shared.ForwardProxyPlugin {
	createdAt := new(int64)
	...
	var partials []shared.ForwardProxyPluginPartials = []shared.ForwardProxyPluginPartials{}
