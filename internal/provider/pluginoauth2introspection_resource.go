...
var _ resource.Resource = &PluginOauth2IntrospectionResource{}
var _ resource.ResourceWithImportState = &PluginOauth2IntrospectionResource{}

func NewPluginOauth2IntrospectionResource() resource.Resource {
	return &PluginOauth2IntrospectionResource{}
}
...
type PluginOauth2IntrospectionResourceModel struct {
	Config        *tfTypes.CreateOauth2IntrospectionPluginConfig `tfsdk:"config"`
...
func (r *PluginOauth2IntrospectionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_oauth2_introspection"
}

func (r *PluginOauth2IntrospectionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginOauth2IntrospectionResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginOauth2IntrospectionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginOauth2IntrospectionResourceModel
	...
	request := data.ToSharedCreateOauth2IntrospectionPlugin()
...
func (r *PluginOauth2IntrospectionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginOauth2IntrospectionResourceModel
...
func (r *PluginOauth2IntrospectionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginOauth2IntrospectionResourceModel
	var plan types.Object
	...
	createOauth2IntrospectionPlugin := data.ToSharedCreateOauth2IntrospectionPlugin()
	request := operations.UpdateOauth2introspectionPluginRequest{
		PluginID:                        pluginID,
		CreateOauth2IntrospectionPlugin: createOauth2IntrospectionPlugin,
	}
...
func (r *PluginOauth2IntrospectionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginOauth2IntrospectionResourceModel
	var item types.Object
