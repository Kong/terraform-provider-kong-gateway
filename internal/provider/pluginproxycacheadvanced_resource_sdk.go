...
func (r *PluginProxyCacheAdvancedResourceModel) ToSharedCreateProxyCacheAdvancedPlugin() *shared.CreateProxyCacheAdvancedPlugin {
	var config *shared.CreateProxyCacheAdvancedPluginConfig
	if r.Config != nil {
		...
		var memory *shared.CreateProxyCacheAdvancedPluginMemory
		if r.Config.Memory != nil {
			...
			memory = &shared.CreateProxyCacheAdvancedPluginMemory{
				DictionaryName: dictionaryName,
			}
		}
		var redis *shared.CreateProxyCacheAdvancedPluginRedis
		if r.Config.Redis != nil {
			...
			var clusterNodes []shared.CreateProxyCacheAdvancedPluginClusterNodes = []shared.CreateProxyCacheAdvancedPluginClusterNodes{}
			for _, clusterNodesItem := range r.Config.Redis.ClusterNodes {
				...
				clusterNodes = append(clusterNodes, shared.CreateProxyCacheAdvancedPluginClusterNodes{
					IP:   ip,
					Port: port,
				})
			}
			...
			var sentinelNodes []shared.CreateProxyCacheAdvancedPluginSentinelNodes = []shared.CreateProxyCacheAdvancedPluginSentinelNodes{}
			for _, sentinelNodesItem := range r.Config.Redis.SentinelNodes {
				...
				sentinelNodes = append(sentinelNodes, shared.CreateProxyCacheAdvancedPluginSentinelNodes{
					Host: host1,
					Port: port2,
				})
			}
			...
			sentinelRole := new(shared.CreateProxyCacheAdvancedPluginSentinelRole)
			if !r.Config.Redis.SentinelRole.IsUnknown() && !r.Config.Redis.SentinelRole.IsNull() {
				*sentinelRole = shared.CreateProxyCacheAdvancedPluginSentinelRole(r.Config.Redis.SentinelRole.ValueString())
			} else {
				sentinelRole = nil
			}
			...
			redis = &shared.CreateProxyCacheAdvancedPluginRedis{
		...
		var requestMethod []shared.CreateProxyCacheAdvancedPluginRequestMethod = []shared.CreateProxyCacheAdvancedPluginRequestMethod{}
		for _, requestMethodItem := range r.Config.RequestMethod {
			requestMethod = append(requestMethod, shared.CreateProxyCacheAdvancedPluginRequestMethod(requestMethodItem.ValueString()))
		}
		...
		var responseHeaders *shared.CreateProxyCacheAdvancedPluginResponseHeaders
		if r.Config.ResponseHeaders != nil {
			...
			responseHeaders = &shared.CreateProxyCacheAdvancedPluginResponseHeaders{
				XCacheKey:    xCacheKey,
		...
		strategy := new(shared.CreateProxyCacheAdvancedPluginStrategy)
		if !r.Config.Strategy.IsUnknown() && !r.Config.Strategy.IsNull() {
			*strategy = shared.CreateProxyCacheAdvancedPluginStrategy(r.Config.Strategy.ValueString())
		} else {
			strategy = nil
		}
		...
		config = &shared.CreateProxyCacheAdvancedPluginConfig{
	...
	var protocols []shared.CreateProxyCacheAdvancedPluginProtocols = []shared.CreateProxyCacheAdvancedPluginProtocols{}
	for _, protocolsItem := range r.Protocols {
		protocols = append(protocols, shared.CreateProxyCacheAdvancedPluginProtocols(protocolsItem.ValueString()))
	}
	var tags []string = []string{}
	for _, tagsItem := range r.Tags {
		tags = append(tags, tagsItem.ValueString())
	}
	var consumer *shared.CreateProxyCacheAdvancedPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.CreateProxyCacheAdvancedPluginConsumer{
			ID: id,
		}
	}
	var consumerGroup *shared.CreateProxyCacheAdvancedPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateProxyCacheAdvancedPluginConsumerGroup{
			ID: id1,
		}
	}
	var route *shared.CreateProxyCacheAdvancedPluginRoute
	if r.Route != nil {
		id2 := new(string)
		...
		route = &shared.CreateProxyCacheAdvancedPluginRoute{
			ID: id2,
		}
	}
	var service *shared.CreateProxyCacheAdvancedPluginService
	if r.Service != nil {
		id3 := new(string)
		...
		service = &shared.CreateProxyCacheAdvancedPluginService{
			ID: id3,
		}
	}
	out := shared.CreateProxyCacheAdvancedPlugin{
		Config:        config,
		Enabled:       enabled,
...
func (r *PluginProxyCacheAdvancedResourceModel) RefreshFromSharedProxyCacheAdvancedPlugin(resp *shared.ProxyCacheAdvancedPlugin) {
	if resp != nil {
		if resp.Config == nil {
			...
			r.Config = &tfTypes.CreateProxyCacheAdvancedPluginConfig{}
