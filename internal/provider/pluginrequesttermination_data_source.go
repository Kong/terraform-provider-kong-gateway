...
var _ datasource.DataSource = &PluginRequestTerminationDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginRequestTerminationDataSource{}

func NewPluginRequestTerminationDataSource() datasource.DataSource {
	return &PluginRequestTerminationDataSource{}
}
...
// PluginRequestTerminationDataSourceModel describes the data model.
type PluginRequestTerminationDataSourceModel struct {
...
func (r *PluginRequestTerminationDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_request_termination"
}

// Schema defines the schema for the data source.
func (r *PluginRequestTerminationDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginRequestTermination DataSource",
...
func (r *PluginRequestTerminationDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginRequestTerminationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginRequestTerminationDataSourceModel
