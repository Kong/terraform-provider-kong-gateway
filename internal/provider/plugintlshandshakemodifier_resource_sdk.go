...
func (r *PluginTLSHandshakeModifierResourceModel) ToSharedTLSHandshakeModifierPlugin() *shared.TLSHandshakeModifierPlugin {
	createdAt := new(int64)
	...
	var partials []shared.TLSHandshakeModifierPluginPartials = []shared.TLSHandshakeModifierPluginPartials{}
...
func (r *PluginTLSHandshakeModifierResourceModel) RefreshFromSharedTLSHandshakeModifierPlugin(resp *shared.TLSHandshakeModifierPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
