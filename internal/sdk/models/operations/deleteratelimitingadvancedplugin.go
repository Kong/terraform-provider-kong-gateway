...
type DeleteRatelimitingadvancedPluginRequest struct {
...
func (d DeleteRatelimitingadvancedPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteRatelimitingadvancedPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteRatelimitingadvancedPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteRatelimitingadvancedPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteRatelimitingadvancedPluginResponse) UnmarshalJSON(data []byte) error {
