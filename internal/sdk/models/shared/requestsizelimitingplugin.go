...
// RequestSizeLimitingPluginSizeUnit - Size unit can be set either in `bytes`, `kilobytes`, or `megabytes` (default). This configuration is not available in versions prior to Kong Gateway 1.3 and Kong Gateway (OSS) 2.0.
type RequestSizeLimitingPluginSizeUnit string

const (
	RequestSizeLimitingPluginSizeUnitMegabytes RequestSizeLimitingPluginSizeUnit = "megabytes"
	RequestSizeLimitingPluginSizeUnitKilobytes RequestSizeLimitingPluginSizeUnit = "kilobytes"
	RequestSizeLimitingPluginSizeUnitBytes     RequestSizeLimitingPluginSizeUnit = "bytes"
)

func (e RequestSizeLimitingPluginSizeUnit) ToPointer() *RequestSizeLimitingPluginSizeUnit {
	return &e
}
func (e *RequestSizeLimitingPluginSizeUnit) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "kilobytes":
		fallthrough
	case "bytes":
		*e = RequestSizeLimitingPluginSizeUnit(v)
		return nil
	default:
		return fmt.Errorf("invalid value for RequestSizeLimitingPluginSizeUnit: %v", v)
	}
}
...
type RequestSizeLimitingPluginConfig struct {
	...
	SizeUnit *RequestSizeLimitingPluginSizeUnit `json:"size_unit,omitempty"`
}
...
func (o *RequestSizeLimitingPluginConfig) GetSizeUnit() *RequestSizeLimitingPluginSizeUnit {
	if o == nil {
		return nil
	}
	return o.SizeUnit
...
func (o *RequestSizeLimitingPlugin) GetOrdering() any {
	if o == nil {
		return nil
	}
	return o.Ordering
