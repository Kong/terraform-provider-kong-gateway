...
func (s *Upstreams) CreateUpstream(ctx context.Context, request shared.UpstreamInput, opts ...operations.Option) (*operations.CreateUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// UpdateUpstream - Update an Upstream
// Update an Upstream
func (s *Upstreams) UpdateUpstream(ctx context.Context, request operations.UpdateUpstreamRequest, opts ...operations.Option) (*operations.UpdateUpstreamResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
	...
	res := &operations.UpdateUpstreamResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
