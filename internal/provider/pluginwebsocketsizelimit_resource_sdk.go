...
func (r *PluginWebsocketSizeLimitResourceModel) ToSharedWebsocketSizeLimitPlugin() *shared.WebsocketSizeLimitPlugin {
	createdAt := new(int64)
	...
	var partials []shared.WebsocketSizeLimitPluginPartials = []shared.WebsocketSizeLimitPluginPartials{}
