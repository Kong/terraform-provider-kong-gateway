...
var _ resource.Resource = &PluginKafkaUpstreamResource{}
var _ resource.ResourceWithImportState = &PluginKafkaUpstreamResource{}

func NewPluginKafkaUpstreamResource() resource.Resource {
	return &PluginKafkaUpstreamResource{}
}
...
func (r *PluginKafkaUpstreamResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginKafkaUpstreamResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginKafkaUpstreamResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginKafkaUpstreamResourceModel
...
func (r *PluginKafkaUpstreamResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginKafkaUpstreamResourceModel
...
func (r *PluginKafkaUpstreamResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginKafkaUpstreamResourceModel
	var plan types.Object
...
func (r *PluginKafkaUpstreamResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginKafkaUpstreamResourceModel
	var item types.Object
...
func (r *PluginKafkaUpstreamResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
