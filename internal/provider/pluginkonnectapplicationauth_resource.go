...
var _ resource.Resource = &PluginKonnectApplicationAuthResource{}
var _ resource.ResourceWithImportState = &PluginKonnectApplicationAuthResource{}

func NewPluginKonnectApplicationAuthResource() resource.Resource {
	return &PluginKonnectApplicationAuthResource{}
}

// PluginKonnectApplicationAuthResource defines the resource implementation.
type PluginKonnectApplicationAuthResource struct {
	client *sdk.KongGateway
}

// PluginKonnectApplicationAuthResourceModel describes the resource data model.
type PluginKonnectApplicationAuthResourceModel struct {
...
func (r *PluginKonnectApplicationAuthResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_konnect_application_auth"
}

func (r *PluginKonnectApplicationAuthResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginKonnectApplicationAuth Resource",
...
func (r *PluginKonnectApplicationAuthResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginKonnectApplicationAuthResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginKonnectApplicationAuthResourceModel
	...
	request := data.ToSharedCreateKonnectApplicationAuthPlugin()
...
func (r *PluginKonnectApplicationAuthResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginKonnectApplicationAuthResourceModel
...
func (r *PluginKonnectApplicationAuthResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginKonnectApplicationAuthResourceModel
	var plan types.Object
...
func (r *PluginKonnectApplicationAuthResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginKonnectApplicationAuthResourceModel
	var item types.Object
...
func (r *PluginKonnectApplicationAuthResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
