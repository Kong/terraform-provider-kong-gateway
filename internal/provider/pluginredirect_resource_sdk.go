...
func (r *PluginRedirectResourceModel) ToSharedRedirectPlugin() *shared.RedirectPlugin {
	createdAt := new(int64)
	...
	var partials []shared.RedirectPluginPartials = []shared.RedirectPluginPartials{}
...
func (r *PluginRedirectResourceModel) RefreshFromSharedRedirectPlugin(resp *shared.RedirectPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
