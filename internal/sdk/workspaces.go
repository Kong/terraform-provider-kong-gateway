...
// ListWorkspace - List all Workspaces
// List all Workspaces
func (s *Workspaces) ListWorkspace(ctx context.Context, request operations.ListWorkspaceRequest, opts ...operations.Option) (*operations.ListWorkspaceResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.ListWorkspaceResponseBody
...
// GetWorkspace - Fetch a Workspace
