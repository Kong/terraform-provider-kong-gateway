...
func (r *PluginAiSemanticPromptGuardDataSourceModel) ToOperationsGetAisemanticpromptguardPluginRequest(ctx context.Context) (*operations.GetAisemanticpromptguardPluginRequest, diag.Diagnostics) {
...
func (r *PluginAiSemanticPromptGuardDataSourceModel) RefreshFromSharedAiSemanticPromptGuardPlugin(ctx context.Context, resp *shared.AiSemanticPromptGuardPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
