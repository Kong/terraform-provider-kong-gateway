...
func (r *RouteExpressionResourceModel) ToOperationsCreateRouteRouteExpressionRequest(ctx context.Context) (*operations.CreateRouteRouteExpressionRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
