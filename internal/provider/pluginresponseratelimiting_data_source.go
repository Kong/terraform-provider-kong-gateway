...
var _ datasource.DataSource = &PluginResponseRatelimitingDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginResponseRatelimitingDataSource{}

func NewPluginResponseRatelimitingDataSource() datasource.DataSource {
	return &PluginResponseRatelimitingDataSource{}
}
...
// PluginResponseRatelimitingDataSourceModel describes the data model.
type PluginResponseRatelimitingDataSourceModel struct {
...
func (r *PluginResponseRatelimitingDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_response_ratelimiting"
}

// Schema defines the schema for the data source.
func (r *PluginResponseRatelimitingDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginResponseRatelimiting DataSource",
...
func (r *PluginResponseRatelimitingDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginResponseRatelimitingDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginResponseRatelimitingDataSourceModel
	...
	resp.Diagnostics.Append(data.RefreshFromSharedResponseRatelimitingPlugin(ctx, res.ResponseRatelimitingPlugin)...)
