...
func (r *PluginAiRequestTransformerResourceModel) ToOperationsCreateAirequesttransformerPluginRequest(ctx context.Context) (*operations.CreateAirequesttransformerPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.Config.Llm.Model.Options != nil {
		...
		if r.Config.Llm.Model.Options.Cohere != nil {
			...
			if !r.Config.Llm.Model.Options.Cohere.EmbeddingInputType.IsUnknown() && !r.Config.Llm.Model.Options.Cohere.EmbeddingInputType.IsNull() {
				*embeddingInputType = shared.AiRequestTransformerPluginEmbeddingInputType(r.Config.Llm.Model.Options.Cohere.EmbeddingInputType.ValueString())
			} else {
		...
		if r.Config.Llm.Model.Options.Dashscope != nil {
			...
			dashscope = &shared.AiRequestTransformerPluginDashscope{
				International: international,
			}
		}
		var databricks *shared.AiRequestTransformerPluginDatabricks
		if r.Config.Llm.Model.Options.Databricks != nil {
			...
			databricks = &shared.AiRequestTransformerPluginDatabricks{
