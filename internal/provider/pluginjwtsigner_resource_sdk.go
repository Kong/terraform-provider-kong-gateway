...
func (r *PluginJwtSignerResourceModel) ToSharedJwtSignerPlugin() *shared.JwtSignerPlugin {
	createdAt := new(int64)
	...
	var partials []shared.JwtSignerPluginPartials = []shared.JwtSignerPluginPartials{}
