...
// Create a new Vault
func (s *Vaults) CreateVault(ctx context.Context, request shared.VaultInput) (*operations.CreateVaultResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update a Vault
func (s *Vaults) UpdateVault(ctx context.Context, request operations.UpdateVaultRequest) (*operations.UpdateVaultResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
