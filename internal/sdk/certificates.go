...
func (s *Certificates) CreateCertificate(ctx context.Context, request shared.CertificateInput, opts ...operations.Option) (*operations.CreateCertificateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Certificates) UpdateCertificate(ctx context.Context, request operations.UpdateCertificateRequest, opts ...operations.Option) (*operations.UpdateCertificateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
