...
func (r *PluginAiRagInjectorResourceModel) RefreshFromSharedAiRagInjectorPlugin(ctx context.Context, resp *shared.AiRagInjectorPlugin) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		r.Condition = types.StringPointerValue(resp.Condition)
		r.Config = &tfTypes.AiRagInjectorPluginConfig{}
		if len(resp.Config.CollectionACLConfig) > 0 {
			r.Config.CollectionACLConfig = make(map[string]tfTypes.AiMcpProxyPluginACL, len(resp.Config.CollectionACLConfig))
			for collectionACLConfigKey, collectionACLConfigValue := range resp.Config.CollectionACLConfig {
				var collectionACLConfigResult tfTypes.AiMcpProxyPluginACL
		...
		if resp.Config.GlobalACLConfig == nil {
			...
			r.Config.GlobalACLConfig = &tfTypes.AiMcpProxyPluginACL{}
...
func (r *PluginAiRagInjectorResourceModel) ToOperationsCreateAiraginjectorPluginRequest(ctx context.Context) (*operations.CreateAiraginjectorPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRagInjectorResourceModel) ToOperationsDeleteAiraginjectorPluginRequest(ctx context.Context) (*operations.DeleteAiraginjectorPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRagInjectorResourceModel) ToOperationsGetAiraginjectorPluginRequest(ctx context.Context) (*operations.GetAiraginjectorPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRagInjectorResourceModel) ToOperationsUpdateAiraginjectorPluginRequest(ctx context.Context) (*operations.UpdateAiraginjectorPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiRagInjectorResourceModel) ToSharedAiRagInjectorPlugin(ctx context.Context) (*shared.AiRagInjectorPlugin, diag.Diagnostics) {
	var diags diag.Diagnostics
