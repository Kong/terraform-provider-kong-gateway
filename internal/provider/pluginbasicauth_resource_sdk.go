		...
		if resp.Config == nil {
			...
			if resp.Config.BruteForceProtection == nil {
				...
				if resp.Config.BruteForceProtection.Redis == nil {
					...
					r.Config.BruteForceProtection.Redis = &tfTypes.PartialRedisCeConfig{}
					if resp.Config.BruteForceProtection.Redis.CloudAuthentication == nil {
						...
						if resp.Config.BruteForceProtection.Redis.CloudAuthentication.Oauth == nil {
							...
							if len(resp.Config.BruteForceProtection.Redis.CloudAuthentication.Oauth.TokenHeaders) > 0 {
							...
							if len(resp.Config.BruteForceProtection.Redis.CloudAuthentication.Oauth.TokenPostArgs) > 0 {
...
func (r *PluginBasicAuthResourceModel) ToOperationsCreateBasicauthPluginRequest(ctx context.Context) (*operations.CreateBasicauthPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
