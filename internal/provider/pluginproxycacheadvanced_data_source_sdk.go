...
func (r *PluginProxyCacheAdvancedDataSourceModel) ToOperationsGetProxycacheadvancedPluginRequest(ctx context.Context) (*operations.GetProxycacheadvancedPluginRequest, diag.Diagnostics) {
...
func (r *PluginProxyCacheAdvancedDataSourceModel) RefreshFromSharedProxyCacheAdvancedPlugin(ctx context.Context, resp *shared.ProxyCacheAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
