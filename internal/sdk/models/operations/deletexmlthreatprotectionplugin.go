...
type DeleteXmlthreatprotectionPluginRequest struct {
...
func (d DeleteXmlthreatprotectionPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteXmlthreatprotectionPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteXmlthreatprotectionPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteXmlthreatprotectionPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteXmlthreatprotectionPluginResponse) UnmarshalJSON(data []byte) error {
