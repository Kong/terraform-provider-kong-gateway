...
func (r *PluginWebsocketSizeLimitResourceModel) RefreshFromSharedWebsocketSizeLimitPlugin(ctx context.Context, resp *shared.WebsocketSizeLimitPlugin) diag.Diagnostics {
...
func (r *PluginWebsocketSizeLimitResourceModel) ToOperationsCreateWebsocketsizelimitPluginRequest(ctx context.Context) (*operations.CreateWebsocketsizelimitPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginWebsocketSizeLimitResourceModel) ToOperationsDeleteWebsocketsizelimitPluginRequest(ctx context.Context) (*operations.DeleteWebsocketsizelimitPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginWebsocketSizeLimitResourceModel) ToOperationsGetWebsocketsizelimitPluginRequest(ctx context.Context) (*operations.GetWebsocketsizelimitPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginWebsocketSizeLimitResourceModel) ToOperationsUpdateWebsocketsizelimitPluginRequest(ctx context.Context) (*operations.UpdateWebsocketsizelimitPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginWebsocketSizeLimitResourceModel) ToSharedWebsocketSizeLimitPlugin(ctx context.Context) (*shared.WebsocketSizeLimitPlugin, diag.Diagnostics) {
	...
	var ordering *shared.WebsocketSizeLimitPluginOrdering
	if r.Ordering != nil {
		...
		ordering = &shared.WebsocketSizeLimitPluginOrdering{
			After:  after,
			Before: before,
		}
	}
	...
	var route *shared.WebsocketSizeLimitPluginRoute
	if r.Route != nil {
		id3 := new(string)
		...
		route = &shared.WebsocketSizeLimitPluginRoute{
			ID: id3,
		}
	}
	var service *shared.WebsocketSizeLimitPluginService
	if r.Service != nil {
		id4 := new(string)
		...
		service = &shared.WebsocketSizeLimitPluginService{
			ID: id4,
		}
	}
