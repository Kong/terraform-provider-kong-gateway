...
func newAPIKeys(rootSDK *KongGateway, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *APIKeys {
	return &APIKeys{
		rootSDK:          rootSDK,
...
func (s *APIKeys) CreateKeyAuthWithConsumer(ctx context.Context, request operations.CreateKeyAuthWithConsumerRequest, opts ...operations.Option) (*operations.CreateKeyAuthWithConsumerResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/consumers/{ConsumerIdForNestedEntities}/key-auth", request, nil)
	if err != nil {
...
func (s *APIKeys) DeleteKeyAuthWithConsumer(ctx context.Context, request operations.DeleteKeyAuthWithConsumerRequest, opts ...operations.Option) (*operations.DeleteKeyAuthWithConsumerResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/consumers/{ConsumerIdForNestedEntities}/key-auth/{KeyAuthId}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
// UpdateKeyAuthWithConsumer - Update a an API-key associated with a Consumer
// Update a an API-key associated with a Consumer using ID.
func (s *APIKeys) UpdateKeyAuthWithConsumer(ctx context.Context, request operations.UpdateKeyAuthWithConsumerRequest, opts ...operations.Option) (*operations.UpdateKeyAuthWithConsumerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.UpdateKeyAuthWithConsumerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
