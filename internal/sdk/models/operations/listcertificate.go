...
func (l *ListCertificateRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListCertificateResponseBody) GetData() []shared.Certificate {
	if l == nil {
		return nil
	}
	return l.Data
...
func (l *ListCertificateResponse) GetGatewayUnauthorizedError() *shared.GatewayUnauthorizedError {
	if l == nil {
		return nil
	}
