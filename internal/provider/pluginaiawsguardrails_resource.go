...
var _ resource.Resource = &PluginAiAwsGuardrailsResource{}
var _ resource.ResourceWithImportState = &PluginAiAwsGuardrailsResource{}

func NewPluginAiAwsGuardrailsResource() resource.Resource {
	return &PluginAiAwsGuardrailsResource{}
}

// PluginAiAwsGuardrailsResource defines the resource implementation.
type PluginAiAwsGuardrailsResource struct {
...
func (r *PluginAiAwsGuardrailsResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_aws_guardrails"
}

func (r *PluginAiAwsGuardrailsResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"text_source": schema.StringAttribute{
						Computed:    true,
						Optional:    true,
						Description: `Select where to pick the 'text' for the Content Guard Services request. must be one of ["concatenate_all_content", "concatenate_user_content", "last_message"]`,
						Validators: []validator.String{
							stringvalidator.OneOf(
...
func (r *PluginAiAwsGuardrailsResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginAiAwsGuardrailsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginAiAwsGuardrailsResourceModel
	...
	if !(res.AiAwsGuardrailsPlugin != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedAiAwsGuardrailsPlugin(ctx, res.AiAwsGuardrailsPlugin)...)
...
func (r *PluginAiAwsGuardrailsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginAiAwsGuardrailsResourceModel
...
func (r *PluginAiAwsGuardrailsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginAiAwsGuardrailsResourceModel
	var plan types.Object
...
func (r *PluginAiAwsGuardrailsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginAiAwsGuardrailsResourceModel
	var item types.Object
...
func (r *PluginAiAwsGuardrailsResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
