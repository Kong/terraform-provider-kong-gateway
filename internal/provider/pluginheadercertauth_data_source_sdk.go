...
func (r *PluginHeaderCertAuthDataSourceModel) ToOperationsGetHeadercertauthPluginRequest(ctx context.Context) (*operations.GetHeadercertauthPluginRequest, diag.Diagnostics) {
...
func (r *PluginHeaderCertAuthDataSourceModel) RefreshFromSharedHeaderCertAuthPlugin(ctx context.Context, resp *shared.HeaderCertAuthPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
