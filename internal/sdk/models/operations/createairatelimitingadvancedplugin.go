...
func (c CreateAiratelimitingadvancedPluginRequest) MarshalJSON() ([]byte, error) {
...
func (c *CreateAiratelimitingadvancedPluginRequest) GetWorkspace() string {
	if c == nil {
		return ""
	}
	return c.Workspace
...
func (c CreateAiratelimitingadvancedPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateAiratelimitingadvancedPluginResponse) UnmarshalJSON(data []byte) error {
