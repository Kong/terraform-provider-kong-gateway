...
func (r *PluginGrpcGatewayResourceModel) ToOperationsCreateGrpcgatewayPluginRequest(ctx context.Context) (*operations.CreateGrpcgatewayPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
