...
var _ resource.Resource = &PluginMtlsAuthResource{}
var _ resource.ResourceWithImportState = &PluginMtlsAuthResource{}

func NewPluginMtlsAuthResource() resource.Resource {
	return &PluginMtlsAuthResource{}
}
...
func (r *PluginMtlsAuthResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_mtls_auth"
}

func (r *PluginMtlsAuthResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginMtlsAuthResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginMtlsAuthResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginMtlsAuthResourceModel
	...
	request, requestDiags := data.ToSharedMtlsAuthPlugin(ctx)
...
func (r *PluginMtlsAuthResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginMtlsAuthResourceModel
...
func (r *PluginMtlsAuthResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginMtlsAuthResourceModel
	var plan types.Object
...
func (r *PluginMtlsAuthResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginMtlsAuthResourceModel
	var item types.Object
...
func (r *PluginMtlsAuthResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
