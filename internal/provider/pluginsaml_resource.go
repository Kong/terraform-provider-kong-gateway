...
var _ resource.Resource = &PluginSamlResource{}
var _ resource.ResourceWithImportState = &PluginSamlResource{}

func NewPluginSamlResource() resource.Resource {
	return &PluginSamlResource{}
}
...
func (r *PluginSamlResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_saml"
}

func (r *PluginSamlResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PluginSamlResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PluginSamlResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *PluginSamlResourceModel
	...
	request, requestDiags := data.ToSharedSamlPlugin(ctx)
...
func (r *PluginSamlResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *PluginSamlResourceModel
...
func (r *PluginSamlResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *PluginSamlResourceModel
	var plan types.Object
...
func (r *PluginSamlResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *PluginSamlResourceModel
	var item types.Object
...
func (r *PluginSamlResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
