...
var _ datasource.DataSource = &PluginServiceProtectionDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginServiceProtectionDataSource{}

func NewPluginServiceProtectionDataSource() datasource.DataSource {
	return &PluginServiceProtectionDataSource{}
}

// PluginServiceProtectionDataSource is the data source implementation.
type PluginServiceProtectionDataSource struct {
	client *sdk.KongGateway
}

// PluginServiceProtectionDataSourceModel describes the data model.
type PluginServiceProtectionDataSourceModel struct {
...
func (r *PluginServiceProtectionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_service_protection"
}

// Schema defines the schema for the data source.
func (r *PluginServiceProtectionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginServiceProtection DataSource",
...
func (r *PluginServiceProtectionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginServiceProtectionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginServiceProtectionDataSourceModel
