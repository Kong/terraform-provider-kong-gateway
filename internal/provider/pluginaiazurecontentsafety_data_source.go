...
var _ datasource.DataSource = &PluginAiAzureContentSafetyDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginAiAzureContentSafetyDataSource{}

func NewPluginAiAzureContentSafetyDataSource() datasource.DataSource {
	return &PluginAiAzureContentSafetyDataSource{}
}
...
// PluginAiAzureContentSafetyDataSourceModel describes the data model.
type PluginAiAzureContentSafetyDataSourceModel struct {
...
func (r *PluginAiAzureContentSafetyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ai_azure_content_safety"
}

// Schema defines the schema for the data source.
func (r *PluginAiAzureContentSafetyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginAiAzureContentSafety DataSource",
...
func (r *PluginAiAzureContentSafetyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginAiAzureContentSafetyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginAiAzureContentSafetyDataSourceModel
