...
func (g GetHmacauthPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetHmacauthPluginRequest) UnmarshalJSON(data []byte) error {
...
func (g *GetHmacauthPluginRequest) GetWorkspace() string {
	if g == nil {
		return ""
	}
	return g.Workspace
...
func (g GetHmacauthPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(g, "", false)
}

func (g *GetHmacauthPluginResponse) UnmarshalJSON(data []byte) error {
