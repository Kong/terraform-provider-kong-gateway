...
func (r *PluginJwtSignerResourceModel) ToSharedCreateJwtSignerPlugin() *shared.CreateJwtSignerPlugin {
	var config *shared.CreateJwtSignerPluginConfig
	if r.Config != nil {
	...
	var consumerGroup *shared.CreateJwtSignerPluginConsumerGroup
	if r.ConsumerGroup != nil {
		...
		consumerGroup = &shared.CreateJwtSignerPluginConsumerGroup{
			ID: id1,
		}
	}
...
func (r *PluginJwtSignerResourceModel) RefreshFromSharedJwtSignerPlugin(resp *shared.JwtSignerPlugin) {
	if resp != nil {
		if resp.Config == nil {
			r.Config = nil
		} else {
