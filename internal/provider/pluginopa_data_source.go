...
var _ datasource.DataSource = &PluginOpaDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginOpaDataSource{}

func NewPluginOpaDataSource() datasource.DataSource {
	return &PluginOpaDataSource{}
}

// PluginOpaDataSource is the data source implementation.
type PluginOpaDataSource struct {
	client *sdk.KongGateway
}

// PluginOpaDataSourceModel describes the data model.
type PluginOpaDataSourceModel struct {
...
func (r *PluginOpaDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_opa"
}

// Schema defines the schema for the data source.
func (r *PluginOpaDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginOpa DataSource",
...
func (r *PluginOpaDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginOpaDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginOpaDataSourceModel
