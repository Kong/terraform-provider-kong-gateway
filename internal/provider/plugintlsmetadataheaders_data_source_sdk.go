...
func (r *PluginTLSMetadataHeadersDataSourceModel) ToOperationsGetTlsmetadataheadersPluginRequest(ctx context.Context) (*operations.GetTlsmetadataheadersPluginRequest, diag.Diagnostics) {
...
func (r *PluginTLSMetadataHeadersDataSourceModel) RefreshFromSharedTLSMetadataHeadersPlugin(ctx context.Context, resp *shared.TLSMetadataHeadersPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
