...
func (r *PluginDatadogTracingResourceModel) ToSharedDatadogTracingPlugin(ctx context.Context) (*shared.DatadogTracingPlugin, diag.Diagnostics) {
	...
	var ordering *shared.DatadogTracingPluginOrdering
	if r.Ordering != nil {
		...
		if r.Ordering.After != nil {
			...
			after = &shared.DatadogTracingPluginAfter{
				Access: access,
			}
		}
		...
		if r.Ordering.Before != nil {
			...
			before = &shared.DatadogTracingPluginBefore{
				Access: access1,
			}
		}
		ordering = &shared.DatadogTracingPluginOrdering{
			After:  after,
			Before: before,
		}
	}
	var partials []shared.DatadogTracingPluginPartials
	if r.Partials != nil {
		partials = make([]shared.DatadogTracingPluginPartials, 0, len(r.Partials))
		for _, partialsItem := range r.Partials {
			...
			partials = append(partials, shared.DatadogTracingPluginPartials{
				ID:   id1,
				Name: name,
				Path: path,
			})
...
func (r *PluginDatadogTracingResourceModel) ToOperationsUpdateDatadogtracingPluginRequest(ctx context.Context) (*operations.UpdateDatadogtracingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginDatadogTracingResourceModel) ToOperationsGetDatadogtracingPluginRequest(ctx context.Context) (*operations.GetDatadogtracingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginDatadogTracingResourceModel) ToOperationsDeleteDatadogtracingPluginRequest(ctx context.Context) (*operations.DeleteDatadogtracingPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginDatadogTracingResourceModel) RefreshFromSharedDatadogTracingPlugin(ctx context.Context, resp *shared.DatadogTracingPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
