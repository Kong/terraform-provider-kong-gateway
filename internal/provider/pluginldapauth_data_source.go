...
var _ datasource.DataSource = &PluginLdapAuthDataSource{}
var _ datasource.DataSourceWithConfigure = &PluginLdapAuthDataSource{}

func NewPluginLdapAuthDataSource() datasource.DataSource {
	return &PluginLdapAuthDataSource{}
}

// PluginLdapAuthDataSource is the data source implementation.
type PluginLdapAuthDataSource struct {
	client *sdk.KongGateway
}

// PluginLdapAuthDataSourceModel describes the data model.
type PluginLdapAuthDataSourceModel struct {
...
func (r *PluginLdapAuthDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_plugin_ldap_auth"
}

// Schema defines the schema for the data source.
func (r *PluginLdapAuthDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PluginLdapAuth DataSource",
...
func (r *PluginLdapAuthDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PluginLdapAuthDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PluginLdapAuthDataSourceModel
