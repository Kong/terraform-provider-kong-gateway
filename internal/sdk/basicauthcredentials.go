...
func (s *BasicAuthCredentials) CreateBasicAuth(ctx context.Context, request shared.BasicAuthInput) (*operations.CreateBasicAuthResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *BasicAuthCredentials) UpdateBasicAuth(ctx context.Context, request operations.UpdateBasicAuthRequest) (*operations.UpdateBasicAuthResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *BasicAuthCredentials) UpsertBasicAuth(ctx context.Context, request operations.UpsertBasicAuthRequest) (*operations.UpsertBasicAuthResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
