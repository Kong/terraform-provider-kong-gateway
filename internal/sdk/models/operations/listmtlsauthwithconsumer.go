...
func (l *ListMtlsAuthWithConsumerRequest) GetConsumerID() string {
	if l == nil {
		return ""
	}
	return l.ConsumerID
...
func (l *ListMtlsAuthWithConsumerRequest) GetWorkspace() string {
	if l == nil {
		return ""
	}
	return l.Workspace
...
func (l *ListMtlsAuthWithConsumerResponseBody) GetData() []shared.MTLSAuth {
	if l == nil {
		return nil
	}
	return l.Data
