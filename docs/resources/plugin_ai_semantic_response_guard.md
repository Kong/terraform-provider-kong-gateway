...
```shell
terraform import kong-gateway_plugin_ai_semantic_response_guard.my_kong-gateway_plugin_ai_semantic_response_guard '{"id": "3473c251-5b6c-4f45-b1ff-7ede735a366d", "workspace": "team-payments"}'
```
