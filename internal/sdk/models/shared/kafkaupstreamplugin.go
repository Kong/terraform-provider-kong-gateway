...
type KafkaUpstreamPluginAuthentication struct {
	...
	Oauthbearer *KafkaUpstreamPluginOauthbearer `json:"oauthbearer,omitempty"`
...
func (e *KafkaUpstreamPluginCompressionType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "none":
		fallthrough
	case "snappy":
		*e = KafkaUpstreamPluginCompressionType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for KafkaUpstreamPluginCompressionType: %v", v)
	}
}
...
func (e *KafkaUpstreamPluginRepeatedHeadersBehavior) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	switch v {
	case "concatenate_by_comma":
		fallthrough
	case "retain_duplicates":
		fallthrough
	case "take_first":
		*e = KafkaUpstreamPluginRepeatedHeadersBehavior(v)
		return nil
	default:
		return fmt.Errorf("invalid value for KafkaUpstreamPluginRepeatedHeadersBehavior: %v", v)
	}
}
...
type KafkaUpstreamPluginHeaders struct {
	...
	ForwardAllByDefault *bool `json:"forward_all_by_default,omitempty"`
	// Whether to forward HTTP headers as Kafka record headers.
	ForwardHTTPHeadersAsRecordHeaders *bool `json:"forward_http_headers_as_record_headers,omitempty"`
	...
	RepeatedHeadersBehavior *KafkaUpstreamPluginRepeatedHeadersBehavior `json:"repeated_headers_behavior,omitempty"`
}
...
type KafkaUpstreamPluginOauth2 struct {
	...
	GrantType *KafkaUpstreamPluginGrantType `json:"grant_type,omitempty"`
...
type KafkaUpstreamPluginOauth2Client struct {
	...
	AuthMethod *KafkaUpstreamPluginAuthMethod `json:"auth_method,omitempty"`
	// The algorithm to use with JWT when using `client_secret_jwt` authentication.
	ClientSecretJwtAlg *KafkaUpstreamPluginClientSecretJwtAlg `json:"client_secret_jwt_alg,omitempty"`
...
type KafkaUpstreamPluginConfigAuthentication struct {
	...
	Oauth2       *KafkaUpstreamPluginOauth2       `json:"oauth2,omitempty"`
...
func (e *KafkaUpstreamPluginPayloadEncoding) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "avro_json":
		fallthrough
	case "simple_json":
		*e = KafkaUpstreamPluginPayloadEncoding(v)
		return nil
	default:
		return fmt.Errorf("invalid value for KafkaUpstreamPluginPayloadEncoding: %v", v)
	}
}
...
type KafkaUpstreamPluginKeySchema struct {
	...
	PayloadEncoding *KafkaUpstreamPluginPayloadEncoding `json:"payload_encoding,omitempty"`
...
func (e *KafkaUpstreamPluginConfigPayloadEncoding) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "avro_json":
		fallthrough
	case "simple_json":
		*e = KafkaUpstreamPluginConfigPayloadEncoding(v)
		return nil
	default:
		return fmt.Errorf("invalid value for KafkaUpstreamPluginConfigPayloadEncoding: %v", v)
	}
}

type KafkaUpstreamPluginValueSchema struct {
	// How the client encodes union/nullable fields in the request body for Avro schemas. 'avro_json' (default) requires Avro-spec JSON with type-tagged unions (e.g. {"int": 1}, {"null": null}). 'simple_json' lets the gateway accept plain JSON and resolve union branches against the schema.
	PayloadEncoding *KafkaUpstreamPluginConfigPayloadEncoding `json:"payload_encoding,omitempty"`
	// The schema version to use for serialization/deserialization. Use 'latest' to always fetch the most recent version.
	SchemaVersion *string `json:"schema_version,omitempty"`
	// The name of the subject
	SubjectName *string `json:"subject_name,omitempty"`
...
type KafkaUpstreamPluginConfluent struct {
	Authentication *KafkaUpstreamPluginConfigAuthentication `json:"authentication,omitempty"`
...
type KafkaUpstreamPluginConfig struct {
	...
	CompressionType *KafkaUpstreamPluginCompressionType `json:"compression_type,omitempty"`
	...
	Headers *KafkaUpstreamPluginHeaders `json:"headers,omitempty"`
