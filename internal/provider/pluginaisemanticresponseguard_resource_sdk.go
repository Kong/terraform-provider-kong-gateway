...
func (r *PluginAiSemanticResponseGuardResourceModel) RefreshFromSharedAiSemanticResponseGuardPlugin(ctx context.Context, resp *shared.AiSemanticResponseGuardPlugin) diag.Diagnostics {
...
func (r *PluginAiSemanticResponseGuardResourceModel) ToOperationsCreateAisemanticresponseguardPluginRequest(ctx context.Context) (*operations.CreateAisemanticresponseguardPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticResponseGuardResourceModel) ToOperationsDeleteAisemanticresponseguardPluginRequest(ctx context.Context) (*operations.DeleteAisemanticresponseguardPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticResponseGuardResourceModel) ToOperationsGetAisemanticresponseguardPluginRequest(ctx context.Context) (*operations.GetAisemanticresponseguardPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticResponseGuardResourceModel) ToOperationsUpdateAisemanticresponseguardPluginRequest(ctx context.Context) (*operations.UpdateAisemanticresponseguardPluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginAiSemanticResponseGuardResourceModel) ToSharedAiSemanticResponseGuardPlugin(ctx context.Context) (*shared.AiSemanticResponseGuardPlugin, diag.Diagnostics) {
	...
	if r.Config.Vectordb.Redis != nil {
		...
		if r.Config.Vectordb.Redis.CloudAuthentication != nil {
			...
			var oauth *shared.AiSemanticResponseGuardPluginOauth
			if r.Config.Vectordb.Redis.CloudAuthentication.Oauth != nil {
				authMethod := new(shared.AiSemanticResponseGuardPluginAuthMethod)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.IsNull() {
					*authMethod = shared.AiSemanticResponseGuardPluginAuthMethod(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.AuthMethod.ValueString())
				} else {
					authMethod = nil
				}
				clientID := new(string)
				...
				clientSecretJwtAlg := new(shared.AiSemanticResponseGuardPluginClientSecretJwtAlg)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.IsNull() {
					*clientSecretJwtAlg = shared.AiSemanticResponseGuardPluginClientSecretJwtAlg(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.ClientSecretJwtAlg.ValueString())
				} else {
					clientSecretJwtAlg = nil
				}
				grantType := new(shared.AiSemanticResponseGuardPluginGrantType)
				if !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsUnknown() && !r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.IsNull() {
					*grantType = shared.AiSemanticResponseGuardPluginGrantType(r.Config.Vectordb.Redis.CloudAuthentication.Oauth.GrantType.ValueString())
				} else {
					grantType = nil
				}
				...
				oauth = &shared.AiSemanticResponseGuardPluginOauth{
