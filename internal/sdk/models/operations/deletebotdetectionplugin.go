...
type DeleteBotdetectionPluginRequest struct {
...
func (d DeleteBotdetectionPluginRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteBotdetectionPluginRequest) UnmarshalJSON(data []byte) error {
...
func (d *DeleteBotdetectionPluginRequest) GetWorkspace() string {
	if d == nil {
		return ""
	}
	return d.Workspace
...
func (d DeleteBotdetectionPluginResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteBotdetectionPluginResponse) UnmarshalJSON(data []byte) error {
