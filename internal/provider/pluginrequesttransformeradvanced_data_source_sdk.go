...
func (r *PluginRequestTransformerAdvancedDataSourceModel) ToOperationsGetRequesttransformeradvancedPluginRequest(ctx context.Context) (*operations.GetRequesttransformeradvancedPluginRequest, diag.Diagnostics) {
...
func (r *PluginRequestTransformerAdvancedDataSourceModel) RefreshFromSharedRequestTransformerAdvancedPlugin(ctx context.Context, resp *shared.RequestTransformerAdvancedPlugin) diag.Diagnostics {
	var diags diag.Diagnostics
