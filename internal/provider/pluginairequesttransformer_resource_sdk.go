...
func (r *PluginAiRequestTransformerResourceModel) ToSharedAiRequestTransformerPluginInput() *shared.AiRequestTransformerPluginInput {
	...
	var consumer *shared.AiRequestTransformerPluginConsumer
	if r.Consumer != nil {
		id := new(string)
		...
		consumer = &shared.AiRequestTransformerPluginConsumer{
			ID: id,
		}
	}
	...
	out := shared.AiRequestTransformerPluginInput{
		Config:        config,
		Consumer:      consumer,
