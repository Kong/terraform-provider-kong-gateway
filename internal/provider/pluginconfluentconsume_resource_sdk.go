...
func (r *PluginConfluentConsumeResourceModel) RefreshFromSharedConfluentConsumePlugin(ctx context.Context, resp *shared.ConfluentConsumePlugin) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Config.Oauthbearer == nil {
			...
			if len(resp.Config.Oauthbearer.Extensions) > 0 {
...
func (r *PluginConfluentConsumeResourceModel) ToOperationsCreateConfluentconsumePluginRequest(ctx context.Context) (*operations.CreateConfluentconsumePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginConfluentConsumeResourceModel) ToOperationsDeleteConfluentconsumePluginRequest(ctx context.Context) (*operations.DeleteConfluentconsumePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginConfluentConsumeResourceModel) ToOperationsGetConfluentconsumePluginRequest(ctx context.Context) (*operations.GetConfluentconsumePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *PluginConfluentConsumeResourceModel) ToOperationsUpdateConfluentconsumePluginRequest(ctx context.Context) (*operations.UpdateConfluentconsumePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
