...
func (r *PluginProxyCacheResourceModel) ToOperationsCreateProxycachePluginRequest(ctx context.Context) (*operations.CreateProxycachePluginRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
